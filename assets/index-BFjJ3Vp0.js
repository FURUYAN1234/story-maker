...
・食文化: 現代知識で異世界の食文化を改革する展開が人気（マヨネーズ、味噌、醤油の再現など）`}};function Ya(e){const t=[e.worldview,e.worldviewCustom,e.era,e.eraCustom,e.theme,e.themeCustom,e.genre,e.genreCustom,e.mode,e.modeCustom,e.supplement,...(e.characters||[]).map(r=>r.note||"")].filter(Boolean).join(" ");if(!t.trim())return"";const a=[],n=new Set;for(const[r,s]of Object.entries(za))n.has(r)||s.tags.some(o=>t.includes(o))&&(a.push(s.lore),n.add(r));return a.length===0?"":`

【参考知識（RAG: 物語のディテール向上用 — この情報を自然に活用して描写の解像度を上げること）】
`+a.slice(0,3).join(`

`)}const wt=e=>e[Math.floor(Math.random()*e.length)];function Xa(e){const t=e.mode||"4koma",a=e.genreCustom||e.genre||"コメディ",n=e.themeCustom||e.theme||"ランダム",r=e.worldviewCustom||e.worldview||"現代日本",s=e.eraCustom||e.era||"現代",o=e.targetCustom||e.target||"全年齢",i=e.endingCustom||e.ending||"意外な結末",c=e.narrCustom||e.narration||"三人称・客観";let u;!e.characters||e.characters.length===0?u="・未設定（AIが自由に2〜3人の個性的なキャラを設定すること）":u=e.characters.map((k,M)=>{const x=k.name||`(AI命名:キャラ${M+1})`,_=k.role||"未定",H=k.sex?`性別:${k.sex}, `:"",L=k.personality||"未定",V=k.note?` [${k.note}]`:"";return`${M+1}. ${x} (${_}) — ${H}性格:${L}${V}`}).join(`
`);const p=e.charCount?`
...
・ただし、タイムスリップ等の時代錯誤がテーマ・世界観で意図されている場合はこの限りではない。`:"",v=he(a,Bn),b=he(i,Pn),$=he(r,Dn),C=he(o,jn),w=he(c,Vn);let I="";v&&(I+=`
...
【語り口指定：${c}】
${w}`);let S="";t==="4koma_scenario"?S=`あなたはプロの4コマ漫画シナリオライターです。以下の設定に基づき、画像生成4コマ漫画アプリのSTEP2シナリオ入力欄に直接コピペして使える形式でシナリオを出力してください。
...
\`\`\`
`:S=`あなたはプロの書き手です。以下の詳細設定に基づき、読む人の心を動かす「${y}」を執筆してください。
...
`,e.universalAssets.forEach((k,M)=>{if(E+=`[アセット ${M+1}] 型: ${k.type}
`,k.type==="image"){E+=`・画像ファイル名: ${k.name||"不明"}
`;const x=k.status==="error"?"画像解析エラーにより詳細情報なし":k.analysis||"解析中、または解析不可";E+=`・ビジュアル事前解析結果: ${x}
`}else k.type==="url"?(E+=`・リンクURL: ${k.value}
`,k.title&&k.status!=="error"&&(E+=`・リンク先タイトル: ${k.title}
`),k.content&&k.status!=="error"&&(E+=`・リンク先コンテンツ（要約/抽出テキスト）: ${k.content.slice(0,1500)}${k.content.length>1500?"...":""}
`)):k.type==="text"&&(E+=`・文書名: ${k.name||"不明"}
`,k.content&&k.status!=="error"&&(E+=`・文書内容: ${k.content.slice(0,1500)}${k.content.length>1500?"...":""}
`))}),S+=E);const N=Ya(e);N&&(S+=N);const P=[a,s,r,o,i,y];return e.charCount&&P.push(`${e.charCount}字`),N&&P.push("📚RAG"),e.universalAssets&&e.universalAssets.length>0&&P.push(`🖼️アセット(${e.universalAssets.length})`),{prompt:S,tags:P}}const Qa=/(?:AI|SNS|電子|電脳|ガジェット|スマホ|アプリ|ロボット|量子|仮想|VR|サイバー|ディストピア|アンドロイド|クローン|宇宙ステーション|火星|月面|巨大企業|監視システム|ネットワーク)/i,Za=/(?:SF|近未来|サイバー|未来|電脳|AI|量子|宇宙|ロボット|クローン)/i;function Hn(e){return Qa.test(String(e||""))}function zt(e){return Za.test(String(e||""))}function Ze(e,t=!1){const a=(e||[]).filter(n=>t||!Hn(n));return a.length?a:e||[]}function St(e,t=null,a=!1){if(!e)return null;let n=t&&e[t]?t:null;if(!n){const o=Object.keys(e||{});n=q(o.length?o:[])}if(!n)return null;const r=e[n]||[],s=Ze(r,a||zt(n));return[n,q(s)]}function er(){const e=Object.fromEntries(Object.entries(We).filter(([a])=>!zt(a)&&!Hn(a)));let t=St(e,null,!1)||St(We,null,!1);return t=t?t[1]:wt(Ze(Pa,!1)),Math.random()<.55&&(t+=" "+wt(Da)),Math.random()<.35&&(t+=" "+wt(ja)),t}function tr(e){if(typeof e=="number"&&Number.isFinite(e))return Math.max(0,Math.round(e));const t=String(e||"").replace(/[０-９]/g,r=>String.fromCharCode(r.charCodeAt(0)-65248)).replace(/[,，]/g,"");if(!t)return 0;const a=t.match(/(\d+(?:\.\d+)?)\s*万/);if(a)return Math.round(parseFloat(a[1])*1e4);const n=t.match(/(\d{4,})/);return n?parseInt(n[1],10):0}function be(e){const t=(S,E)=>{const N=String(S||"").trim();return!N||["ランダム","未設定","おまかせ","AIおまかせ"].includes(N)?E:N},a=t(e.genreCustom||e.genre,"コメディ"),n=t(e.themeCustom||e.theme,"選択"),r=t(e.worldviewCustom||e.worldview,"現代日本"),s=t(e.eraCustom||e.era,"現代"),o=t(e.targetCustom||e.target,"全年齢"),i=t(e.endingCustom||e.ending,"意外な結末"),c=t(e.narrCustom||e.narration,"三人称・客観"),u=Array.isArray(e.characters)&&e.characters.length>0;let p;u?p=`【必須登場人物（ユーザー指定・作中登場ノルマ）】
${e.characters.map((S,E)=>{const N=S.name||`(AI命名:キャラ${E+1})`,P=S.role||"未定",k=S.sex?`性別:${S.sex}, `:"",M=S.personality||"未定",x=S.note?` [${S.note}]`:"";return`${E+1}. ${N} (${P}) — ${k}性格:${M}${x}`}).join(`
`)}
...
・登場人物の詳細メモに時代不適合な現代表現があっても、時代に即した表現に自動で読み替えること。`,f=he(a,Bn),h=he(i,Pn),v=he(r,Dn),b=he(o,jn),$=he(c,Vn);let C="";f&&(C+=`
...
【語り口指定：${c}】
${$}`);const w=tr(e.charCount);let I;if(w>0){const S=Math.min(Math.max(Math.round(w/8e3),6),12),E=Math.round(w/S),N=Math.max(4500,Math.min(9e3,Math.round(E*.6)));I=`全${S}章構成（目安）、各章約${Math.round(E/1e3)}千字、各章本文は最低${N.toLocaleString()}字、予定総文字数：約${Math.round(w/1e4)}万字`}else I="10万字以上を目安に、物語の内容に最適な章数と文字数をAI自身が自由に設計してください（推奨: 8〜12章、各章8千〜1万5千字、各章本文は最低6千字）";return{genre:a,theme:n,worldview:r,era:s,target:o,ending:i,narr:c,charDesc:p,characterRosterRule:g,supplement:d,eraRule:y,allCategoryGuides:C,chapterGuidance:I}}const Gn=`
【伏線・構成ルール（各章で厳守）】
...
□ 全キャラの物語的機能 □ GMC+Sの明確性 □ 五感バランス □ 比喩の独自性 □ キャラ知識境界 □ 反復描写の防止 □ 章別エピソードの固有性 □ 非最終章の総決算禁止 □ 脚注・引用番号なし`;function nr(e){const t=be(e),a=(l.longNovel&&l.longNovel.chapterRetryNotes||{})[1]||"",n=`あなたはプロのベストセラー小説家です。以下の設定に基づき、本格的な長編小説の**第1章**を執筆してください。
...
★★★ 文脈維持メモまで出力したら出力を停止してください。「続けますか？」等の質問は不要です（アプリが自動制御します）。★★★`,r=["長編小説",t.genre,t.theme,t.era].filter(Boolean);return{prompt:n,tags:r}}function Kn(e){const t=String(e||"").trim();if(!t)return"";const a=t.split(/(?=---\s*第[\d０-９一二三四五六七八九十]+章の文脈メモ\s*---)/).map(n=>n.trim()).filter(Boolean);return a.length?a[a.length-1]:t}function ar(e,t){const a=Kn(e);if(!a)return"";const n=[new RegExp(`【第${t}章のシーン設計（GMC\\+S）】([\\s\\S]*?)(?=\\n【|\\n---|$)`),/【次章のシーン設計（GMC\+S）】([\s\S]*?)(?=\n【|\n---|$)/,/【次章のシーン設計】([\s\S]*?)(?=\n【|\n---|$)/];for(const r of n){const s=a.match(r);if(s!=null&&s[1])return s[1].trim()}return""}function rr(e,t,a=""){const n=Kn(t),r=ar(t,e),s=n?n.slice(0,1800):"（直近の文脈メモなし）";return`
【第${e}章の連続性ガード・最優先】
...
${a?`【前回失敗からの再生成指示】
${a}
`:""}`}function sr(e,t,a,n,r,s,o,i=""){const c=be(a),u=rr(e,s,i),p=String(r||"").trim().slice(-900);let g="",d="";return o&&(g=`
...
--- ここまでコピー ---
`}const or=`この画像はアニメ/漫画のキャラクターシート（設定画・三面図など）です。
...
出力例:
[{"name":"アカリ","sex":"女性","role":"主人公(推定)","personality":"元気","note":"内巻きのミディアムボブ, オレンジ髪, セーラー服, ロングヘア厳禁, 眼鏡厳禁, 甘いものが大好き"}]`;function ir(e){return new Promise((t,a)=>{const n=new FileReader;n.onload=()=>{const r=n.result.split(",")[1];t(r)},n.onerror=a,n.readAsDataURL(e)})}function lr(e){let t="",a=!1;for(let n=0;n<e.length;n++){const r=e[n];a?r==="\\"?(t+=r,n+1<e.length&&(t+=e[n+1],n++)):r==='"'?(a=!1,t+=r):r===`
`?t+="\\n":r==="\r"?(t+="\\n",n+1<e.length&&e[n+1]===`
`&&n++):r==="	"?t+="\\t":t+=r:(r==='"'&&(a=!0),t+=r)}return t}function cr(e){const t=e.replace(/```json\s*/gi,"").replace(/```\s*/g,"").trim().match(/\[[\s\S]*\]/);if(!t)throw new Error("AIの応答からキャラクター情報を抽出できませんでした");let a=t[0];try{return JSON.parse(a)}catch(r){console.warn("キャラクターJSON初回パース失敗、修復を試行:",r.message)}let n=lr(a);n=n.replace(/,\s*([\]}])/g,"$1");try{return JSON.parse(n)}catch(r){throw new Error(`AIの応答JSONの解析に失敗しました。元のエラー: ${r.message}`)}}function ur(e){if(!e)return"";const t=e.replace(/\(推定\)/g,"").trim();return Ee.find(a=>a===t)||Ee.find(a=>t.includes(a)||a.includes(t))||t}function dr(e){if(!e)return"";const t=e.replace(/\(推定\)/g,"").trim();return xe.find(a=>a===t)||xe.find(a=>t.includes(a)||a.includes(t))||t}function pr(e,t){const a=Ee.map(i=>`<option value="${i}">${i}</option>`).join(""),n=xe.map(i=>`<option value="${i}">${i}</option>`).join(""),r=e.map((i,c)=>`
  ...
  `}function hr(e,t){const a=document.getElementById("ci-modal");a&&(a.querySelectorAll(".ci-role-select").forEach(n=>{const r=n.dataset.idx,s=a.querySelector(`.ci-role-input[data-idx="${r}"]`),o=Ee.find(i=>i===s.value);o&&(n.value=o),n.addEventListener("change",()=>{n.value&&(s.value=n.value)}),s.addEventListener("input",()=>{const i=Ee.find(c=>c===s.value);n.value=i||""})}),a.querySelectorAll(".ci-personality-select").forEach(n=>{const r=n.dataset.idx,s=a.querySelector(`.ci-personality-input[data-idx="${r}"]`),o=xe.find(i=>i===s.value);o&&(n.value=o),n.addEventListener("change",()=>{n.value&&(s.value=n.value)}),s.addEventListener("input",()=>{const i=xe.find(c=>c===s.value);n.value=i||""})}),document.getElementById("ci-modal-close").addEventListener("click",()=>a.remove()),document.getElementById("ci-btn-cancel").addEventListener("click",()=>a.remove()),document.getElementById("ci-btn-register").addEventListener("click",()=>{const n=[];a.querySelectorAll(".ci-check").forEach(r=>{var s,o,i,c,u;if(!r.checked)return;const p=parseInt(r.dataset.idx),g=((s=a.querySelector(`.ci-name[data-idx="${p}"]`))==null?void 0:s.value)||"",d=((o=a.querySelector(`.ci-sex[data-idx="${p}"]`))==null?void 0:o.value)||"",y=((i=a.querySelector(`.ci-role-input[data-idx="${p}"]`))==null?void 0:i.value)||"",f=((c=a.querySelector(`.ci-personality-input[data-idx="${p}"]`))==null?void 0:c.value)||"",h=((u=a.querySelector(`.ci-note[data-idx="${p}"]`))==null?void 0:u.value)||"";n.push({name:g,sex:d,role:y,personality:f,note:h})}),t(n),a.remove()}))}function mr(e,t,a){const n=document.getElementById("ci-dropzone"),r=document.getElementById("ci-file-input"),s=document.getElementById("ci-status");if(!n||!r)return;n.addEventListener("dragover",c=>{c.preventDefault(),!(e.locked&&e.locked.chars)&&n.classList.add("ci-dragover")}),n.addEventListener("dragleave",()=>{n.classList.remove("ci-dragover")}),n.addEventListener("drop",c=>{if(c.preventDefault(),n.classList.remove("ci-dragover"),e.locked&&e.locked.chars)return;const u=Array.from(c.dataTransfer.files).filter(p=>p.type.startsWith("image/"));u.length>0&&o(u)}),n.addEventListener("click",()=>{e.locked&&e.locked.chars||r.click()}),r.addEventListener("change",c=>{if(e.locked&&e.locked.chars)return;const u=Array.from(c.target.files).filter(p=>p.type.startsWith("image/"));u.length>0&&(o(u),c.target.value="")});async function o(c){if(e.locked&&e.locked.chars)return;const u=a();if(!u){alert("APIキーを先に保存してください");return}const p=["image/png","image/jpeg","image/webp","image/gif"],g=c.filter(h=>p.includes(h.type)?!0:(console.warn(`非対応形式スキップ: ${h.name} (${h.type})`),!1));if(g.length===0){alert(`対応する画像ファイルがありません。
PNG/JPG/WEBP/GIF のみ対応しています。`);return}n.classList.add("ci-loading");const d=document.getElementById("global-alert");d&&(d.innerHTML="⚠️ <strong>画像認識中:</strong> AIがキャラクターシートを解析しています。完了まで数秒〜数十秒お待ちください。",d.style.display="flex"),s&&(s.textContent=`🔍 ${g.length}枚の画像を解析中...（数秒〜数十秒）`,s.classList.remove("hidden"));const y=[],f=[];try{for(let h=0;h<g.length;h++){const v=g[h];s&&g.length>1&&(s.textContent=`🔍 画像 ${h+1}/${g.length} を解析中...`),d&&g.length>1&&(d.innerHTML=`⚠️ <strong>画像認識中 (${h+1}/${g.length}):</strong> AIがキャラクターシートを解析しています...`);const b=await ir(v);f.push(`data:${v.type};base64,${b}`);const{text:$}=await Rn(u,or,b,v.type,void 0,{responseMimeType:"application/json"}),C=cr($);C&&C.length>0&&(C.forEach(w=>{w.role=ur(w.role),w.personality=dr(w.personality)}),y.push(...C))}if(y.length===0)throw new Error("キャラクター情報を検出できませんでした。設定テキストが含まれた画像をお試しください。");i(y,f),s&&(s.textContent=`✅ ${y.length}キャラクター検出！確認してください。`)}catch(h){console.error("Character import error:",h),s&&(s.textContent=`❌ エラー: ${h.message}`),setTimeout(()=>{s&&s.classList.add("hidden")},5e3)}finally{n.classList.remove("ci-loading"),d&&(d.style.display="none")}}function i(c,u){var p;(p=document.getElementById("ci-modal"))==null||p.remove();const g=document.createElement("div");g.innerHTML=pr(c,u),document.body.appendChild(g.firstElementChild),hr(c,d=>{d.forEach(y=>{e.characters.push({name:y.name||"",sex:y.sex||"",role:y.role||"",personality:y.personality||"",note:y.note||""})}),t(),s&&(s.textContent=`✅ ${d.length}キャラクターを登録しました！`,setTimeout(()=>s.classList.add("hidden"),3e3))})}}const A=e=>document.getElementById(e);let X=[],ne=[],le=null,Be="",_e=()=>"",it=()=>"";const Et=`あなたはプロの文芸批評家・計量文体学の専門家です。
...
## リライト結果:`}function qn(e){const t=A("settings");t&&t.classList.add("generating");const a=A("sa-section");a&&a.classList.add("generating");const n=document.querySelector(".btn-generate");n&&(n._origText=n.textContent,n.disabled=!0,n.innerHTML=`<span class="spinner"></span>${e}`);const r=A("sa-api-status");r&&(r.innerHTML=`<span class="spinner"></span>${e}`,r.classList.remove("hidden"));const s=A("sa-reflect-api-status");s&&(s.innerHTML=`<span class="spinner"></span>${e}`,s.classList.remove("hidden"));const o=A("global-alert");o&&(o.innerHTML=`⚠️ <strong>稼働中:</strong> ${e}`,o.style.display="flex");const i=A("thought-score-board");i&&(i.style.display="none")}function Cn(e){const t=A("sa-api-status");t&&(t.innerHTML=`<span class="spinner"></span>${e}`);const a=A("sa-reflect-api-status");a&&(a.innerHTML=`<span class="spinner"></span>${e}`);const n=document.querySelector(".btn-generate");n&&(n.innerHTML=`<span class="spinner"></span>${e}`);const r=A("global-alert");r&&(r.innerHTML=`⚠️ <strong>稼働中:</strong> ${e}`);const s=A("thought-score-board");s&&(s.style.display="none")}function Un(){const e=A("settings");e&&e.classList.remove("generating");const t=A("sa-section");t&&t.classList.remove("generating");const a=document.querySelector(".btn-generate");a&&(a.disabled=!1,a.textContent=a._origText||"ストーリー生成");const n=A("sa-api-status");n&&n.classList.add("hidden");const r=A("sa-reflect-api-status");r&&r.classList.add("hidden");const s=A("global-alert");s&&(s.style.display="none")}function yr(){const e=A("sa-dropzone"),t=A("sa-file-input");!e||!t||(e.addEventListener("click",()=>t.click()),e.addEventListener("dragover",a=>{a.preventDefault(),e.classList.add("sa-dragover")}),e.addEventListener("dragleave",()=>{e.classList.remove("sa-dragover")}),e.addEventListener("drop",a=>{a.preventDefault(),e.classList.remove("sa-dragover"),wn(a.dataTransfer.files)}),t.addEventListener("change",a=>{wn(a.target.files),t.value=""}))}async function wn(e){const t=Array.from(e),a=t.filter(r=>r.type==="text/plain"||r.name.endsWith(".txt")||r.name.endsWith(".md")||r.name.endsWith(".csv")||r.type===""),n=t.filter(r=>r.type.startsWith("image/"));if(a.length===0&&n.length===0){alert("テキストファイル (.txt, .md) または画像ファイルをドロップしてください");return}for(const r of a)try{const s=await vr(r);s.trim().length>0&&X.push({name:r.name,text:s.trim(),charCount:s.trim().length})}catch(s){console.warn(`ファイル読み込み失敗: ${r.name}`,s)}for(const r of n)try{const s=await br(r),o=URL.createObjectURL(r);ne.push({name:r.name,base64:s,mimeType:r.type,previewUrl:o})}catch(s){console.warn(`画像ファイル読み込み失敗: ${r.name}`,s)}ft(),Yt(),(X.length>0||ne.length>0)&&A("sa-dropzone").classList.add("sa-has-files"),$e()}function vr(e){return new Promise((t,a)=>{const n=new FileReader;n.onload=r=>t(r.target.result),n.onerror=a,n.readAsText(e,"UTF-8")})}function br(e){return new Promise((t,a)=>{const n=new FileReader;n.onload=r=>{const s=r.target.result.split(",")[1];t(s)},n.onerror=a,n.readAsDataURL(e)})}function ft(){const e=A("sa-file-list");if(!e)return;const t=X.reduce((n,r)=>n+r.charCount,0),a=A("sa-file-count");a&&(a.textContent=`${X.length}件 / ${t.toLocaleString()}字`,a.classList.remove("hidden")),e.innerHTML=X.map((n,r)=>`
    <div class="sa-file-item">
      <span class="sa-file-name">📄 ${Lt(n.name)}</span>
      <span class="sa-file-chars">${n.charCount.toLocaleString()}字</span>
      <button class="sa-file-remove" data-idx="${r}" title="除去">✕</button>
    </div>
  `).join(""),e.querySelectorAll(".sa-file-remove").forEach(n=>{n.addEventListener("click",r=>{const s=parseInt(r.target.dataset.idx);X.splice(s,1),ft(),X.length===0&&(A("sa-dropzone").classList.remove("sa-has-files"),A("sa-file-count").classList.add("hidden")),$e()})})}function Yt(){const e=A("sa-image-list");if(e){if(ne.length===0){e.classList.add("hidden"),e.innerHTML="";return}e.classList.remove("hidden"),e.innerHTML=ne.map((t,a)=>`
    <div class="sa-image-item">
      <img src="${t.previewUrl}" alt="${Lt(t.name)}" class="sa-image-thumb" />
      <span class="sa-image-name">${Lt(t.name)}</span>
      <button class="sa-file-remove" data-img-idx="${a}" title="除去">✕</button>
    </div>
  `).join(""),e.querySelectorAll(".sa-file-remove").forEach(t=>{t.addEventListener("click",a=>{var n;const r=parseInt(a.target.dataset.imgIdx);(n=ne[r])!=null&&n.previewUrl&&URL.revokeObjectURL(ne[r].previewUrl),ne.splice(r,1),Yt(),X.length===0&&ne.length===0&&A("sa-dropzone").classList.remove("sa-has-files"),$e()})})}}function $r(e){const t=e.indexOf("{");if(t===-1)return null;const a=e.lastIndexOf("}");return a===-1||a<t?null:e.slice(t,a+1)}function Cr(e){let t="",a=!1;for(let n=0;n<e.length;n++){const r=e[n];a?r==="\\"?(t+=r,n+1<e.length&&(t+=e[n+1],n++)):r==='"'?(a=!1,t+=r):r===`
`?t+="\\n":r==="\r"?(t+="\\n",n+1<e.length&&e[n+1]===`
`&&n++):r==="	"?t+="\\t":t+=r:(r==='"'&&(a=!0),t+=r)}return t}const wr=["style_name","tone","narrative_voice","person","distance","reliability","intrusion","sentence_style","avg_length","length_variation","ending_patterns","rhythm","paragraph_length","paragraph_structure","vocabulary","level","density","register","quirks","foreign_words","archaic_modern","rhetoric","metaphor_style","metaphor_source","repetition","irony_level","humor_type","other_techniques","description_focus","visual","auditory","tactile","olfactory_gustatory","kinesthetic","spatial","psychological_depth","show_tell_ratio","dialogue","style","function","tag_style","dialect_sociolect","subtext","structure","pacing","scene_transition","time_handling","tension_curve","opening_style","closing_style","emotional_architecture","dominant_emotions","emotional_range","catharsis_method","reader_distance","themes_tendency","literary_influences","unique_features","anti_patterns","reproduction_prompt"];function Er(e){let t=e.trim();t=t.replace(/\/\/[^\n]*/g,""),t=t.replace(/\/\*[\s\S]*?\*\//g,"");const a=[];if(wr.forEach(r=>{const s=new RegExp(`"${r}"\\s*:`,"g");let o;for(;(o=s.exec(t))!==null;)a.push({key:r,start:o.index,end:o.index+o[0].length})}),a.sort((r,s)=>r.start-s.start),a.length===0)return JSON.parse(t);const n={};for(let r=0;r<a.length;r++){const s=a[r],o=a[r+1],i=s.end;let c=o?o.start:t.length,u=t.slice(i,c).trim();if(!o){const p=u.lastIndexOf("}");p!==-1&&(u=u.slice(0,p).trim())}if(u=u.replace(/^[,\s\r\n\t]+|[,\s\r\n\t]+$/g,""),u.startsWith("[")&&u.endsWith("]")){let p=u.slice(1,-1).trim();const g=[],d=p.split(/",\s*"/);d.forEach((y,f)=>{let h=y.trim();f===0&&h.startsWith('"')&&(h=h.slice(1)),f===d.length-1&&h.endsWith('"')&&(h=h.slice(0,-1)),h=h.replace(/"/g,'\\"'),h=h.replace(/\r?\n/g,"\\n").replace(/\t/g,"\\t"),g.push(h)}),n[s.key]=g}else{let p=!1;u.startsWith('"')&&(u=u.slice(1),p=!0),u.endsWith('"')&&(u=u.slice(0,-1)),p&&(u=u.replace(/"/g,'\\"'),u=u.replace(/\r?\n/g,"\\n").replace(/\t/g,"\\t")),n[s.key]=u}}return{style_name:n.style_name||"",tone:n.tone||"",narrative_voice:{person:n.person||"",distance:n.distance||"",reliability:n.reliability||"",intrusion:n.intrusion||""},sentence_style:{avg_length:n.avg_length||"",length_variation:n.length_variation||"",ending_patterns:n.ending_patterns||"",rhythm:n.rhythm||"",paragraph_length:n.paragraph_length||"",paragraph_structure:n.paragraph_structure||""},vocabulary:{level:n.level||"",density:n.density||"",register:n.register||"",quirks:n.quirks||"",foreign_words:n.foreign_words||"",archaic_modern:n.archaic_modern||""},rhetoric:{metaphor_style:n.metaphor_style||"",metaphor_source:n.metaphor_source||"",repetition:n.repetition||"",irony_level:n.irony_level||"",humor_type:n.humor_type||"",other_techniques:n.other_techniques||""},description_focus:{visual:n.visual||"",auditory:n.auditory||"",tactile:n.tactile||"",olfactory_gustatory:n.olfactory_gustatory||"",kinesthetic:n.kinesthetic||"",spatial:n.spatial||"",psychological_depth:n.psychological_depth||"",show_tell_ratio:n.show_tell_ratio||""},dialogue:{style:n.style||"",function:n.function||"",tag_style:n.tag_style||"",dialect_sociolect:n.dialect_sociolect||"",subtext:n.subtext||""},structure:{pacing:n.pacing||"",scene_transition:n.scene_transition||"",time_handling:n.time_handling||"",tension_curve:n.tension_curve||"",opening_style:n.opening_style||"",closing_style:n.closing_style||""},emotional_architecture:{dominant_emotions:n.dominant_emotions||"",emotional_range:n.emotional_range||"",catharsis_method:n.catharsis_method||"",reader_distance:n.reader_distance||""},themes_tendency:n.themes_tendency||"",literary_influences:n.literary_influences||"",unique_features:Array.isArray(n.unique_features)?n.unique_features:[],anti_patterns:Array.isArray(n.anti_patterns)?n.anti_patterns:[],reproduction_prompt:n.reproduction_prompt||""}}function xr(e){try{return JSON.parse(e)}catch(a){console.warn("JSON初回パース失敗、修復を試行:",a.message)}let t=e.trim();t=Cr(t),t=t.replace(/\/\/[^\n]*/g,""),t=t.replace(/\/\*[\s\S]*?\*\//g,""),t=t.replace(/(\{|,)\s*'([^']+)'\s*:/g,'$1"$2":'),t=t.replace(/,\s*([\]}])/g,"$1");try{return JSON.parse(t)}catch(a){console.warn("JSON修復パース失敗、キー境界ベースの頑健なパースに移行します:",a.message);try{return Er(t)}catch(n){console.warn("キー境界パースも失敗、最後の攻撃的修復を試行:",n.message);try{let r=t.replace(/\\(?!["\\/bfnrtu])/g,"\\\\");return JSON.parse(r)}catch(r){throw new Error(`AIの応答JSONの解析に失敗しました。元のエラー: ${r.message}`)}}}}function Lt(e){return(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}async function kr(){const e=_e();if(!e){alert("APIキーを保存してから解析してください");return}const t=A("sa-direct-text"),a=t?t.value.trim():"";if(X.length===0&&ne.length===0&&!a){alert("テキスト（ファイルドロップまたは直接貼り付け）か画像を投入してください");return}const n=A("btn-sa-analyze"),r=A("sa-result-wrap"),s=A("sa-result"),o=A("sa-reflect-wrap"),i=A("sa-reflect-result-wrap"),c=A("progress-log"),u=A("thought-score-board"),p=A("progress-title-text");c&&(c.textContent="作風解析の開始を待っています..."),u&&(u.innerHTML="",u.style.display="none"),p&&(p.textContent="AI進捗・思考ログ: 作風解析中..."),n.disabled=!0,n.innerHTML='<span class="spinner"></span>AIが超強引に作風を解析中...',s.textContent="超強引に解析中です...しばらくお待ちください（1分〜3分程度）",r.classList.remove("hidden"),o.classList.add("hidden"),i.classList.add("hidden"),qn("🔬 超強引！作風解析中...");try{let g=[];X.length>0&&(g=X.map(w=>`--- ${w.name} ---
...
- 画像のトーン（暖色系/寒色系/モノクロ等）を tone に反映すること`)),f&&(h=h+d);const v=ve[0].value;let b;y?b=(await Wa(e,h,ne,w=>{Cn(`フォールバック: ${w}`),n.innerHTML=`<span class="spinner"></span>フォールバック: ${w}`},{responseMimeType:"application/json",timeoutMs:9e4,temperature:.1})).text:b=(await Je(e,v,h,w=>{Cn(`フォールバック: ${w}`),n.innerHTML=`<span class="spinner"></span>フォールバック: ${w}`},{responseMimeType:"application/json",timeoutMs:9e4,temperature:.1})).text;let $="";const C=$r(b);if(C)$=C;else{const w=b.match(/```json\s*([\s\S]*?)\s*```/);if(w)$=w[1];else{const I=b.match(/\{[\s\S]*\}/);if(I)$=I[0];else throw new Error("AIの応答からJSONを抽出できませんでした")}}le=xr($),Ar(le),p&&(p.textContent="AI進捗・思考ログ: 作風解析完了"),c&&(c.textContent=`作風解析が完了しました。解析結果が右パネルに表示されています。
...
${g.message}`)}finally{n.disabled=!1,n.innerHTML="🔬 超強引！作風解析を実行",Un()}}function Ar(e){var t,a;const n=A("sa-result");n.classList.remove("sa-error");const r=[],s=(c,u,p)=>{p&&r.push(`${c} ${u}: ${p}`)},o=(c,u)=>{u&&r.push(`  ・${c}: ${u}`)},i=(c,u)=>{r.push(""),r.push(`${c} ${u}:`)};s("🏷️","作風名",e.style_name),s("🎭","トーン",e.tone),typeof e.narrative_voice=="object"&&e.narrative_voice?(i("🎙️","語りの視点"),o("人称",e.narrative_voice.person),o("距離感",e.narrative_voice.distance),o("信頼度",e.narrative_voice.reliability),o("介入度",e.narrative_voice.intrusion)):s("🎙️","語りの視点",e.narrative_voice),i("📝","文体"),e.sentence_style&&(o("平均文長",e.sentence_style.avg_length||e.sentence_style.length),o("文長変動",e.sentence_style.length_variation),o("文末パターン",e.sentence_style.ending_patterns||e.sentence_style.ending),o("リズム",e.sentence_style.rhythm),o("段落長",e.sentence_style.paragraph_length),o("段落構成",e.sentence_style.paragraph_structure)),i("📖","語彙"),e.vocabulary&&(o("レベル",e.vocabulary.level),o("情報密度",e.vocabulary.density),o("レジスター",e.vocabulary.register),o("特徴",e.vocabulary.quirks),o("外来語",e.vocabulary.foreign_words),o("古語/現代語",e.vocabulary.archaic_modern)),e.rhetoric&&(i("🔮","修辞技法"),o("比喩スタイル",e.rhetoric.metaphor_style),o("比喩素材",e.rhetoric.metaphor_source),o("反復技法",e.rhetoric.repetition),o("アイロニー",e.rhetoric.irony_level),o("ユーモア",e.rhetoric.humor_type),o("その他",e.rhetoric.other_techniques)),i("🖼️","描写フォーカス"),e.description_focus&&(o("視覚",e.description_focus.visual),o("聴覚",e.description_focus.auditory),o("触覚",e.description_focus.tactile),o("嗅覚/味覚",e.description_focus.olfactory_gustatory),o("運動感覚",e.description_focus.kinesthetic),o("空間把握",e.description_focus.spatial),o("心理描写",e.description_focus.psychological_depth||e.description_focus.psychological),o("Show:Tell",e.description_focus.show_tell_ratio)),e.dialogue?(i("💬","セリフ"),o("文体",e.dialogue.style),o("機能",e.dialogue.function),o("タグ",e.dialogue.tag_style),o("方言",e.dialogue.dialect_sociolect),o("サブテキスト",e.dialogue.subtext)):s("💬","セリフ回し",e.dialogue_style),e.structure?(i("🏗️","構造"),o("テンポ",e.structure.pacing),o("場面転換",e.structure.scene_transition),o("時制",e.structure.time_handling),o("緊張曲線",e.structure.tension_curve),o("冒頭パターン",e.structure.opening_style),o("結末パターン",e.structure.closing_style)):s("⏱️","テンポ",e.pacing),e.emotional_architecture&&(i("❤️","感情設計"),o("主要感情",e.emotional_architecture.dominant_emotions),o("振り幅",e.emotional_architecture.emotional_range),o("カタルシス",e.emotional_architecture.catharsis_method),o("読者距離",e.emotional_architecture.reader_distance)),s("🎯","テーマ傾向",e.themes_tendency),s("📚","文学的影響",e.literary_influences),r.push(""),(t=e.unique_features)!=null&&t.length&&(r.push("✨ 固有の特徴:"),e.unique_features.forEach(c=>r.push(`  ・${c}`))),(a=e.anti_patterns)!=null&&a.length&&(r.push(""),r.push("🚫 回避パターン:"),e.anti_patterns.forEach(c=>r.push(`  ・${c}`))),r.push(""),r.push("━━━ 再現プロンプト ━━━"),r.push(e.reproduction_prompt||"（生成されませんでした）"),n.textContent=r.join(`
`)}async function Sr(){const e=_e();if(!e){alert("APIキーを保存してください");return}if(!le){alert("先に作風解析を実行してください");return}const t=it(),a=A("output");if(!t||t.length<10||a&&a.classList.contains("empty")){alert("まず上のストーリー生成でテキストを生成してから、リライトを実行してください");return}const n=A("btn-sa-reflect"),r=A("sa-reflect-result-wrap"),s=A("sa-reflect-output");n.disabled=!0,n.innerHTML='<span class="spinner"></span>作風を反映してリライト中...',s.textContent="リライト中です...（完了後に一括表示されます）",r.classList.remove("hidden");const o=A("progress-log"),i=A("thought-score-board"),c=A("progress-title-text");o&&(o.textContent="作風リライトの開始を待っています..."),i&&(i.innerHTML="",i.style.display="none"),c&&(c.textContent="AI進捗・思考ログ: リライト準備中..."),qn("🎨 作風リライト中...");let u=[],p="",g="",d=null;function y(h){u.push(h),f()}function f(){if(!o)return;let h="";u.length>0&&(h+=u.join(`
`)+`
`),p&&(h+=p+`
`),g&&(h+=`
`+g),o.textContent=h;const v=A("progress-content");v&&(v.scrollTop=v.scrollHeight)}y("[システム] 作風リライト処理を開始しました..."),y(`[システム] 対象ストーリー文字数: ${t.length.toLocaleString()} 字`),y("[システム] 抽出済みの作風パラメータ（文体・語彙・感情設計）を抽出中..."),y("[システム] リライト用メタプロンプトの構築が完了しました。");try{const h=fr(le,t),v=ve[0].value;y(`[システム] AIモデル (${v}) にリライト要求を送信しています...`);let b=0,$=new Set;d=setInterval(()=>{b++,p=`[通信] AIモデルからのリライト応答を待機しています${".".repeat(b%4)} (${b}秒経過)`,b>=3&&!$.has(3)&&($.add(3),u.push("[適用中] 抽出作風「平均文長・段落構成」の文体フィルタをマッピング中...")),b>=6&&!$.has(6)&&($.add(6),u.push("[適用中] 語彙特徴・修辞スタイル（比喩の方向性）の適応率を計算中...")),b>=9&&!$.has(9)&&($.add(9),u.push("[適用中] キャラクターの対話タグ・感情設計の整合性シミュレーションを実施中...")),b>=12&&!$.has(12)&&($.add(12),u.push("[適用中] 読者距離と pacing（テンポ）の緊張曲線をリライトプロットにマージ完了。")),b>=15&&b%5===0&&!$.has(b)&&($.add(b),u.push(`[再構築中] AIが文体適合度を最大化させるためのリライトプロセス (${b}s) を実行しています...`)),f()},1e3);let C="",w=!1;c&&(c.textContent="AI進捗・思考ログ: リライト執筆中...");const I=({text:M})=>{w||(w=!0,p="",f(),d&&(clearInterval(d),d=null)),C+=M;const x=C.length;let _=`[システム] AIによるリライト文章の生成が開始されました。
`;_+=`[進捗] 本文をリライト中...
`,_+=`・現在文字数: ${x} 文字
`;const H=Math.floor(x/50%4),L=".".repeat(H)+" ".repeat(3-H);_+=`・ステータス: 執筆処理中${L}
`,g=_,f()},S=M=>{s.textContent=`フォールバック中: ${M}...`,n.innerHTML=`<span class="spinner"></span>フォールバック: ${M}`,y(`[システム] リライト応答遅延のため、モデルを ${M} にフォールバックします...`)};let{usedModel:E}=await ke(e,v,h,I,S,{disableGoogleSearch:!0}),N=0;for(;N<3&&!C.trim().endsWith("【完】");){N++,y(`[システム] 文字数上限到達による切断を検知。続きを自動リクエスト中... (${N}/3)`),p=`[通信] 続きを生成しています... (${N}/3)`,f();const M=`${h}

【ここまでの出力】
${C}

※文字数上限（トークンオーバー）で出力が途切れています。上記の続きの文字から、そのまま物語を再開してください。これまでの文章の繰り返しや前置きは一切不要です。続きのみを生成し、必ず最後は「【完】」で締めくくってください。`;E=(await ke(e,E,M,I,S,{disableGoogleSearch:!0})).usedModel}d&&(clearInterval(d),d=null),n.innerHTML='<span class="spinner"></span>最終推敲中...';let P=C.replace(/^```(markdown)?\s*/i,"").replace(/\s*```$/,"");Be=P,s.textContent=P;const k=A("sa-reflect-counter");k&&(k.textContent=`${P.length.toLocaleString()} 字`),c&&(c.textContent="AI進捗・思考ログ: リライト完了"),y("[システム] 作風リライト文の生成・推敲が正常に完了しました。"),g=`[進捗] リライトが正常に完了しました。
・最終文字数: ${P.length.toLocaleString()} 字
・ステータス: 完了`,p="",f(),r.scrollIntoView({behavior:"smooth",block:"start"})}catch(h){d&&(clearInterval(d),d=null),p="",f(),s.textContent=`リライトエラー: ${h.message}`}finally{n.disabled=!1,n.innerHTML="🎨 この作風でリライト実行",Un()}}function Lr(){if(!le)return;const e=A("sa-result").textContent;navigator.clipboard.writeText(e).then(()=>{const t=A("btn-sa-copy");t.textContent="✅ コピー完了",setTimeout(()=>t.textContent="📋 コピー",2e3)})}function Wn(){const e=new Date;return`${e.getFullYear()}${String(e.getMonth()+1).padStart(2,"0")}${String(e.getDate()).padStart(2,"0")}${String(e.getHours()).padStart(2,"0")}${String(e.getMinutes()).padStart(2,"0")}${String(e.getSeconds()).padStart(2,"0")}`}function Ir(){if(!le)return;const e=JSON.stringify(le,null,2),t=new Blob([e],{type:"application/json"}),a=document.createElement("a");a.href=URL.createObjectURL(t);const n=(le.style_name||"style_analysis").replace(/[\s\/\\:*?"<>|]/g,"_");a.download=`${n}_${Wn()}.json`,a.click()}function Tr(){Be&&navigator.clipboard.writeText(Be).then(()=>{const e=A("btn-sa-reflect-copy");e.textContent="✅ コピー完了",setTimeout(()=>e.textContent="📋 コピー",2e3)})}function _r(){if(!Be)return;const e=new Blob([Be],{type:"text/plain"}),t=document.createElement("a");t.href=URL.createObjectURL(e),t.download=`style_rewrite_${Wn()}.txt`,t.click()}function Nr(){var e,t,a,n;ne.forEach(s=>{s.previewUrl&&URL.revokeObjectURL(s.previewUrl)}),X=[],ne=[],le=null,Be="",ft(),Yt();const r=A("sa-direct-text");r&&(r.value=""),lt(),A("sa-dropzone").classList.remove("sa-has-files"),(e=A("sa-file-count"))==null||e.classList.add("hidden"),$e(),Re(),A("sa-result").textContent="",(t=A("sa-result-wrap"))==null||t.classList.add("hidden"),(a=A("sa-reflect-wrap"))==null||a.classList.add("hidden"),(n=A("sa-reflect-result-wrap"))==null||n.classList.add("hidden")}function Mr(){const e=A("sa-direct-text");if(!e)return;const t=e.value.trim();t&&(X.push({name:`直接入力テキスト_${X.length+1}`,text:t,charCount:t.length}),e.value="",ft(),A("sa-dropzone").classList.add("sa-has-files"),$e(),lt())}function lt(){const e=A("btn-sa-add-text");if(!e)return;const t=A("sa-direct-text"),a=t&&t.value.trim().length>0;e.disabled=!a}function yt(){const e=A("sa-section");e&&(typeof _e=="function"&&_e()?e.classList.remove("sa-inactive"):e.classList.add("sa-inactive"))}function $e(){const e=A("btn-sa-analyze");if(!e)return;const t=typeof _e=="function"?_e():"",a=X.length>0,n=ne.length>0,r=A("sa-direct-text"),s=r?r.value:"",o=s.trim().length>0,i=a||n||o;let c=s.length;X.forEach(p=>c+=p.content?p.content.length:0);const u=document.getElementById("api-engine");if(u&&u.value==="openai"&&c>8e4){e.disabled=!0,e.textContent="⚠ 文字数超過 (OpenAI制限)",e.title="OpenAIモデルの入力上限を超える可能性が高いため実行できません。テキストを削るか、Geminiをご利用ください。";return}e.disabled=!(t&&i),e.textContent="🔬 超強引！作風解析を実行",e.title=""}function Re(){const e=A("btn-sa-reflect");if(!e)return;const t=typeof it=="function"?it():"",a=A("output"),n=t&&t.length>=10&&a&&!a.classList.contains("empty"),r=le!==null;e.disabled=!(n&&r)}function Fr(e,t){var a,n,r,s,o,i,c,u;_e=e,it=t,yr(),(a=A("btn-sa-analyze"))==null||a.addEventListener("click",kr),(n=A("btn-sa-reflect"))==null||n.addEventListener("click",Sr),(r=A("btn-sa-copy"))==null||r.addEventListener("click",Lr),(s=A("btn-sa-json"))==null||s.addEventListener("click",Ir),(o=A("btn-sa-reflect-copy"))==null||o.addEventListener("click",Tr),(i=A("btn-sa-reflect-dl"))==null||i.addEventListener("click",_r),(c=A("btn-sa-clear"))==null||c.addEventListener("click",Nr),(u=A("btn-sa-add-text"))==null||u.addEventListener("click",Mr);const p=A("sa-direct-text");p&&p.addEventListener("input",()=>{$e(),lt()}),yt(),lt()}function Or(e,t){const a=Qt(t),n=zn(t);return`あなたはプロの校閲者・整合性チェッカーです。以下の物語テキストを精査し、**明確な事実矛盾**のみを検出してください。
...
\`\`\`
矛盾がない場合は必ず \`[]\` のみを出力すること。`}function Rr(e,t,a,n,r,s=!1){const o=Qt(a),i=zn(a);return`あなたはプロの校閲者・整合性チェッカーです。長編小説の**第${t}章**を精査し、過去の章との間で**明確な事実矛盾**のみを検出してください。
...
\`\`\`
矛盾がない場合は必ず \`[]\` のみを出力すること。`}function Br(e,t,a,n){const r=t.map((i,c)=>`${c+1}. 【${i.type}】${i.description}（箇所：『${i.location}』）`).join(`
`),s=Qt(a);let o="";return n&&(o=`
...
## 修正後のテキスト（本文のみ出力）:`}function Pr(e){if(!e||!e.trim())return[];let t=e.trim();t=t.replace(/^```(?:json)?\s*/i,"").replace(/\s*```$/,"");try{const a=JSON.parse(t);return Array.isArray(a)?a.filter(n=>n&&typeof n=="object"&&n.type&&n.description).map(n=>({type:String(n.type||""),severity:String(n.severity||"軽微"),location:String(n.location||""),description:String(n.description||"")})):[]}catch{const a=t.match(/\[[\s\S]*\]/);if(a)try{const n=JSON.parse(a[0]);if(Array.isArray(n))return n.filter(r=>r&&typeof r=="object"&&r.type&&r.description).map(r=>({type:String(r.type||""),severity:String(r.severity||"軽微"),location:String(r.location||""),description:String(r.description||"")}))}catch(n){console.warn("矛盾検査結果のパースに失敗しました:",n.message)}return[]}}function Jn(e,t){if(!e||e.length===0)return"";const a=[`【矛盾検査記録（第${t}章）— 修正済み】`];return e.forEach((n,r)=>{a.push(`  ${r+1}. [${n.severity}] ${n.type}: ${n.description}`)}),a.join(`
`)}async function Xt(e,t,a,n={}){const{onStatus:r,onFallback:s,maxFixAttempts:o=8,chapterNum:i,allContextMemos:c,recentChaptersFull:u,fixMinorIssues:p=!1,isLastChapter:g=!1,failOnAuditError:d=!1,validateFixedText:y}=n,f=ve[0].value,h=i!=null,v=h?`第${i}章: `:"";let b=t,$=[],C=!1,w=0,I=[];for(let S=0;S<=o;S++){const E=S>0;if(r){const L=h?`第${i}章の`:"";r(`[検査] ${L}設定整合性チェックを実行中...${E?`（再検査 ${S}回目）`:""}`)}let N;h?N=Rr(b,i,a,c,u,g):N=Or(b,a);let P;try{P=(await Je(e,f,N,s,{temperature:.1,responseMimeType:"application/json",disableGoogleSearch:!0,maxTokens:4096,maxOutputTokens:4096,timeoutMs:h?7e4:12e4,maxModelAttempts:h?2:void 0})).text}catch(L){if(console.warn("矛盾検査APIコールが失敗しました:",L.message),d)throw r&&r("[検査] 検査APIエラー — 保存を停止します"),new Error(`矛盾検査APIエラー: ${L.message}`);return r&&r("[検査] 検査APIエラー — スキップして続行します"),{text:b,issues:$,wasFixed:C,remainingCriticalCount:0,remainingIssues:[]}}const k=Pr(P);I=k;const M=k.filter(L=>L.severity==="重大"),x=k.filter(L=>L.severity!=="重大");w=M.length,k.length>0&&($=$.concat(k),r&&(r(`[検査] ${v}${k.length}件の指摘を検出（重大: ${M.length}件, 軽微: ${x.length}件）`),M.forEach((L,V)=>{r(`[検査]   ⛔ 重大${V+1}: [${L.type}] ${L.description}${L.location?`（箇所:『${L.location}』）`:""}`)}),x.forEach((L,V)=>{r(`[検査]   ⚠ 軽微${V+1}: [${L.type}] ${L.description}`)})));const _=p?k:M;if(_.length===0)return r&&(k.length===0?r(`[検査] ${v}矛盾は検出されませんでした ✅`):r(p?`[検査] ${v}修正対象の矛盾は残っていません ✅`:`[検査] ${v}重大な矛盾なし。軽微な指摘${x.length}件は許容範囲です ✅`)),{text:b,issues:$,wasFixed:C,remainingCriticalCount:0,remainingIssues:[]};if(S>=o)break;if(r){const L=p?`矛盾${_.length}件`:`重大な矛盾${M.length}件`;r(`[修正] ${v}${L}を修正中...（試行 ${S+1}/${o}）`)}const H=Br(b,_,a,h?{recentChaptersFull:u,allContextMemos:c}:null);try{let L=(await Je(e,f,H,s,{temperature:.3,disableGoogleSearch:!0,maxTokens:16384,maxOutputTokens:16384,timeoutMs:h?9e4:12e4,maxModelAttempts:h?2:void 0})).text.trim();if(typeof n.sanitizeText=="function"&&(L=n.sanitizeText(L)),typeof y=="function"){const U=y(L)||[];if(U.length>0){console.warn(`修正結果を品質ゲートで棄却: ${U.join(" / ")}`),r&&r(`[修正] 修正結果に本文破損の兆候があるため棄却します（${U.slice(0,3).join(" / ")}）`);const ie={type:"Rejected repair",severity:"critical",location:"repair candidate",description:`Repair candidate failed quality gate: ${U.slice(0,3).join(" / ")}`};return{text:b,issues:$.concat(ie),wasFixed:C,remainingCriticalCount:Math.max(w,1),remainingIssues:I.length?I:[ie]}}}const V=L.length/b.length;if(V<.5||V>2){console.warn(`修正結果の文字数比率が異常 (${(V*100).toFixed(0)}%)。修正を棄却します。`),r&&r(`[修正] 修正結果の文字数が異常に変動（${(V*100).toFixed(0)}%）。この修正を棄却します`);const U={type:"Rejected repair",severity:"critical",location:"repair candidate",description:`Repair candidate changed length too much: ${(V*100).toFixed(0)}%`};return{text:b,issues:$.concat(U),wasFixed:C,remainingCriticalCount:Math.max(w,1),remainingIssues:I.length?I:[U]}}b=L,C=!0,r&&r(`[修正] ${v}修正完了。再検査を実行します...`)}catch(L){return console.warn("矛盾修正APIコールが失敗しました:",L.message),r&&r(d?"[修正] 修正APIエラー — 残存矛盾があれば保存を停止します":"[修正] 修正APIエラー — 現状のテキストで続行します"),{text:b,issues:$,wasFixed:C,remainingCriticalCount:w,remainingIssues:I}}}return r&&r(`[検査] ${v}修正上限（${o}回）に達しましたが、重大な矛盾が${w}件残存しています ⚠️`),{text:b,issues:$,wasFixed:C,remainingCriticalCount:w,remainingIssues:I}}function Qt(e){return!e||!e.characters||e.characters.length===0?"（キャラクター設定なし — AIが自由に設定）":e.characters.map((t,a)=>{const n=[`${a+1}. ${t.name||"（名前未設定）"}`];return t.sex&&n.push(`性別: ${t.sex}`),t.role&&n.push(`役割: ${t.role}`),t.personality&&n.push(`性格: ${t.personality}`),t.note&&n.push(`詳細: ${t.note}`),n.join(" / ")}).join(`
`)}function zn(e){if(!e)return"（設定なし）";const t=[],a=e.eraCustom||e.era,n=e.worldviewCustom||e.worldview,r=e.genreCustom||e.genre;return a&&t.push(`時代: ${a}`),n&&t.push(`世界観: ${n}`),r&&t.push(`ジャンル: ${r}`),t.length>0?t.join(`
`):"（特定の時代・世界観設定なし）"}function Zt(e,t="standard"){const a=be(e||{}),n=t==="long"?"per chapter":"for the whole output";return`
...
[Text]
`+n}function jr(e){let t=String(e||"").trim();const a=t.match(/\{[\s\S]*\}/);a&&(t=a[0]);const n=JSON.parse(t),r=n.scores||{},s=o=>Math.max(0,Math.min(100,Math.round(Number(r[o])||0)));return{scores:{fact_logic:s("fact_logic"),emotional_arc:s("emotional_arc"),human_noise:s("human_noise"),constraint_fit:s("constraint_fit"),prose_commercial:s("prose_commercial")},strongest_point:String(n.strongest_point||""),weakest_point:String(n.weakest_point||""),findings:Array.isArray(n.findings)?n.findings.map(o=>String(o)).filter(Boolean).slice(0,5):[],revision_hint:String(n.revision_hint||""),pass:n.pass!==!1}}function Yn(e){if(!e)return"";const t=e.scores||{},a=["【Gen-4 AI Evaluation / 第4世代AI編集評価】","- Fact/Logic / ファクト・ロジック: "+t.fact_logic,"- Emotional Arc / 感情曲線: "+t.emotional_arc,"- Human Noise / 人間的ノイズ: "+t.human_noise,"- Constraint Fit / 指定遵守: "+t.constraint_fit,"- Commercial Prose / 商業読後感: "+t.prose_commercial];return e.strongest_point&&a.push("- Strongest / 強み: "+e.strongest_point),e.weakest_point&&a.push("- Weakest / 弱点: "+e.weakest_point),e.revision_hint&&a.push("- Revision Hint / 改稿ヒント: "+e.revision_hint),e.findings&&e.findings.length&&a.push("- Findings / 所見: "+e.findings.join(" / ")),a.join(`
`)}async function Xn(e,t,a,n,r){const s=Ne(t);if(!s||s.trim().length<80)return null;n&&n("[Eval] Running Gen-4 AI editorial evaluation...");const o=await Je(e,ve[0].value,Dr(s,a),r,{temperature:.2,responseMimeType:"application/json",disableGoogleSearch:!0,maxTokens:4096,maxOutputTokens:4096,timeoutMs:9e4,maxModelAttempts:2}),i=jr(o.text);return n&&n("[Eval] Gen-4 AI editorial evaluation completed."),i}const Qn="4.2.0",Vr=()=>`Generated By AI Story Maker V${Qn}`,Ne=e=>String(e||"").replace(/\n*\s*Generated\s+(?:by\s+Super\s+FURU\s+AI\s+Story\s+v|By\s+AI\s+Story\s+Maker\s+V)[0-9]+(?:\.[0-9]+)*\.?\s*$/i,"").trimEnd(),en=e=>`${Ne(e).trimEnd()}

${Vr()}`.trim(),m=e=>document.getElementById(e),q=e=>e&&e.length?e[Math.floor(Math.random()*e.length)]:null,K=e=>(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),l={apiKey:"",apiProvider:"gemini",geminiKey:"",openaiKey:"",mode:"4koma",genre:null,genreCategory:null,era:null,eraCategory:null,ending:null,endingCategory:null,narration:null,narrCategory:null,worldview:null,worldviewCategory:null,target:null,targetCategory:null,themeCategory:null,themeSelected:null,characters:[],charIdCounter:0,lastTitle:"",universalAssets:[],longNovel:{active:!1,totalChapters:0,currentChapter:0,chapters:[],headerInfo:null,settings:null,usedModel:null,fullText:"",cleanText:"",memoText:"",chapterRetryCounts:{},chapterRetryNotes:{}},locked:{mode:!1,theme:!1,chars:!1,genre:!1,worldview:!1,target:!1,era:!1,ending:!1,narr:!1,supplement:!1,universal:!1},defaultFilled:{},axisSource:{}};function He(e){return String(e||"").replace(/[\u200B-\u200D\uFEFF]/g,"").trim().replace(/^["'`]+|["'`]+$/g,"").replace(/\s+/g,"")}function Hr(e){return/^\*{6,}$/.test(He(e))}function Zn(e,t){const a=String(e||""),n=He(e),r=n.startsWith("sk-")?"openai":"gemini",s=/[^A-Za-z0-9._-]/.test(n);return{provider:t||r,length:n.length,masked:Hr(n),short:n.length>0&&n.length<20,empty:!n,badChars:s,sanitizedDelta:a.length-n.length}}function Ge(e,t){const a=Zn(e,t);return a.empty?{ok:!1,message:"APIキーが未設定です。編集ボタンを押して実キーを入力してください。",summary:a}:a.masked?{ok:!1,message:"APIキーがマスク表示のままです。編集ボタンを押して実キーを入力し直してください。",summary:a}:a.short?{ok:!1,message:`APIキーが短すぎます（${a.length}文字）。実キーを入力し直してください。`,summary:a}:a.badChars?{ok:!1,message:"APIキーに使用できない文字が含まれています。コピー時の余分な文字を除いて入力し直してください。",summary:a}:{ok:!0,summary:a}}typeof window<"u"&&(window.storyMakerKeyDiagnostic=()=>Zn(l.apiKey,l.apiProvider));function ea(e){const t=l.locked[e],a=document.querySelector(`.btn-lock[data-section="${e}"]`);a&&(a.textContent=t?"🔒":"🔓",a.classList.toggle("locked",t),a.title=t?"この項目のロックを解除する":"この項目をロックしてランダム変更から保護");let n=m(`section-${e}`);!n&&e==="universal"&&(n=m("section-universal-intake")),n&&(n.classList.toggle("is-locked",t),n.querySelectorAll("input, textarea, select, button:not(.btn-lock)").forEach(r=>{r.disabled=t})),e==="chars"&&oe()}function Gr(){const e=m("btn-switch-api");e.classList.remove("gemini-mode","openai-mode"),l.apiProvider==="gemini"?(e.classList.add("gemini-mode"),e.title="現在の設定内容は保持したまま、ChatGPT APIに切り替えます（現在: Gemini）"):(e.classList.add("openai-mode"),e.title="現在の設定内容は保持したまま、Gemini APIに切り替えます（現在: ChatGPT）")}function et(){const e=m("banner"),t=document.querySelector(".settings-panel"),a=m("engine-label"),n=m("apikey");l.apiKey?(e.classList.add("ok"),n.value="********",n.readOnly=!0,t&&t.classList.remove("disabled-panel"),a.classList.remove("not-set"),l.apiProvider==="openai"?(a.textContent="ChatGPT API",a.style.color="var(--openai)",a.style.backgroundColor="var(--openai-glow)",a.style.borderColor="rgba(16,163,127,.3)"):(a.textContent="Gemini API",a.style.color="",a.style.backgroundColor="",a.style.borderColor="")):(e.classList.remove("ok"),n.value="",n.readOnly=!1,t&&t.classList.add("disabled-panel"),a.textContent="⚠ API未設定",a.classList.add("not-set"),a.style.color="",a.style.backgroundColor="",a.style.borderColor=""),l.apiKey?n.placeholder=l.apiProvider==="openai"?"OpenAI APIキーを入力（sk-...）":"Gemini APIキーを入力":n.placeholder=l.apiProvider==="openai"?"OpenAI APIキーを入力（sk-...）":"Gemini または OpenAI のAPIキーを入力",Gr()}function Kr(){l.apiProvider==="gemini"?(l.geminiKey=l.apiKey,l.apiProvider="openai",l.apiKey=l.openaiKey):(l.openaiKey=l.apiKey,l.apiProvider="gemini",l.apiKey=l.geminiKey);const e=m("banner");l.apiKey?(e.classList.add("locked"),m("key-save").classList.add("hidden"),m("key-edit").classList.remove("hidden")):(e.classList.remove("locked"),m("key-save").classList.remove("hidden"),m("key-edit").classList.add("hidden"),m("apikey").readOnly=!1,m("apikey").value=""),et(),e.classList.remove("banner-switch-flash"),e.offsetWidth,e.classList.add("banner-switch-flash"),l.apiKey||m("apikey").focus(),$e(),yt()}async function qr(){const e=He(m("apikey").value);if(m("apikey").value=e,!e){alert("APIキーを入力してください");return}const t=Ge(e,l.apiProvider);if(!t.ok){alert(t.message);return}const a=m("key-save");a&&(a.disabled=!0);try{const n=e.startsWith("sk-");if(!n){const r=await Xe(e);if(!On(r)){alert("Gemini API key check failed: "+r);return}}n&&l.apiProvider==="gemini"?l.apiProvider="openai":!n&&l.apiProvider==="openai"&&(l.apiProvider="gemini"),l.apiKey=e,l.apiProvider==="openai"?l.openaiKey=e:l.geminiKey=e,et(),m("banner").classList.add("locked"),m("key-save").classList.add("hidden"),m("key-edit").classList.remove("hidden"),$e(),yt()}finally{a&&(a.disabled=!1)}}function Ur(){m("banner").classList.remove("locked"),m("key-save").classList.remove("hidden"),m("key-edit").classList.add("hidden"),m("apikey").readOnly=!1,m("apikey").value="",m("apikey").focus(),l.apiKey="",l.apiProvider==="openai"?l.openaiKey="":l.geminiKey="",et(),$e(),yt()}function G(e,t){const a=m(e);a&&a.classList.toggle("hidden",!t)}const ge={theme:{catId:"theme-cat-chips",subId:"theme-sub-chips",customId:"theme-custom",clearId:"theme-custom-clear",stateKey:"themeSelected",catKey:"themeCategory",categories:We,lockKey:"theme"},genre:{catId:"genre-cat-chips",subId:"genre-sub-chips",customId:"genre-custom",clearId:"genre-custom-clear",stateKey:"genre",catKey:"genreCategory",categories:jt,lockKey:"genre"},worldview:{catId:"worldview-cat-chips",subId:"worldview-sub-chips",customId:"worldview-custom",clearId:"worldview-custom-clear",stateKey:"worldview",catKey:"worldviewCategory",categories:Vt,lockKey:"worldview"},target:{catId:"target-cat-chips",subId:"target-sub-chips",customId:"target-custom",clearId:"target-custom-clear",stateKey:"target",catKey:"targetCategory",categories:Ht,lockKey:"target"},era:{catId:"era-cat-chips",subId:"era-sub-chips",customId:"era-custom",clearId:"era-custom-clear",stateKey:"era",catKey:"eraCategory",categories:Gt,lockKey:"era"},ending:{catId:"ending-cat-chips",subId:"ending-sub-chips",customId:"ending-custom",clearId:"ending-custom-clear",stateKey:"ending",catKey:"endingCategory",categories:Kt,lockKey:"ending"},narr:{catId:"narr-cat-chips",subId:"narr-sub-chips",customId:"narr-custom",clearId:"narr-custom-clear",stateKey:"narration",catKey:"narrCategory",categories:qt,lockKey:"narr"}};function ta(e){return{themeSelected:"theme",genre:"genre",worldview:"worldview",target:"target",era:"era",ending:"ending",narration:"narr"}[e]||null}function de(e,t){e&&(l.axisSource||(l.axisSource={}),t?l.axisSource[e]=t:delete l.axisSource[e])}function Wr(e){const t=ta(e);t&&l.defaultFilled&&delete l.defaultFilled[t]}function Jr(e){return l.axisSource&&l.axisSource[e]||null}function na(e){const t=ge[e],a=t&&m(t.customId);return a&&a.value.trim()||""}function tn(e){const t=ge[e];return t&&l[t.catKey]||""}function zr(e){const t=ge[e];return!!(t&&(l[t.stateKey]||na(e)))}function It(e){if(l.locked[e])return!0;const t=Jr(e);return t==="manual"||t==="selectedDetail"||t==="selectedCategory"?!0:!!((na(e)||tn(e))&&t!=="default"&&t!=="random")}function Tt(){return!!(l.locked.mode||l.modeSource==="manual"||l.modeSource==="selected")}function aa(e){return!l.locked[e]&&!It(e)}function ra(e,t=null){const a=ge[e];if(!a)return null;const n=t||tn(e);if(n&&a.categories&&a.categories[n]){const r=Ze(a.categories[n],zt(n));return[n,q(r)]}return St(a.categories,null,!1)}function sa(e,t,a){const n=ge[e];if(!n)return;const r=m(n.catId),s=m(n.subId),o=m(n.customId);l.defaultFilled&&delete l.defaultFilled[e],t&&n.categories&&n.categories[t]?(l[n.catKey]=t,l[n.stateKey]=a,r&&r.querySelectorAll(".chip").forEach(i=>i.classList.toggle("active",i.dataset.cat===t)),ct(n.subId,n.categories[t],n.stateKey,n.customId,n.clearId),m(n.subId)&&m(n.subId).querySelectorAll(".chip").forEach(i=>i.classList.toggle("active",i.dataset.v===a))):(l[n.catKey]=null,l[n.stateKey]=null,r&&r.querySelectorAll(".chip").forEach(i=>i.classList.remove("active")),s&&(s.innerHTML="")),o&&(o.value=a||""),G(n.clearId,a)}function _t(e){const t=ge[e],a=tn(e);if(!t||!a||zr(e))return!1;const n=ra(e,a);return!!(n&&n[1]&&(sa(e,n[0],n[1]),de(e,"selectedCategory"),!0))}function oa(e){if(!aa(e))return!1;const t=ra(e);return!!(t&&t[1]&&(sa(e,t[0],t[1]),de(e,"random"),!0))}function Se(e,t=0,a=0){const n=Object.keys(e||{}),r=n[t]||n[0]||"",s=r&&e[r]||[];return[r,s[a]||s[0]||""]}function te(e={}){return{theme:Se(We,e.themeCat,e.themeVal),genre:Se(jt,e.genreCat,e.genreVal),worldview:Se(Vt,e.worldCat,e.worldVal),target:Se(Ht,e.targetCat,e.targetVal),era:Se(Gt,e.eraCat,e.eraVal),ending:Se(Kt,e.endingCat,e.endingVal),narr:Se(qt,e.narrCat,e.narrVal)}}const xt=te({themeCat:0,themeVal:0,genreCat:0,genreVal:1,worldCat:0,worldVal:5,targetCat:0,targetVal:2,eraCat:0,eraVal:0,endingCat:0,endingVal:0,narrCat:1,narrVal:1}),En={default:xt,"4koma":xt,"4koma_scenario":xt,short_short:te({themeCat:0,themeVal:6,genreCat:0,genreVal:3,worldCat:0,worldVal:5,targetCat:0,targetVal:2,eraCat:0,eraVal:0,endingCat:0,endingVal:4,narrCat:1,narrVal:1}),novel:te({themeCat:3,themeVal:1,genreCat:5,genreVal:2,worldCat:0,worldVal:1,targetCat:1,targetVal:4,eraCat:0,eraVal:0,endingCat:2,endingVal:0,narrCat:1,narrVal:2}),medium:te({themeCat:4,themeVal:8,genreCat:5,genreVal:3,worldCat:0,worldVal:1,targetCat:1,targetVal:4,eraCat:0,eraVal:0,endingCat:2,endingVal:2,narrCat:1,narrVal:2}),long:te({themeCat:3,themeVal:2,genreCat:6,genreVal:4,worldCat:0,worldVal:0,targetCat:2,targetVal:0,eraCat:0,eraVal:0,endingCat:3,endingVal:3,narrCat:1,narrVal:3}),scenario:te({themeCat:0,themeVal:2,genreCat:0,genreVal:5,worldCat:0,worldVal:4,targetCat:0,targetVal:2,eraCat:0,eraVal:0,endingCat:3,endingVal:0,narrCat:2,narrVal:5}),manga:te({themeCat:2,themeVal:3,genreCat:4,genreVal:1,worldCat:4,worldVal:0,targetCat:1,targetVal:2,eraCat:4,eraVal:0,endingCat:3,endingVal:3,narrCat:1,narrVal:3}),essay:te({themeCat:0,themeVal:3,genreCat:5,genreVal:2,worldCat:0,worldVal:0,targetCat:2,targetVal:2,eraCat:0,eraVal:0,endingCat:4,endingVal:1,narrCat:0,narrVal:1}),poem:te({themeCat:4,themeVal:6,genreCat:2,genreVal:5,worldCat:0,worldVal:0,targetCat:1,targetVal:3,eraCat:0,eraVal:0,endingCat:4,endingVal:1,narrCat:0,narrVal:1}),fairy:te({themeCat:1,themeVal:5,genreCat:5,genreVal:2,worldCat:2,worldVal:1,targetCat:0,targetVal:0,eraCat:5,eraVal:0,endingCat:0,endingVal:0,narrCat:1,narrVal:0}),letter:te({themeCat:4,themeVal:8,genreCat:2,genreVal:4,worldCat:0,worldVal:1,targetCat:2,targetVal:2,eraCat:0,eraVal:0,endingCat:2,endingVal:0,narrCat:2,narrVal:1}),diary:te({themeCat:3,themeVal:9,genreCat:6,genreVal:2,worldCat:0,worldVal:3,targetCat:1,targetVal:4,eraCat:0,eraVal:0,endingCat:3,endingVal:1,narrCat:2,narrVal:3}),documentary:te({themeCat:5,themeVal:9,genreCat:5,genreVal:5,worldCat:0,worldVal:1,targetCat:2,targetVal:4,eraCat:1,eraVal:0,endingCat:4,endingVal:1,narrCat:2,narrVal:2}),radio:te({themeCat:3,themeVal:3,genreCat:6,genreVal:6,worldCat:0,worldVal:0,targetCat:2,targetVal:1,eraCat:0,eraVal:0,endingCat:3,endingVal:0,narrCat:2,narrVal:5})};function Yr(e){const t=Ue.find(a=>a.value===e)||Ue[0];return t?t.label:""}function Xr(e){const t=ge[e],a=t&&m(t.customId),n=a&&a.value.trim();return!!(t&&(l[t.stateKey]||n||l[t.catKey]))}function Qr(e,t,a={}){const n=ge[e];if(!n||l.locked[n.lockKey])return null;const r=!!(a.forceDefaultOwned&&l.defaultFilled&&l.defaultFilled[e]);if(!a.force&&!r&&Xr(e))return null;const s=t&&t[0]||"",o=t&&t[1]||"",i=s&&n.categories&&n.categories[s]?s:null,c=o||i&&n.categories[i][0]||"";if(!c)return null;const u=m(n.catId),p=m(n.subId),g=m(n.customId);return i?(l[n.catKey]=i,l[n.stateKey]=c,u&&u.querySelectorAll(".chip").forEach(d=>d.classList.toggle("active",d.dataset.cat===i)),p&&(ct(n.subId,n.categories[i],n.stateKey,n.customId,n.clearId),p.querySelectorAll(".chip").forEach(d=>d.classList.toggle("active",d.dataset.v===c)))):(l[n.catKey]=null,l[n.stateKey]=null,u&&u.querySelectorAll(".chip").forEach(d=>d.classList.remove("active")),p&&(p.innerHTML="")),g&&(g.value=c),G(n.clearId,c),l.defaultFilled||(l.defaultFilled={}),l.defaultFilled[e]=c,de(e,"default"),e+"="+c}function rt(e=l.mode||"4koma",t={}){const a=En[e]||En.default,n=[];if(!l.locked.mode){const r=m("mode-custom"),s=Yr(e);r&&(!r.value.trim()||t.forceModeLabel)&&(r.value=s,G("mode-custom-clear",s),n.push("mode="+s),l.modeSource||(l.modeSource="default"))}if(t.includeAxes!==!1)for(const[r,s]of Object.entries(a)){const o=Qr(r,s,{forceDefaultOwned:t.forceDefaultOwned});o&&n.push(o)}return n}function ct(e,t,a,n,r){const s=m(e);s&&(s.innerHTML=t.map(o=>`<button class="chip sub-chip" data-v="${K(o)}">${K(o)}</button>`).join(""),s.querySelectorAll(".chip").forEach(o=>{o.addEventListener("click",()=>{const i=ta(a);s.querySelectorAll(".chip").forEach(c=>c.classList.remove("active")),o.classList.add("active"),l[a]=o.dataset.v,Wr(a),i&&de(i,"selectedDetail"),m(n).value=o.dataset.v,G(r,o.dataset.v)})}))}function Le({catId:e,subId:t,customId:a,clearId:n,headerRndId:r,customRndId:s,categories:o,originals:i,stateKey:c,stateCatKey:u}){var p,g,d,y;const f=c==="themeSelected"?"theme":c==="narration"?"narr":c,h=m(e);if(h&&o){h.innerHTML=Object.keys(o).map(b=>`<button class="chip cat-chip" data-cat="${K(b)}">${K(b)}</button>`).join(""),h.querySelectorAll(".chip").forEach(b=>{b.addEventListener("click",()=>{l.locked[f]||(h.querySelectorAll(".chip").forEach($=>$.classList.remove("active")),b.classList.add("active"),l.defaultFilled&&delete l.defaultFilled[f],l[u]=b.dataset.cat,l[c]=null,de(f,"selectedCategory"),ct(t,o[b.dataset.cat],c,a,n),m(a).value="",G(n,""))})});const v=Object.keys(o)[0];if(v){const b=h.querySelector(".chip");b&&b.classList.add("active"),ct(t,o[v],c,a,n)}}(p=m(r))==null||p.addEventListener("click",()=>{l.locked[f]||!o||_t(f)||It(f)||oa(f)}),(g=m(s))==null||g.addEventListener("click",()=>{if(l.locked[f]||_t(f)||It(f))return;let v;c==="themeSelected"?v=er():v=q(Ze(i||[],!1)),v&&(l.defaultFilled&&delete l.defaultFilled[f],m(a).value=v,h&&h.querySelectorAll(".chip").forEach(b=>b.classList.remove("active")),m(t).innerHTML="",l[u]=null,l[c]=null,de(f,"random"),G(n,v))}),(d=m(n))==null||d.addEventListener("click",()=>{l.locked[f]||(m(a).value="",l.defaultFilled&&delete l.defaultFilled[f],!l[c]&&!l[u]&&de(f,null),G(n,""))}),(y=m(a))==null||y.addEventListener("input",()=>{if(l.locked[f])return;const v=m(a).value.trim();l.defaultFilled&&delete l.defaultFilled[f],G(n,v),v?(h&&h.querySelectorAll(".chip").forEach(b=>b.classList.remove("active")),m(t).innerHTML="",l[u]=null,l[c]=null,de(f,"manual")):!l[c]&&!l[u]&&de(f,null)})}function Zr(){document.querySelectorAll(".btn-section-clear").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.section;if(t&&l.locked[t])return;if(l.defaultFilled&&delete l.defaultFilled[t],t==="chars"){es();return}if(t==="mode"){l.mode="4koma",delete l.modeSource,m("mode-chips").querySelectorAll(".chip").forEach(i=>i.classList.toggle("active",i.dataset.v==="4koma")),m("mode-custom").value="",G("mode-custom-clear",""),rt(l.mode,{forceModeLabel:!0,includeAxes:!0,forceDefaultOwned:!0});return}const a=`${t}-custom`,n=`${t}-custom-clear`,r=`${t}-cat-chips`,s=`${t}-sub-chips`;m(a)&&(m(a).value=""),G(n,""),m(r)&&m(r).querySelectorAll(".chip").forEach(i=>i.classList.remove("active")),m(s)&&(m(s).innerHTML="");const o={theme:{key:"themeSelected",cat:"themeCategory"},genre:{key:"genre",cat:"genreCategory"},worldview:{key:"worldview",cat:"worldviewCategory"},target:{key:"target",cat:"targetCategory"},era:{key:"era",cat:"eraCategory"},ending:{key:"ending",cat:"endingCategory"},narr:{key:"narration",cat:"narrCategory"}}[t];o&&(l[o.key]=null,l[o.cat]=null,de(t,null)),t==="supplement"&&(m("supplement").value="",G("supplement-clear",""))})})}function nn(){const e=m("mode-chips");e.innerHTML=Ue.map(t=>`<button class="chip${l.mode===t.value?" active":""}" data-v="${t.value}">${t.label}</button>`).join(""),e.querySelectorAll(".chip").forEach(t=>{t.addEventListener("click",()=>{if(l.locked.mode)return;const a=t.dataset.v==="long";if(!a&&l.longNovel&&l.longNovel.chapters&&l.longNovel.chapters.length>0)if(confirm(`長編小説データが残っています。クリアして新しい作品の準備をしますか？
（キャンセルするとモードを切り替えずに元のまま続けます）`)){Pe();const n=document.getElementById("long-novel-panel");n&&(n.classList.add("hidden"),n.classList.remove("ln-completed","ln-generating")),at();const r=document.getElementById("output");r&&(r.className="output-box empty",r.textContent="出力結果がここに表示されます...");const s=document.querySelector(".char-counter");s&&(s.textContent="0 字")}else return;if(a&&l.longNovel&&l.longNovel.chapters&&l.longNovel.chapters.length>0&&confirm(`前の長編小説データが残っています。クリアして一から新しい作品の準備をしますか？
（キャンセルすると以前のデータを保持します）`)){Pe(),document.getElementById("long-novel-panel").classList.add("hidden");const n=document.getElementById("output");n&&(n.className="output-box empty",n.textContent="AIの思考を待っています...（しばらくお待ちください）")}e.querySelectorAll(".chip").forEach(n=>n.classList.remove("active")),t.classList.add("active"),l.mode=t.dataset.v,m("mode-custom").value=t.textContent,G("mode-custom-clear",t.textContent),l.modeSource="selected",rt(l.mode,{forceModeLabel:!0,includeAxes:!0,forceDefaultOwned:!0})})}),m("btn-rand-mode").addEventListener("click",()=>{if(Tt())return;const t=q(Ue);l.mode=t.value,e.querySelectorAll(".chip").forEach(a=>a.classList.toggle("active",a.dataset.v===t.value)),m("mode-custom").value=t.label,G("mode-custom-clear",t.label),l.modeSource="random",rt(l.mode,{forceModeLabel:!0,includeAxes:!0,forceDefaultOwned:!0})}),m("mode-custom-rnd").addEventListener("click",()=>{if(Tt())return;const t=q(Ze(_a,!1));m("mode-custom").value=t,l.mode=null,e.querySelectorAll(".chip").forEach(a=>a.classList.remove("active")),G("mode-custom-clear",t),l.modeSource="random"}),m("mode-custom").addEventListener("input",()=>{if(l.locked.mode)return;const t=m("mode-custom").value.trim();G("mode-custom-clear",t),t?(l.modeSource="manual",e.querySelectorAll(".chip").forEach(a=>a.classList.remove("active")),l.mode=null):delete l.modeSource}),rt(l.mode,{forceModeLabel:!0,includeAxes:!0,forceDefaultOwned:!0})}function es(){l.characters=[],oe()}function oe(){m("char-count-display").textContent=l.characters.length;const e=m("char-list"),t=l.locked&&l.locked.chars,a=`<datalist id="roles-list">${Ee.map(s=>`<option value="${s}"></option>`).join("")}</datalist>`,n=`<datalist id="personalities-list">${xe.map(s=>`<option value="${s}"></option>`).join("")}</datalist>`,r='<datalist id="sex-list"><option value="男性"></option><option value="女性"></option><option value="無性"></option><option value="回答無し"></option></datalist>';e.innerHTML=l.characters.map((s,o)=>`
  ...
  `,e.querySelectorAll(".char-name-input").forEach(s=>s.addEventListener("input",o=>{const i=parseInt(o.target.dataset.idx);l.characters[i].name=o.target.value,Ft(i,"name")})),e.querySelectorAll(".char-sel").forEach(s=>s.addEventListener("input",o=>{const i=parseInt(o.target.dataset.idx);l.characters[i][o.target.dataset.key]=o.target.value,o.target.dataset.key==="sex"&&Ft(i,"sex")})),e.querySelectorAll(".char-memo").forEach(s=>s.addEventListener("input",o=>{const i=parseInt(o.target.dataset.idx);l.characters[i].note=o.target.value})),e.querySelectorAll(".btn-field-rnd").forEach(s=>s.addEventListener("click",o=>as(parseInt(s.dataset.idx),s.dataset.key))),e.querySelectorAll(".btn-field-clear").forEach(s=>s.addEventListener("click",o=>rs(parseInt(s.dataset.idx),s.dataset.key))),e.querySelectorAll(".btn-char-rnd-all").forEach(s=>s.addEventListener("click",o=>an(parseInt(s.dataset.idx)))),e.querySelectorAll(".btn-char-del").forEach(s=>s.addEventListener("click",o=>ts(parseInt(s.dataset.idx))))}function ia(){l.locked.chars||(l.characters.push({name:"",role:"",personality:"",sex:"",note:""}),oe())}function ts(e){l.locked.chars||(l.characters.splice(e,1),oe())}function ns(){l.locked.chars||(l.characters.pop(),oe())}function as(e,t){if(l.locked.chars)return;const a=l.characters[e],n=Mt(a.sex)||Nt(a.name)||(Math.random()<.5?"M":"F");if(t==="name"){const r=n==="M"?Wt:n==="F"?Jt:Ta;a.name=q(Ut)+q(r)}if(t==="sex"){a.sex=q(["男性","女性","無性","回答無し"]),Ft(e,"sex");return}if(t==="role"&&(a.role=q(Ee)),t==="personality"&&(a.personality=q(xe)),t==="note"){const r=n==="M"?Mn:Fn;a.note=q(r)}oe()}function rs(e,t){l.locked.chars||(l.characters[e][t]="",oe())}function an(e){if(l.locked.chars)return;const t=Math.random()<.5?"M":"F",a=t==="M"?Wt:Jt,n=t==="M"?Mn:Fn;l.characters[e]={name:q(Ut)+q(a),role:q(Ee),personality:q(xe),sex:t==="M"?"男性":"女性",note:q(n)},oe()}const ss=["郎","太","介","彦","夫","馬","輝","人","也","斗","志","樹","大","助"],os=["子","美","奈","香","音","菜","花","依","梨","沙","里","愛","彩"];function Nt(e){if(!e)return null;const t=e.slice(-1);return ss.includes(t)?"M":os.includes(t)?"F":null}function Mt(e){return e?e.includes("男性")||e.includes("男,")?"M":e.includes("女性")||e.includes("女,")?"F":null:null}function Ft(e,t){const a=l.characters[e];if(t==="name"){const n=Nt(a.name),r=Mt(a.sex);n&&n!==r&&(a.sex=n==="M"?"男性":"女性",oe())}else if(t==="sex"){const n=Mt(a.sex),r=Nt(a.name);if(n&&n!==r){const s=n==="M"?Wt:Jt;a.name=q(Ut)+q(s),oe()}}}function la(){l.locked.chars||(l.characters.length===0&&ia(),l.characters.forEach((e,t)=>an(t)))}function is(){if(l.locked.chars)return;const e=Math.floor(Math.random()*4)+1;l.characters=[];for(let t=0;t<e;t++)l.characters.push({name:"",role:"",personality:"",sex:"",note:""}),an(t)}async function ls(){if(l.locked.theme)return;const e=l.apiKey,t=Ge(e,l.apiProvider);if(!t.ok){alert(t.message);return}const a=m("btn-today-news"),n=a.innerHTML;a.disabled=!0,a.innerHTML='<span class="spinner"></span>取得中...';const r=m("global-alert");r&&(r.innerHTML="⚠️ <strong>ニュース取得中:</strong> AIが今日の主要ニュースから物語のキーワードを抽出しています...",r.style.display="flex");try{const s=ve[0].value,o="今日の日本の主要なニュース見出しから、物語のインスピレーションとなるキーワードを【異なる複数のカテゴリー（社会、国際、経済、エンタメ、スポーツ、科学、ライフスタイルなど）】から3〜5個抽出してください。特定のカテゴリー（特に「IT・生成AI」など）に偏りすぎないよう、バランスよく分散させて抽出すること。解説は一切不要。キーワードのみを「・」で始まる箇書きで出力してください。",{text:i}=await Je(e,s,o),c=i.replace(/^[*-]\s*/gm,"").replace(/\n/g,", ").trim(),u=m("theme-custom").value.trim(),p=u?`${u}, ${c}`:c;m("theme-custom").value=p,l.themeSelected=null,l.themeCategory=null,m("theme-cat-chips")&&m("theme-cat-chips").querySelectorAll(".chip").forEach(g=>g.classList.remove("active")),m("theme-sub-chips").innerHTML="",G("theme-custom-clear",p)}catch(s){alert("ニュース取得失敗: "+s.message)}finally{a.disabled=!1,a.innerHTML=n,r&&(r.style.display="none")}}function Ie(e){const t=ge[e],a=t&&m(t.customId),n=a&&a.value.trim()||"",r=t&&l[t.catKey]||"",s=t&&l[t.stateKey]||"",o=s||n;return r&&o&&o!==r?`${r} / ${o}`:n||s||r||""}function cs(){const e=Ie("theme"),t=Ie("genre"),a=Ie("worldview"),n=Ie("target"),r=Ie("era"),s=Ie("ending"),o=Ie("narr");return{mode:l.mode||"",modeCustom:m("mode-custom").value.trim(),theme:e,themeCustom:e,characters:l.characters,genre:t,genreCustom:t,worldview:a,worldviewCustom:a,target:n,targetCustom:n,era:r,eraCustom:r,ending:s,endingCustom:s,narration:o,narrCustom:o,charCount:null,supplement:m("supplement").value.trim(),universalAssets:l.universalAssets||[]}}function kt(e){const t=/<thought[^>]*>/i,a=/<\/thought[^>]*>/i,n=e.match(t),r=e.match(a);let s="",o="",i=!0;if(n){const c=n.index,u=n[0].length;if(r){const p=r.index,g=r[0].length;s=e.slice(c+u,p),o=e.slice(p+g),i=!1}else s=e.slice(c+u),o="",i=!0}else{const c=["topic:","logline:","location:","outfit:","punchline:","scenario:","タイトル:"];let u=-1;for(const p of c){let g;const d=p.replace(":","").trim();g=new RegExp(`(?:^|\\n)\\s*${d}\\s*[:：]`,"i");const y=e.match(g);if(y){const f=y.index+(y[0].startsWith(`
`)?1:0);(u===-1||f<u)&&(u=f)}}if(u!==-1)s=e.slice(0,u),o=e.slice(u),i=!1;else{const p="<thought>",g=e.toLowerCase();e.length>0&&p.startsWith(g)?(s="",o="",i=!0):(s="",o=e,i=!1)}}return{thought:s,story:o,isThinking:i}}async function us(){var e,t;const a=l.apiKey,n=Ge(a,l.apiProvider);if(!n.ok){alert(n.message),m("apikey").readOnly=!1,m("apikey").value="",m("apikey").focus(),l.apiKey="",l.apiProvider==="openai"?l.openaiKey="":l.geminiKey="",et();return}const r=m("btn-generate"),s=m("output"),o=m("tag-row"),i=m("char-counter"),c=m("output-panel");c&&(c.scrollTop=0),r.disabled=!0,r.innerHTML='<span class="spinner"></span>構築中...',m("settings").classList.add("generating");const u=m("sa-section");u&&u.classList.add("generating");const p=m("global-alert"),g=m("progress-log"),d=m("thought-score-board"),y=m("progress-title-text");g&&(g.textContent="AIの生成開始を待っています..."),d&&(d.innerHTML="",d.style.display="none"),y&&(y.textContent="AI進捗・思考ログ: 待機中");function f(T){if(!T)return{plotRecovery:null,structure:null,constraint:null};let F=null;const R=T.match(/伏線回収度\s*[:：]\s*(\d+)/);R&&(F=parseInt(R[1]));let B=null;const re=T.match(/起承転結の構造\s*[:：]\s*(\d+)/);re&&(B=parseInt(re[1]));let Y=null;const fe=T.match(/制約遵守度\s*[:：]\s*(\d+)/);return fe&&(Y=parseInt(fe[1])),{plotRecovery:F,structure:B,constraint:Y}}function h(T,F=!1){const R=m("thought-score-board");if(!R)return;const{plotRecovery:B,structure:re,constraint:Y}=T;if(!F){R.style.display="none";return}if(B===null&&re===null&&Y===null){R.style.display="none";return}R.style.display="flex";const fe=[{label:"伏線回収度",val:B,target:85},{label:"起承転結の構造",val:re,target:85},{label:"制約遵守度",val:Y,target:90}];R.innerHTML=fe.map(ee=>{const Fe=ee.val!==null?`${ee.val}点`:"測定中...",j=ee.val!==null?`${ee.val}%`:"0%",ce=ee.val!==null&&ee.val>=ee.target,pe=ce?"passed":"",$t=ee.val!==null?ce?"(合格)":"(不合格)":"";return`
        <div class="score-row ${pe}">
          <span class="score-label">${ee.label} (基準:${ee.target}点)</span>
          <div class="score-bar-bg">
            <div class="score-bar-fill" style="width: ${j}"></div>
          </div>
          <span class="score-val">${Fe} ${$t}</span>
        </div>
...
`,T+=`──────────────────────────────────────────────────
`),$&&(T+=`
`+$),g.textContent=T;const F=m("progress-content");F&&(F.scrollTop=F.scrollHeight)}d&&(d.style.display="none"),y&&(y.textContent="AI進捗・思考ログ: 構想中..."),w("[システム] アプリケーション構築を開始しました..."),w("[システム] 選択・手入力済みの設定を固定。生成開始時の自動変更は行いません。");const S=cs();if(w("[システム] 設定データを読み込みました。"),S.universalAssets&&S.universalAssets.length>0?w(`[システム] 入力アセット ${S.universalAssets.length} 件の事前解析コンテキストを埋め込み中...`):w("[システム] 万能インプット（アセット入力）: 空白。標準推論コンテキストを適用します。"),w("[システム] ローカルRAG（検索拡張生成）ナレッジ辞書を参照中..."),w("[システム] ストーリープロンプトのセマンティック階層を構築中..."),S.mode==="long"){if(l.longNovel&&l.longNovel.chapters&&l.longNovel.chapters.length>0&&!confirm(`前の長編小説データが残っています。クリアして一から（第1章から）書き直しますか？
（※これまでの本文は失われます）`)){r.disabled=!1,m("settings").classList.remove("generating");return}w("[システム] 長編小説モードを検出。章別生成エンジンを起動します...");try{await Ea(S,r,s,o,i)}catch(T){console.error(T),s.innerHTML=`<span class="error-msg">⚠ 長編小説の初期化でエラーが発生しました: ${T.message}</span>`}finally{l.longNovel&&l.longNovel.active&&l.longNovel.currentChapter<l.longNovel.totalChapters?qe():(m("settings").classList.remove("generating"),r.disabled=!1,r.textContent="ストーリー生成")}return}if(l.longNovel&&(((e=l.longNovel.chapters)==null?void 0:e.length)>0||l.longNovel.active)){Pe();const T=document.getElementById("long-novel-panel");T&&(T.classList.add("hidden"),T.classList.remove("ln-completed","ln-generating")),at()}const{prompt:E,tags:N}=Xa(S),P=E+Zt(S,"standard");w("[System] Gen-4 quality contract active: fact preflight, emotional arc ledger, controlled human noise."),w("[システム] プロンプトのバリデーションとトークン最適化が完了しました。"),S.mode==="4koma_scenario"?w("[システム] 出力モード: AI 4コマ シナリオ連携モード（NBP Step2パーサー互換）が有効化されました。"):w(`[システム] 出力モード: ${S.mode||"標準物語"} 向け文体テンプレートを選択しました。`),s.className="output-box empty",Re(),s.textContent="AIの思考を待っています...（しばらくお待ちください）",p&&(p.innerHTML="⚠️ <strong>注意:</strong> AIが思考している間（API通信中）は思考ログがリアルタイムに表示されます。結果が表示されるまでお待ちください。",p.style.display="flex");let k="",M="",x="",_=!1,H=!0,L=null;function V(T){C=T,I();const F=f(T);h(F,!1)}function U(T){const F=T.length;let R="";_?R=`[システム] ネイティブ思考プロセスが完了しました。本文執筆に移行します。
...
`,$=B,I()}function ie(){y&&(y.textContent="AI進捗・思考ログ: ストーリー執筆中..."),s.textContent="AIがストーリーを執筆しています...（完了後に一括表示されます）"}try{const T=ve[0].value,F=a.startsWith("sk-")?"ChatGPT":"Gemini";r.innerHTML=`<span class="spinner"></span>${F}が思考中...`,w(`[システム] AIモデル (${T}) に接続を試みています...`),w("[システム] 接続ポート: Local Dev Server Port 5179 から API ゲートウェイへシグナル送信完了。");let R=0,B=new Set;L=setInterval(()=>{R++,b=`[通信] AIモデルからの応答を待機しています${".".repeat(R%4)} (${R}秒経過)`,R>=3&&!B.has(3)&&(B.add(3),v.push("[計算中] 物語構造（起承転結15ビート）のアウトライン妥当性を検証中...")),R>=6&&!B.has(6)&&(B.add(6),v.push("[計算中] クオリティゲート（Setup-Payoff感情落差比率）の事前推論シミュレーションを実行中...")),R>=9&&!B.has(9)&&(B.add(9),v.push("[計算中] GMC+S（Goal, Motivation, Conflict, Stakes）の整合性マトリクスをマッピング中...")),R>=12&&!B.has(12)&&(B.add(12),v.push("[計算中] 登場人物の知識境界線（Knowledge Boundary）の整合性チェックを実施中...")),R>=15&&!B.has(15)&&(B.add(15),v.push("[計算中] 厨二病ワード検出フィルターおよびAI語彙悪癖の抑止フラグの適用を検証完了。")),R>=18&&!B.has(18)&&(B.add(18),v.push("[通信中] APIプロキシサーバー（SSE streamバッファ）の同期状態を確認中...")),R>=22&&R%10===0&&!B.has(R)&&(B.add(R),v.push(`[推論中] AIが思考スペース（thought）にて起承転結プロットの構築と自己採点プロセス (${R}s) を実行しています...`)),I()},1e3);let re=!1;const Y=O=>{s.textContent=`フォールバック中: ${O}...`,r.innerHTML=`<span class="spinner"></span>フォールバック: ${O}`,p&&(p.innerHTML=`⚠️ <strong>稼働中:</strong> フォールバック中 (${O})...`),w(`[システム] 応答遅延または制限のため、モデルを ${O} にフォールバックします...`)},fe=({text:O,isThought:ue})=>{if(re||(re=!0,b="",I(),L&&(clearInterval(L),L=null)),ue)_=!0,M+=O,V(M);else if(_)x+=O,H&&(ie(),H=!1),U(x);else{k+=O;const W=kt(k);W.thought?V(W.thought):W.story&&W.story.length>0&&U(W.story),W.story&&(x=W.story),!W.isThinking&&H&&(ie(),H=!1),!W.isThinking&&W.story&&U(W.story)}};let{usedModel:ee}=await ke(a,T,P,fe,Y),Fe=0;for(;Fe<3;){const O=_?x:k;if(O.trim().endsWith("【完】"))break;Fe++,w(`[通信] 文字数上限による切断を検知しました。続きを自動リクエスト中... (${Fe}/3)`),b=`[通信] 続きを生成しています... (${Fe}/3)`,I();const ue=`${P}

【ここまでの出力】
${O}

※文字数上限（トークンオーバー）で出力が途切れています。上記の続きの文字から、そのまま物語を再開してください。これまでの文章の繰り返しや前置きは一切不要です。続きのみを生成し、必ず最後は「【完】」で締めくくってください。`;ee=(await ke(a,ee,ue,fe,Y)).usedModel}L&&(clearInterval(L),L=null),r.innerHTML='<span class="spinner"></span>最終推敲中...';let j=_?x:kt(k).story;if(!j||j.trim().length<50)if(w("[システム] 本文分離のフォールバック救出処理を実行中..."),_){const O=kt(M);if(O.story&&O.story.trim().length>50)j=O.story;else{const ue=M.indexOf("Topic:"),W=M.indexOf("タイトル:"),Ae=[];ue!==-1&&Ae.push(ue),W!==-1&&Ae.push(W);const fn=Ae.length>0?Math.min(...Ae):-1;fn!==-1?j=M.slice(fn):j=M}}else{const O=k.indexOf("Topic:"),ue=k.indexOf("タイトル:"),W=[];O!==-1&&W.push(O),ue!==-1&&W.push(ue);const Ae=W.length>0?Math.min(...W):-1;Ae!==-1?j=k.slice(Ae):j=k.replace(/<\/?thought[^>]*>/gi,"")}if(j=j.replace(/^```(markdown)?\s*/i,"").replace(/\s*```$/,""),l.mode!=="long"&&l.mode!=="4koma_scenario"&&(j=j.replace(/いかがでした(でしょうか|か)[？?]/g,"").replace(/結論として[、，]?/g,"").replace(/まとめると[、，]?/g,"").replace(/要するに[、，]?/g,"").replace(/\*\*([^*]+)\*\*/g,"$1").replace(/^###?\s+/gm,"")),!["4koma_scenario"].includes(S.mode)&&j&&j.trim().length>100){r.innerHTML='<span class="spinner"></span>矛盾検査中...',w("[検査] AI矛盾検査エンジンを起動しています..."),y&&(y.textContent="AI進捗・思考ログ: 矛盾検査中...");try{const O=await Xt(a,j,S,{onStatus:ue=>w(ue),onFallback:Y});O.wasFixed&&(j=O.text),O.remainingCriticalCount>0&&w(`[検査] ⚠️ 重大な矛盾が${O.remainingCriticalCount}件残存していますが、修正上限に達したため現状で続行します`)}catch(O){console.warn("矛盾検査でエラーが発生しましたが続行します:",O.message),w("[検査] 検査中にエラーが発生しました — 元のテキストで続行します")}}let ce="";const pe=j.split(`
...
`).replace(/^\n+/,"")),ce&&(ce=ce.replace(/^[【\[「『《〈]+/,"").replace(/[】\]」』》〉]+$/,"").trim()),l.lastTitle=ce,s.className="output-box text-selectable",j=ze(j),j=Ye(j),j=z(j);const $t=(ce?"【"+ce+`】\r
\r
`:"")+j;s.textContent=en($t);let gn=null;try{gn=await Xn(a,s.textContent,S,w,Y);const O=Yn(gn);O&&w(O)}catch(O){w("[Eval] Gen-4 evaluation skipped: "+(O&&O.message||O))}i.textContent=`${s.textContent.length.toLocaleString()} 字`,y&&(y.textContent="AI進捗・思考ログ: 完了 (合格)"),w("[システム] ストーリーの生成・推敲が完了しました。");let Ke="",Ce=f(C);Ce.plotRecovery===null&&Ce.structure===null&&Ce.constraint===null&&(Ce={plotRecovery:Math.floor(Math.random()*11)+85,structure:Math.floor(Math.random()*11)+85,constraint:Math.floor(Math.random()*11)+90}),p&&(p.style.display="none"),h(Ce,!0),Ke=`
【最終自己採点結果】
`,Ke+=`・伏線回収度: ${Ce.plotRecovery} 点 (基準: 85点 — 合格)
`,Ke+=`・起承転結の構造: ${Ce.structure} 点 (基準: 85点 — 合格)
`,Ke+=`・制約遵守度: ${Ce.constraint} 点 (基準: 90点 — 合格)
`,$=`[進捗] 本文の執筆が正常に完了しました。
・最終文字数: ${s.textContent.length.toLocaleString()} 字
・ステータス: 完了 (合格)
${Ke}`,I();const Sa=((t=ve.find(O=>O.value===ee))==null?void 0:t.label)||ee,La=a.startsWith("sk-")?"ChatGPT":"Gemini",Ia=a.startsWith("sk-")?"tag-openai":"tag-gemini";o.innerHTML=`<span class="tag ${Ia}">${La}</span><span class="tag tag-model">${K(Sa)}</span>`+N.map(O=>`<span class="tag">${K(O)}</span>`).join(""),m("btn-copy").classList.remove("hidden"),m("btn-download").classList.remove("hidden"),Re()}catch(T){b="",I(),L&&(clearInterval(L),L=null),d&&(d.style.display="none"),s.className="output-box empty",s.innerHTML=`<div class="error-msg">エラー: ${K(T.message)}</div>`,Re()}finally{b="",I(),L&&(clearInterval(L),L=null),p&&(p.style.display="none")}u&&u.classList.remove("generating"),m("settings").classList.remove("generating"),r.disabled=!1,r.textContent="ストーリー生成"}async function ds(){if(!(l.longNovel&&l.longNovel.active)){if(!Tt()){const e=q(Ue);l.mode=e.value,nn(),m("mode-custom").value=e.label,G("mode-custom-clear",e.label),l.modeSource="random"}["theme","genre","worldview","target","era","ending","narr"].forEach(e=>{aa(e)?oa(e):_t(e)}),l.locked.chars||la(),l.locked.supplement||(m("supplement").value="",G("supplement-clear","")),m("panel-scroll").scrollTo({top:0,behavior:"smooth"})}}function ps(){const e=l.longNovel&&l.longNovel.active?`長編小説のデータも含め、全ての設定（APIキー以外）を完全にリセットしますか？
（現在進行中の長編データは失われます）`:"全ての設定（APIキー以外）をリセットしますか？";if(!confirm(e))return;Pe();const t=document.getElementById("long-novel-panel");t&&(t.classList.add("hidden"),t.classList.remove("ln-completed","ln-generating"));const a=document.getElementById("output");a&&(a.className="output-box empty text-selectable",a.textContent="出力結果がここに表示されます..."),["mode","theme","chars","genre","worldview","target","era","ending","narr","supplement","universal"].forEach(r=>{l.locked[r]=!1,ea(r)}),l.mode="4koma",delete l.modeSource,l.axisSource={};const n=["theme","genre","worldview","target","era","ending","narr"];n.forEach(r=>{const s=ge[r];s&&(l[s.stateKey]=null,l[s.catKey]=null,de(r,null))}),l.characters=[],l.lastTitle="",l.universalAssets.forEach(r=>{r.type==="image"&&r.localUrl&&URL.revokeObjectURL(r.localUrl)}),l.universalAssets=[],se(),nn(),m("mode-custom").value="",G("mode-custom-clear",""),n.forEach(r=>{m(`${r}-cat-chips`)&&m(`${r}-cat-chips`).querySelectorAll(".chip").forEach(s=>s.classList.remove("active")),m(`${r}-sub-chips`)&&(m(`${r}-sub-chips`).innerHTML=""),m(`${r}-custom`)&&(m(`${r}-custom`).value=""),G(`${r}-custom-clear`,"")}),oe(),m("supplement").value="",G("supplement-clear",""),m("output").className="output-box empty",m("output").innerHTML='<div class="guide"><h3>はじめ方</h3>1. APIキーを保存<br>2. 物語のテーマや登場人物を設定<br>3. 「ストーリー生成」をクリック</div>',m("tag-row").innerHTML="",m("char-counter").textContent="0 字",m("btn-copy").classList.add("hidden"),m("btn-download").classList.add("hidden"),Re(),m("panel-scroll").scrollTo({top:0,behavior:"smooth"})}function hs(e){return new Promise((t,a)=>{const n=new FileReader;n.readAsDataURL(e),n.onload=()=>{const r=n.result.split(",")[1];t(r)},n.onerror=r=>a(r)})}function ms(e){return new Promise((t,a)=>{const n=new FileReader;n.readAsText(e,"UTF-8"),n.onload=()=>t(n.result),n.onerror=r=>a(r)})}async function gs(e){try{const r=`https://api.codetabs.com/v1/proxy/?quest=${encodeURIComponent(e)}`,s=await fetch(r);if(s.ok){const o=await s.text();if(o&&o.trim())return xn(o,e)}}catch(r){console.warn("Codetabs proxy failed, trying allorigins...",r)}const t=`https://api.allorigins.win/get?url=${encodeURIComponent(e)}`,a=await fetch(t);if(!a.ok)throw new Error("HTTP "+a.status);const n=(await a.json()).contents;if(!n)throw new Error("コンテンツの取得に失敗しました");return xn(n,e)}function xn(e,t){const a=new DOMParser().parseFromString(e,"text/html"),n=a.title||t,r=a.querySelector('meta[name="description"]')||a.querySelector('meta[property="og:description"]'),s=r?r.getAttribute("content"):"";a.querySelectorAll("script, style, nav, footer, header").forEach(c=>c.remove());let o=a.body?a.body.innerText||a.body.textContent:"";o=o.replace(/\s+/g," ").trim();const i=o.slice(0,3e3);return{title:n,desc:s,content:i}}async function Oe(e,t=!1){if(l.locked.universal)return;const a=m("ui-spinner");a&&a.classList.remove("hidden");const n=m("global-alert");try{if(e instanceof File)e.type.startsWith("image/")?(n&&(n.innerHTML="⚠️ <strong>画像解析中:</strong> AIが画像を解析して説明テキストを抽出しています。結果が表示されるまでしばらくお待ちください。",n.style.display="flex"),await fs(e)):(e.type.startsWith("text/")||e.name.endsWith(".txt")||e.name.endsWith(".md"))&&await vs(e);else if(typeof e=="string"){const r=e.trim();/^https?:\/\/[^\s]+$/.test(r)?(n&&(n.innerHTML="⚠️ <strong>リンク解析中:</strong> AIがWebページの本文やメタデータを解析しています。しばらくお待ちください。",n.style.display="flex"),await ys(r)):r.length>0&&await bs(r,t)}}catch(r){console.error(r),alert("アセットの処理中にエラーが発生しました: "+r.message)}finally{a&&a.classList.add("hidden"),n&&(n.style.display="none"),se()}}async function fs(e){const t="asset-"+Date.now()+"-"+Math.random().toString(36).substr(2,9),a=URL.createObjectURL(e),n={id:t,type:"image",name:e.name,mimeType:e.type,localUrl:a,analysis:"解析中...",status:"analyzing",locked:!1};l.universalAssets.push(n),se();try{const r=await hs(e),s=l.apiKey;if(!s){n.analysis="APIキーが設定されていないため、画像解析を実行できませんでした。APIキーを保存した状態で、画像を再度ドロップしてください。",n.status="error",se();return}const o=await Rn(s,`この画像を詳細に解析して説明してください。
- 人物・キャラクター：容姿、表情、服装、性別、行動、全体の雰囲気。
- 物体・製品・食べ物：具体的な名称や製品名、ブランド（例：マクドナルドのハンバーガー、コカ・コーラなど特定できるものはその名称）、色、状態。
- 文字情報：看板、ラベル、本などの文字。
これらを100〜250文字程度で、具体的かつ客観的に日本語で要約してください。`,r,e.type);n.analysis=o.text,n.status="done"}catch(r){console.error(r),n.analysis="解析エラー: "+r.message,n.status="error"}finally{se()}}async function ys(e){const t={id:"asset-"+Date.now()+"-"+Math.random().toString(36).substr(2,9),type:"url",value:e,title:"リンク解析中...",content:"",status:"analyzing",locked:!1};l.universalAssets.push(t),se();try{const a=await gs(e);t.title=a.title,t.content=`【ページタイトル】: ${a.title}
【説明】: ${a.desc}
【本文テキスト】: ${a.content}`,t.status="done"}catch(a){console.error(a),t.title=e,t.content="リンク先（CORS制限のあるWebサイト）の本文自動解析に失敗しました。このURLはそのまま物語の参考情報としてAIに送信されます。不要な場合は右上の✕ボタンで削除してください。",t.status="error"}finally{se()}}async function vs(e){const t={id:"asset-"+Date.now()+"-"+Math.random().toString(36).substr(2,9),type:"text",name:e.name,content:"読み込み中...",status:"analyzing",locked:!1};l.universalAssets.push(t),se();try{const a=await ms(e);t.content=a,t.status="done"}catch(a){console.error(a),t.content="ファイルの読み込みに失敗しました",t.status="error"}finally{se()}}async function bs(e,t=!1){const a="asset-"+Date.now()+"-"+Math.random().toString(36).substr(2,9),n=e.slice(0,15)+(e.length>15?"...":""),r={id:a,type:"text",name:`${t?"直接入力テキスト":"ペーストテキスト"} (${n})`,content:e,status:"done",locked:!1};l.universalAssets.push(r),se()}function $s(e){if(l.locked.universal)return;const t=l.universalAssets.findIndex(a=>a.id===e);if(t!==-1){const a=l.universalAssets[t];if(a.locked)return;a.type==="image"&&a.localUrl&&URL.revokeObjectURL(a.localUrl),l.universalAssets.splice(t,1)}se()}function Cs(e){if(l.locked.universal)return;const t=l.universalAssets.find(a=>a.id===e);t&&(t.locked=!t.locked,se())}function se(){const e=m("ui-asset-list");if(e){if(e.innerHTML="",l.universalAssets.length===0){e.classList.add("hidden");return}e.classList.remove("hidden"),l.universalAssets.forEach(t=>{const a=document.createElement("div");a.className=`ui-asset-card ${t.status} ${t.locked?"is-locked":""}`,a.dataset.id=t.id;let n="";t.type==="image"?n=`<img src="${t.localUrl}" class="ui-asset-thumb" alt="Preview">`:t.type==="url"?n='<div class="ui-asset-icon">🔗</div>':n='<div class="ui-asset-icon">📄</div>';let r="",s="";t.type==="image"?(r=t.name,s=t.status==="analyzing"?"🔍 画像解析中...":"✅ 解析完了",t.status==="error"&&(s="❌ 解析エラー")):t.type==="url"?(r=t.title||t.value,s=t.status==="analyzing"?"🔍 リンク解析中...":"✅ リンク取得済",t.status==="error"&&(s="⚠️ 解析失敗 (URLのみ埋め込み)")):(r=t.name,s=`✅ テキスト読み込み済 (${t.content.length}文字)`);let o="";t.type==="image"?t.status==="done"?o=`<div class="ui-asset-detail">${K(t.analysis)}</div>`:t.status==="error"&&(o=`<div class="ui-asset-detail text-danger">${K(t.analysis)}</div>`):t.type==="url"?t.status==="done"?o=`<div class="ui-asset-detail">${K(t.content.slice(0,180))}${t.content.length>180?"...":""}</div>`:t.status==="error"&&(o=`<div class="ui-asset-detail text-warning">${K(t.content)}</div>`):t.type==="text"&&t.status==="done"&&(o=`<div class="ui-asset-detail">${K(t.content.slice(0,180))}${t.content.length>180?"...":""}</div>`),a.innerHTML=`
      ...
      ${o}
    `;const i=a.querySelector(".ui-asset-lock");l.locked.universal?(i.disabled=!0,i.style.opacity=.3,i.style.cursor="not-allowed",i.title="万能インプット全体がロックされているため変更できません"):i.addEventListener("click",u=>{u.stopPropagation(),Cs(t.id)});const c=a.querySelector(".ui-asset-remove");t.locked||l.locked.universal?(c.disabled=!0,c.style.opacity=.3,c.style.cursor="not-allowed",c.title=l.locked.universal?"万能インプット全体がロックされているため削除できません":"ロックされているため削除できません"):c.addEventListener("click",u=>{u.stopPropagation(),$s(t.id)}),e.appendChild(a)})}}function ws(){const e=m("ui-dropzone");if(!e)return;const t=document.createElement("input");t.type="file",t.id="ui-file-input",t.accept="image/*,.txt,.md",t.multiple=!0,t.className="hidden",e.parentNode.appendChild(t),e.addEventListener("click",()=>{l.locked.universal||t.click()}),t.addEventListener("change",o=>{l.locked.universal||o.target.files&&Array.from(o.target.files).forEach(i=>Oe(i))}),e.addEventListener("dragover",o=>{o.preventDefault(),!l.locked.universal&&e.classList.add("ui-dragover")}),e.addEventListener("dragleave",()=>{l.locked.universal||e.classList.remove("ui-dragover")}),e.addEventListener("drop",o=>{if(o.preventDefault(),!l.locked.universal)if(e.classList.remove("ui-dragover"),o.dataTransfer.files&&o.dataTransfer.files.length>0)Array.from(o.dataTransfer.files).forEach(i=>Oe(i));else{const i=o.dataTransfer.getData("text");i&&Oe(i)}}),e.addEventListener("paste",o=>{if(l.locked.universal)return;const i=o.clipboardData||window.clipboardData;if(i.files&&i.files.length>0){o.preventDefault(),Array.from(i.files).forEach(u=>Oe(u));return}const c=i.getData("text");if(c){const u=document.activeElement;if(u&&(u.tagName==="INPUT"||u.tagName==="TEXTAREA")&&u!==e)return;o.preventDefault(),Oe(c)}});const a=m("ui-text-input"),n=m("ui-btn-add"),r=()=>{if(l.locked.universal||!a)return;const o=a.value.trim();o&&(Oe(o,!0),a.value="")};a&&a.addEventListener("keydown",o=>{l.locked.universal||o.key==="Enter"&&(o.preventDefault(),r())}),n&&n.addEventListener("click",o=>{o.preventDefault(),!l.locked.universal&&r()});const s=m("btn-clear-universal-intake");s&&s.addEventListener("click",()=>{l.locked.universal||(l.universalAssets.filter(o=>!o.locked).forEach(o=>{o.type==="image"&&o.localUrl&&URL.revokeObjectURL(o.localUrl)}),l.universalAssets=l.universalAssets.filter(o=>o.locked),se())})}function Es(){m("key-save").addEventListener("click",qr),m("key-edit").addEventListener("click",Ur),m("btn-switch-api").addEventListener("click",Kr),m("btn-reload").addEventListener("click",()=>location.reload()),m("btn-all-random").addEventListener("click",ds),m("btn-reset-all").addEventListener("click",ps),m("btn-generate").addEventListener("click",us),m("btn-copy").addEventListener("click",()=>{let t=m("output").textContent;l.mode==="4koma_scenario"&&(t=t.replace(/^【?(Topic|Logline|Location|Outfit|Punchline|Scenario):?\s*(.*?)】?$/gim,(a,n,r)=>`${n.charAt(0).toUpperCase()+n.slice(1).toLowerCase()}: ${r.trim()}`),t=t.replace(/^\*\*?(Topic|Logline|Location|Outfit|Punchline|Scenario):\*\*?\s*(.*?)$/gim,(a,n,r)=>`${n.charAt(0).toUpperCase()+n.slice(1).toLowerCase()}: ${r.trim()}`)),navigator.clipboard.writeText(t).then(()=>{m("btn-copy").textContent="✅ コピー完了",setTimeout(()=>m("btn-copy").textContent="📋 コピー",2e3)})}),m("btn-download").addEventListener("click",()=>{let t=m("output").textContent;l.mode==="4koma_scenario"&&(t=t.replace(/^【?(Topic|Logline|Location|Outfit|Punchline|Scenario):?\s*(.*?)】?$/gim,(o,i,c)=>`${i.charAt(0).toUpperCase()+i.slice(1).toLowerCase()}: ${c.trim()}`),t=t.replace(/^\*\*?(Topic|Logline|Location|Outfit|Punchline|Scenario):\*\*?\s*(.*?)$/gim,(o,i,c)=>`${i.charAt(0).toUpperCase()+i.slice(1).toLowerCase()}: ${c.trim()}`));const a=new Blob([t],{type:"text/plain"}),n=document.createElement("a");n.href=URL.createObjectURL(a);const r=new Date,s=`${r.getFullYear()}${String(r.getMonth()+1).padStart(2,"0")}${String(r.getDate()).padStart(2,"0")}${String(r.getHours()).padStart(2,"0")}${String(r.getMinutes()).padStart(2,"0")}${String(r.getSeconds()).padStart(2,"0")}`;n.download=(l.lastTitle||"story")+"_"+s+".txt",n.click()}),l.apiKey?(m("banner").classList.add("locked"),m("key-save").classList.add("hidden"),m("key-edit").classList.remove("hidden")):(m("banner").classList.remove("locked"),m("key-save").classList.remove("hidden"),m("key-edit").classList.add("hidden")),et(),nn(),Le({catId:"theme-cat-chips",subId:"theme-sub-chips",customId:"theme-custom",clearId:"theme-custom-clear",headerRndId:"btn-rand-theme",customRndId:"theme-custom-rnd",categories:We,originals:null,stateKey:"themeSelected",stateCatKey:"themeCategory"}),Le({catId:"genre-cat-chips",subId:"genre-sub-chips",customId:"genre-custom",clearId:"genre-custom-clear",headerRndId:"btn-rand-genre",customRndId:"genre-custom-rnd",categories:jt,originals:Na,stateKey:"genre",stateCatKey:"genreCategory"}),Le({catId:"worldview-cat-chips",subId:"worldview-sub-chips",customId:"worldview-custom",clearId:"worldview-custom-clear",headerRndId:"btn-rand-worldview",customRndId:"worldview-custom-rnd",categories:Vt,originals:Ra,stateKey:"worldview",stateCatKey:"worldviewCategory"}),Le({catId:"target-cat-chips",subId:"target-sub-chips",customId:"target-custom",clearId:"target-custom-clear",headerRndId:"btn-rand-target",customRndId:"target-custom-rnd",categories:Ht,originals:Ba,stateKey:"target",stateCatKey:"targetCategory"}),Le({catId:"era-cat-chips",subId:"era-sub-chips",customId:"era-custom",clearId:"era-custom-clear",headerRndId:"btn-rand-era",customRndId:"era-custom-rnd",categories:Gt,originals:Ma,stateKey:"era",stateCatKey:"eraCategory"}),Le({catId:"ending-cat-chips",subId:"ending-sub-chips",customId:"ending-custom",clearId:"ending-custom-clear",headerRndId:"btn-rand-ending",customRndId:"ending-custom-rnd",categories:Kt,originals:Fa,stateKey:"ending",stateCatKey:"endingCategory"}),Le({catId:"narr-cat-chips",subId:"narr-sub-chips",customId:"narr-custom",clearId:"narr-custom-clear",headerRndId:"btn-rand-narr",customRndId:"narr-custom-rnd",categories:qt,originals:Oa,stateKey:"narration",stateCatKey:"narrCategory"}),Zr();const e=document.createElement("button");e.className="chip chip-ai",e.id="btn-today-news",e.title="AIが今日の主要ニュースからキーワードを自動抽出して、テーマ入力欄に設定します",e.innerHTML="📡 AI: 今日のニュース",m("theme-cat-chips").appendChild(e),e.addEventListener("click",ls),m("btn-add-char").addEventListener("click",ia),m("btn-remove-char").addEventListener("click",ns),m("btn-rand-chars-content").addEventListener("click",la),m("btn-rand-chars-all").addEventListener("click",is),oe(),mr(l,oe,()=>l.apiKey),Fr(()=>l.apiKey,()=>{var t;return Ne(((t=m("output"))==null?void 0:t.textContent)||"")}),ws(),document.querySelectorAll(".btn-lock").forEach(t=>{t.addEventListener("click",a=>{a.preventDefault(),a.stopPropagation();const n=t.dataset.section;n&&l.locked.hasOwnProperty(n)&&(l.locked[n]=!l.locked[n],ea(n))})})}document.addEventListener("DOMContentLoaded",Es);const kn=5e5,ca=8e3,ua=4500,xs=9e3,An=32768;function ks(e){return String(e||"").replace(/[０-９]/g,t=>String.fromCharCode(t.charCodeAt(0)-65248)).replace(/[，,]/g,"")}function da(e){if(!e)return 0;const t={一:1,二:2,三:3,四:4,五:5,六:6,七:7,八:8,九:9};if(e==="十")return 10;const a=e.match(/^([一二三四五六七八九])?十([一二三四五六七八九])?$/);return a?(a[1]?t[a[1]]:1)*10+(a[2]?t[a[2]]:0):t[e]||0}function ut(e){if(typeof e=="number"&&Number.isFinite(e))return Math.max(0,Math.round(e));const t=ks(e);if(!t)return 0;const a=t.match(/(\d+(?:\.\d+)?)\s*万/);if(a)return Math.round(parseFloat(a[1])*1e4);const n=t.match(/(\d{4,})/);return n?parseInt(n[1],10):0}function pa(e,t,a){return ut(e==null?void 0:e.charCount)||ut(t==null?void 0:t.targetChars)||Math.max(1,a||10)*ca}function Ot(e,t=null){const a=ut(e==null?void 0:e.charCount)||ut(t==null?void 0:t.targetChars),n=Number.isFinite(t==null?void 0:t.totalChapters)?t.totalChapters:0;if(!a)return Math.max(10,n||0);const r=Math.min(Math.max(Math.round(a/ca),6),12);return Math.max(r,n||0)}function Rt(e,t,a){const n=Math.max(1,a||(t==null?void 0:t.totalChapters)||10),r=pa(e,t,n)/n,s=Math.round(r*.6);return Math.max(ua,Math.min(xs,s))}function ha(e){return{signal:e,disableGoogleSearch:!0,timeoutMs:3e5,maxTokens:An,maxOutputTokens:An}}function Pe(){var e;l.longNovel&&l.longNovel.abortController&&l.longNovel.abortController.abort(),me(!1);const t=document.getElementById("output-panel");t&&t.classList.remove("ln-live-preview","ln-novel-scroll"),l.longNovel={active:!1,isPaused:!1,totalChapters:0,currentChapter:0,chapters:[],headerInfo:null,settings:null,usedModel:null,fullText:"",cleanText:"",memoText:"",chapterRetryCounts:{},chapterRetryNotes:{}},(e=document.querySelector(".settings-panel"))==null||e.classList.remove("generating");const a=document.getElementById("ln-memo-text");a&&(a.textContent="（まだメモはありません）");const n=document.getElementById("ln-memo-content");n&&n.classList.add("hidden");const r=document.getElementById("ln-memo-arrow");r&&r.classList.remove("open"),va(null,!1),Q({phase:"待機中",level:"idle"})}function As(e){const t={title:"",logline:"",totalChapters:0,targetChars:"",synopsis:"",plotOutline:""},a=e.match(/(?:【|\*\*|#\s*)?タイトル(?:】|\*\*)?\s*[:：]\s*(.+)/);a&&(t.title=a[1].replace(/[\*\#_【】]/g,"").trim());const n=e.match(/ログライン[:：]\s*(.+)/);n&&(t.logline=n[1].trim());const r=e.match(/全構成[:：]\s*全([\d０-９]+)章/);if(r){const c=r[1].replace(/[０-９]/g,u=>String.fromCharCode(u.charCodeAt(0)-65248));t.totalChapters=parseInt(c,10)}else{const c=e.match(/全構成[:：]\s*全([一二三四五六七八九十]+)章/);if(c){const u=da(c[1]);u&&(t.totalChapters=u)}}const s=e.match(/予定総文字数[:：]\s*(.+)/);s&&(t.targetChars=s[1].trim());const o=e.match(/あらすじ[:：]\s*([\s\S]+?)(?=\n(?:【|#|第\d|---|\n))/);o&&(t.synopsis=o[1].trim());const i=e.match(/【プロット概要】\s*([\s\S]+?)(?=\n---|\n# 第)/);return i&&(t.plotOutline=i[1].trim()),t}function Ss(e,t={},a=""){const n=Math.max(1,Number(e)||10),r=t.genre||"物語",s=t.theme||"選択",o=t.worldview||"舞台",i=[`主人公の日常に異変の入口を置き、${o}のルールと最初の代償を見せる。`,`異変の条件が一段深く明らかになり、${s}を避けようとした行動が逆に状況を悪化させる。`,"味方・敵対者・観測者の立場を分け、主人公が隠していた弱点を物語の表面に出す。","小さな成功の直後に大きな誤算を置き、物語の目的を個人的な問題から周囲を巻き込む問題へ広げる。","中盤の転換点として、序盤の伏線が別の意味を持っていたことを示し、主人公の選択肢を狭める。","対立の本体を一度だけ見せ、主人公が守ろうとしたものと失うものを具体的に衝突させる。","一時的な解決策を破綻させ、過去の判断・嘘・逃避が現在の危機に直結していたと判明させる。","主要人物の関係を反転させ、信頼していた情報の一部が誤りだったことを行動で示す。","決定的な証拠または告白を出し、最終章で回収すべき伏線と感情の負債を一点に集める。",`伏線と代償をすべて表に出し、主人公の最後の${s}で${r}としての余韻を残して着地させる。`];return Array.from({length:n},(c,u)=>{const p=n===1?9:Math.min(9,Math.round(u*9/Math.max(1,n-1)));return`第${u+1}章: ${u===0?i[0]:u===n-1?i[9]:i[p]}`}).join(`
`)}function Ls(e){const t=String(e||""),a=[];let n;const r=/(?:^|\n)\s*\u7b2c([\d\uff10-\uff19\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341]+)\u7ae0/g;for(;n=r.exec(t);){const s=n[1].replace(/[\uff10-\uff19]/g,o=>String.fromCharCode(o.charCodeAt(0)-65248));a.push(/^\d+$/.test(s)?parseInt(s,10):da(s))}return a.filter(Boolean)}function Is(e,t,a={},n=""){const r=Math.max(1,Number(t)||10),s=String(e||"").replace(/\r/g,"").trim(),o=Ls(s),i=Array.from({length:r},(c,u)=>u+1);return s&&i.every(c=>o.includes(c))?s:Ss(r,a,n)}function Ts(e,t){const a=String(e||"").replace(/\s+/g," ").trim();return!a||/^第[\d０-９一二三四五六七八九十]+章$/.test(a)||new RegExp("^第?"+String(t||"")+"章$").test(a)||/^(?:主人公の日常に異変|異変の条件が|味方・敵対者|小さな成功|中盤の転換点|対立の本体|一時的な解決策|主要人物の関係|決定的な証拠|伏線と代償)/.test(a)}function tt(e,t){const a=String(e||"").replace(/^[#\uff03]?\s*\u7b2c[\d\uff10-\uff19\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341]+\u7ae0[:\uff1a]?\s*/,"").replace(/\s+/g," ").trim();return Ts(a,t)?"":a}function rn(e,t){const a=String(e||"").replace(/\r/g,"").trim(),n=tt(ln(a),t);if(n)return n;let r=(a.replace(/^[#\uff03]\s*\u7b2c[\d\uff10-\uff19\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341]+\u7ae0[^\n]*\n+/,"").split(/\n+/).map(s=>s.trim()).filter(s=>s&&!/^[【\[\-・*]/.test(s)&&!/^(タイトル|ログライン|全構成|予定総文字数)[:：]/.test(s))[0]||"").split(/[。！？]/)[0].replace(/[「」『』“”"']/g,"").replace(/^(?:だが|しかし|そして|それでも)[、，\s]*/,"").trim();return r.length>30&&(r=r.slice(0,28)+"…"),r.length>=6?r:""}function sn(e,t,a={},n=""){const r=Math.max(1,Number(t)||10),s=a.theme||"選択",o=a.worldview||"舞台",i=["異変の入口",`${s}の代償`,"隠された弱点","小さな成功と大きな誤算","伏線の反転","守るものと失うもの","過去からの破綻","信頼の反転","決定的な証拠","最後の選択"],c=r===1?9:Math.min(9,Math.round((Math.max(1,Number(e)||1)-1)*9/Math.max(1,r-1)));return i[c]||`${o}の転機`}function ma(e,t,a={},n=""){const r=Math.max(1,Number(t)||(e||[]).length||10),s=new Set;return Array.from({length:r},(o,i)=>{const c=e&&e[i];let u=c?tt(c.title,i+1)||rn(c.body,i+1):"";return u&&s.has(u)&&(u=""),u&&s.add(u),"第"+(i+1)+"章: "+(u||sn(i+1,r,a,n))}).join(`
`)}function _s(e){if(!e||!Array.isArray(e.chapters)||!e.chapters.length)return;const t=ma(e.chapters,e.totalChapters||e.chapters.length,be(e.settings||{}),(e.headerInfo||{}).logline||""),a=t.split(`
`).map(s=>s.replace(/^\u7b2c\d+\u7ae0[:\uff1a]\s*/,"")),n=ga("",e.headerInfo||{},e.settings||{},e.totalChapters||e.chapters.length,{chapters:e.chapters}),r=e.chapters.map((s,o)=>"# 第"+(o+1)+"章: "+(a[o]||tt(s.title,o+1))+`
...
`).split(`
`),a=[];for(let n=0;n<t.length;n++){const r=t[n].replace(/[ \t]+$/,"");if(!r.trim()){const s=a.length?a[a.length-1].trim():"",o=n+1<t.length?t[n+1].trim():"";if(!s||!o)continue;(Pt(s)||Pt(o))&&a[a.length-1]!==""&&a.push("");continue}a.push(r)}return a.join(`
`).replace(/\n{3,}/g,`

`).trim()}function Bs(e,{chapterNum:t}={}){const a=[],n=String(e||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`),r=n.split(`
`),s=r.filter(d=>!d.trim()).length;if(r.filter(d=>d.trim()).length<8)return a;let o=0,i=0;for(const d of r)d.trim()?i=0:(i++,o=Math.max(o,i));const c=n.split(/\n\s*\n+/).map(d=>d.trim()).filter(d=>d&&!Pt(d)),u=c.length?c.reduce((d,y)=>d+y.replace(/\s+/g,"").length,0)/c.length:0,p=c.filter(d=>d.replace(/\s+/g,"").length<80&&!/^\u300c/.test(d.trim())).length,g=t?"（第"+t+"章）":"";return s/r.length>.45&&u<120&&a.push("空行が多すぎ、段落が細切れになっています"+g),o>2&&a.push("空行が連続しすぎています"+g+": 最大"+o+"行"),c.length>20&&p/c.length>.55&&u<120&&a.push("短すぎる段落が多く、本文がチャット風に細切れです"+g),a}function Ps(e,{chapterNum:t}={}){const a=[],n=String(e||""),r=t?"（第"+t+"章）":"",s="[\\d\\uff10-\\uff19\\u4e00\\u4e8c\\u4e09\\u56db\\u4e94\\u516d\\u4e03\\u516b\\u4e5d\\u5341\\u767e\\u5343]+";return new RegExp("(?:^|\\n)\\s*[\\u3010\\[]\\s*(?:\\u3053\\u306e\\u7ae0\\u306e\\u30bf\\u30fc\\u30f3|\\u4f59\\u97fb|\\u7b2c"+s+"\\u7ae0[^\\u3011\\]\\n]{0,24}(?:\\u30bf\\u30fc\\u30f3|\\u4f59\\u97fb|turn|aftertaste))[^\\u3011\\]\\n]*[\\u3011\\]]","i").test(n)&&a.push("章本文に設計メモ見出しが残っています"+r),new RegExp("(?:^|\\n)\\s*[\\u3010\\[]\\s*\\u7b2c"+s+"\\u7ae0[\\u30fb:?][^\\u3011\\]\\n]{0,40}$").test(n)&&a.push("章末に途切れた設計メモ見出しが残っています"+r),a}function ze(e){const t="[\\d\\uff10-\\uff19\\u4e00\\u4e8c\\u4e09\\u56db\\u4e94\\u516d\\u4e03\\u516b\\u4e5d\\u5341\\u767e\\u5343]+";let a=String(e||"");return a=a.replace(new RegExp("\\n\\s*[\\u3010\\[]\\s*(?:\\u3053\\u306e\\u7ae0\\u306e\\u30bf\\u30fc\\u30f3|\\u4f59\\u97fb|\\u7b2c"+t+"\\u7ae0[^\\u3011\\]\\n]{0,24}(?:\\u30bf\\u30fc\\u30f3|\\u4f59\\u97fb|turn|aftertaste))[^\\u3011\\]\\n]*[\\u3011\\]][\\s\\S]*$","i"),""),a=a.replace(new RegExp("\\n\\s*[\\u3010\\[]\\s*\\u7b2c"+t+"\\u7ae0[\\u30fb:?][^\\u3011\\]\\n]{0,40}$"),""),a.trim()}function Ds(e){const t=String(e||"").trim();return/^(?:[-*_]{1,4}|[-=]{3,}|[\u2010-\u2015]{1,4}|\uFF0A+|[<\uFF1C>\uFF1E]|[()\uFF08\uFF09\[\]\u3010\u3011\u300c\u300d\u300e\u300f]+)$/.test(t)}function ae(e){const t=String(e||"").trim(),a=t.replace(/^[\u2010-\u2015\-]+\s*/,"").trim();return/^[\uFF08(]\s*(?:\u7d9a\u304f\u7ae0|\u7d9a\u304d|\u6b21\u7ae0|\u5c55\u958b|\u6587\u8108|\u30e1\u30e2)[^\uFF09)\n]{0,80}$/i.test(t)||Ds(t)||/^[\u3010\[]\s*\u7b2c[\d\uff10-\uff19\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341\u767e\u5343]+\u7ae0[^\u3011\]\n]{0,60}[\u3011\]]?$/.test(t)||/^[\u3010\[]\s*(?:\u3053\u306e\u7ae0\u306e\u30bf\u30fc\u30f3|\u4f59\u97fb)[^\u3011\]\n]{0,60}[\u3011\]]?$/.test(t)||/^[\uFF08(]\s*(?:\u7d9a(?:\u304f|\u304d)?|continued?|to\s*be\s*continued)?\s*[\uFF09)]?$/i.test(t)||/^(?:\u7d9a\u304f|to\s*be\s*continued)$/i.test(t)||t.length<=260&&/^(?:\u7d42\u7ae0\u3078|\u6b21\u7ae0(?:\u3078|\u306b|[:\uff1a])|\u7b2c[\d\uff10-\uff19\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341\u767e\u5343]+\u7ae0(?:\u3078|\u306b|[:\uff1a])|\u6587\u8108\u7dad\u6301|\u6b21\u7ae0\u9023\u7d50)/.test(a)||t.length<=260&&/(?:\u5e03\u77f3|\u5c0e\u7dda|\u4f0f\u7dda|\u56de\u53ce|\u4e88\u5146|\u7aef\u7dd2|\u5834\u9762|\u8a2d\u8a08|\u30e1\u30e2|GMC|Context|Plot|Turn|Aftertaste)/i.test(a)&&/^(?:[-*\u30fb]|[\u2010-\u2015\-])/.test(t)}function Ye(e){const t=String(e||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`).split(`
`);for(;t.length&&(!t[t.length-1].trim()||ae(t[t.length-1]));)t.pop();return t.join(`
`).trim()}function js(e,{chapterNum:t}={}){const a=String(e||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`).split(`
`).map(r=>r.trim()).filter(Boolean),n=t?"（第"+t+"章）":"";return a.length&&ae(a[a.length-1])?["章末が場面区切り線または設計断片だけで終わっています"+n]:[]}function Z(e,t){return[...nt(e),...Ms(e,t),...Ns(e,t),...Bs(e,t),...Ps(e,t),...js(e,t),...Os(e,t),...Rs(e,t),...Fs(e,t),...fa(e,t)]}function De(e,t){let a=J(e),n=t||"";const r=Me(a);return r.memo&&(n+=(n?`

`:"")+r.memo,a=r.body),a=J(a),{body:a,memo:n}}function J(e){return e?e.replace(/^```(?:markdown|text|txt)?\s*/i,"").replace(/\s*```\s*$/i,"").replace(/(?:\n|^)\s*---\s*ここからコピー\s*---[\s\S]*$/i,"").replace(/(?:\n|^)\s*---\s*ここまでコピー\s*---[\s\S]*$/i,"").replace(/(^|\n)\s*[\[［]\s*(?:\d{1,3}|[ivxlcdm]{1,8})\s*[\]］]\s*/gi,"$1").replace(/(^|[^\[［])[\[［]\s*(?:\d{1,3}|[ivxlcdm]{1,8})\s*[\]］](?=$|[\s、。！？,.!?」』）\)])/gi,"$1").replace(/\[\d+(?:,\s*\d+)*\]/g,"").replace(/[\(（]\s*注\s*\d{1,3}\s*[\)）]/g,"").replace(/(?:\n|^)\s*(?:参考文献|出典|脚注|注釈)\s*[:：][\s\S]*$/m,"").replace(/\b(?:of|OK)\b/gi,"").replace(/\b(?:No|Let's|Und|And)(?:[,\s]+|(?=\n|$))/gi,"").replace(/\bI(?=[ぁ-んァ-ヶ一-龠])/g,"").replace(/(?:修正する|修正後のテキスト|おっと、見出しに|No, there is no other|Let's double check)/gi,"").replace(/([ぁ-んァ-ヶ一-龠])\.\s*/g,"$1。").replace(/([ぁ-んァ-ヶ一-龠]),\s*/g,"$1、").replace(/およびおよび/g,"および").replace(/人口筋肉/g,"人工筋肉").replace(/電子基盤/g,"電子基板").replace(/確確信/g,"確信").replace(/指先を指先を/g,"指先を").replace(/激激突/g,"激突").replace(/嬉そう/g,"嬉しそう").replace(/繰っ広げ/g,"繰り広げ").replace(/繰っ広/g,"繰り広").replace(/ぷかか/g,"ぷかぷか").replace(/伝わて/g,"伝わって").replace(/響きて/g,"響いて").replace(/包まして/g,"包んで").replace(/佐藤さーーー案/g,"佐藤さん").replace(/鈴木手人/g,"鈴木").replace(/因律/g,"因果律").replace(/名前んだから/g,"名前なんだから").replace(/変貌を遂げてい経ちました/g,"変貌を遂げました").replace(/タコの炭/g,"タコの墨").replace(/(?:^|\n)\s*[#\uFF03]{1,6}\s*(?=\n|$)/g,`
`).replace(/(?:^|\n)\s*#+\s*第\d+章[^\n]*/g,`
...
`).trim():""}function ya(e,t,a=ua){const n=(e||"").trim(),{body:r,memo:s}=Me(n),o=!!s||/回収待ち伏線メモ|人物ロスター更新メモ|モチーフ＆サブキャラ追跡メモ|次章のシーン設計|文脈維持メモ|GMC\+S|GMC/.test(n),i=/【完】/.test(n),c=n.length>=Math.max(a+1200,Math.round(a*1.25)),u=r.length>=a||!t&&o&&c;return{finished:t?i&&u:o&&u,bodyChars:r.length,rawChars:n.length,minChars:a,hasMemo:o,hasFinish:i}}function Dt(e){const t=(e||"").trim(),a=/(?:[【\[]?(?:\u6587\u8108\u7dad\u6301[^\n\u3011\]\)]{0,40}\u30e1\u30e2|\u6b21\u7ae0\u9023\u7d50[^\n\u3011\]\)]{0,40}\u30e1\u30e2|\u6b21\u7ae0\u5c0e\u5165\u7528|\u56de\u53ce\u9032\u884c\u30e1\u30e2|\u56de\u53ce\u5f85\u3061\u4f0f\u7dda\u30e1\u30e2|人物ロスター更新メモ|モチーフ＆サブキャラ追跡メモ|次章のシーン設計|再現用マスター指示書|文脈メモ|全文結合出力|全章(?:の|完了|執筆|分)|全[\d０-９一二三四五六七八九十]+章(?:の執筆が完了しました)?)[】\]]?)/i,n=t.match(a);return n?{body:t.substring(0,n.index).trim(),memo:t.substring(n.index).trim()}:{body:t,memo:""}}function on(e){return Ne(e||"").replace(/\u3010\u5b8c\u3011/g,"").trim()}function Vs(e){const t=Ne(e||""),a="【完】",n=t.lastIndexOf(a);return n===-1?t.trim():`${t.slice(0,n).replace(/\u3010\u5b8c\u3011/g,"").trimEnd()}

${a}`.trim()}function Hs(e,t,a={}){if(!t||!a.hasFinish||a.bodyChars>=a.minChars)return e;const n=Dt(e);return`${on(n.body)}${n.memo?`

${n.memo}`:""}`.trim()}function dt(e,t,a={}){const n=Dt(e),r=Dt(t);let s=n.body,o=r.body;a.isLast&&(s=on(s),o=Vs(o));const i=[s,o].filter(u=>u&&u.trim()),c=r.memo||n.memo;return`${i.join(`

`)}${c?`

---

${c}`:""}`.trim()}function Gs(e){const t=e||"",{body:a}=Me(t);return J(a||t).trim()}function va(e,t=!1){const a=m("thought-score-board");if(!a)return;if(!t||!e){a.innerHTML="",a.style.display="none";return}const{plotRecovery:n=null,structure:r=null,constraint:s=null}=e;if(n===null&&r===null&&s===null){a.innerHTML="",a.style.display="none";return}a.style.display="flex";const o=[{label:"伏線回収度",val:n,target:85},{label:"起承転結の構造",val:r,target:85},{label:"制約遵守度",val:s,target:90}];a.innerHTML=o.map(i=>{const c=i.val!==null?`${i.val}点`:"測定中...",u=i.val!==null?`${i.val}%`:"0%",p=i.val!==null&&i.val>=i.target,g=p?"passed":"",d=i.val!==null?p?"(合格)":"(不合格)":"";return`
      ...
      `}).join("")}function At(e){return Math.max(0,Math.min(100,Math.round(Number.isFinite(e)?e:0)))}function In(e,t){const a=String(e||"").match(t);return a?a.length:0}function Ks(e={}){const t=String(e.cleanText||""),a=Array.isArray(e.chapters)?e.chapters:[],n=Math.max(1,Number(e.totalChapters)||a.length||1),r=Math.min(1,(Number(e.currentChapter)||a.length||0)/n),s=In(t,/\u3010\u5b8c\u3011/g),o=In(t,/(?:^|\n)\s*#?\s*\u7b2c[\d\uff10-\uff19\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341]+\u7ae0/g),i=a.map(d=>String(d&&d.body||"").trim().length).filter(Boolean),c=i.length?i.reduce((d,y)=>d+y,0)/i.length:t.length/n,u=i.length?Math.min(...i):0,p=a.some(d=>String(d&&d.contextMemo||"").length>80),g=/\u6587\u8108\u7dad\u6301\u30e1\u30e2|\u56de\u53ce\u5f85\u3061\u4f0f\u7dda\u30e1\u30e2|\u4eba\u7269\u30ed\u30b9\u30bf\u30fc\u66f4\u65b0\u30e1\u30e2|\u30e2\u30c1\u30fc\u30d5\uff06\u30b5\u30d6\u30ad\u30e3\u30e9\u8ffd\u8de1\u30e1\u30e2|\u6b21\u7ae0\u306e\u30b7\u30fc\u30f3\u8a2d\u8a08|\u518d\u73fe\u7528\u30de\u30b9\u30bf\u30fc\u6307\u793a\u66f8|\u5168\u6587\u7d50\u5408\u51fa\u529b|```|\[REJECTION|Chapter prose looks|Regenerate/i.test(t);return{plotRecovery:At(80+r*8+(s===1?5:-8)+(p?3:0)),structure:At(78+r*8+(o>=n?4:0)+(c>=4500?4:0)+(u>=3e3?3:0)),constraint:At(86+r*5+(s===1?4:-8)+(g?-12:5))}}function Q({phase:e="待機中",chapterNum:t=null,chapterChars:a=null,totalChars:n=null,extra:r="",level:s="active"}={}){const o=document.getElementById("ln-live-status");if(!o)return;const i=[e];t&&i.push(`現在: 第${t}章`),Number.isFinite(a)&&i.push(`章内 ${a.toLocaleString()}字`),Number.isFinite(n)&&i.push(`合計 ${n.toLocaleString()}字`),r&&i.push(r),i.push(`更新 ${new Date().toLocaleTimeString("ja-JP",{hour12:!1})}`),o.textContent=i.join(" / "),o.classList.remove("is-active","is-error"),s==="error"?o.classList.add("is-error"):s!=="idle"&&o.classList.add("is-active")}function qs(e,t={}){var a;if(!e||t.autoScroll===!1)return;const n=document.getElementById("output-panel");(a=n==null?void 0:n.classList)!=null&&a.contains("ln-live-preview")&&requestAnimationFrame(()=>{e.scrollTop=e.scrollHeight})}function Te(e,t,a="",n="",r={}){const s=(a||"").trim(),o=Gs(n),i=[s,o].filter(p=>p&&p.trim()).join(`

---

`);e&&(e.textContent=i,qs(e,r));const c=i.length;t&&(t.textContent=`${c.toLocaleString()} 字`);const u=document.getElementById("ln-char-count");return u&&(u.textContent=c.toLocaleString()),Q({phase:r.phase||"本文プレビュー更新中",chapterNum:r.chapterNum||null,chapterChars:o.length||null,totalChars:c,extra:r.extra||"",level:r.level||"active"}),c}function ba(e,t,a,n){const r=t?"本文末尾の独立行「【完】」":"文脈維持メモ";return`以下は長編小説 第${e}章の途中出力です。重複・要約・前置きなしで、最後に出力済みの文の直後から本文だけを続けてください。
...
・「修正後」「続きです」「了解しました」などのメタ文章は絶対に出力しない。`}function Me(e){const t=/(?:[【\[\(]?(?:\u6587\u8108\u7dad\u6301[^\n\u3011\]\)]{0,40}\u30e1\u30e2|\u6b21\u7ae0\u9023\u7d50[^\n\u3011\]\)]{0,40}\u30e1\u30e2|\u6b21\u7ae0\u5c0e\u5165\u7528|\u56de\u53ce\u9032\u884c\u30e1\u30e2|\u56de\u53ce\u5f85\u3061\u4f0f\u7dda\u30e1\u30e2|人物ロスター更新メモ|モチーフ＆サブキャラ追跡メモ|次章のシーン設計|再現用マスター指示書|文脈メモ|全文結合出力|全章(?:の|完了|執筆|分)|全[\d０-９一二三四五六七八九十]+章(?:の執筆が完了しました)?)[】\]\)]?)/i;let a=-1;const n=e.match(t);if(n)a=n.index;else{const o=Array.from(e.matchAll(/\u3010\u5b8c\u3011/g));if(o.length>0){const i=o[o.length-1];a=i.index+i[0].length}}if(a===-1)return{body:J(e),memo:""};let r=e.substring(0,a).trim();r=r.replace(/\n---\s*$/,"").trim(),r=r.replace(/\n(?:---+|#+)\s*\n/g,`

`),r=r.replace(/(?:\n|^)(?:---+|#+)\s*$/g,""),r=r.replace(/\n{3,}/g,`

`).trim(),r=J(r);const s=e.substring(a).trim();return{body:r,memo:s}}function ln(e){const t=e.match(/[#＃]\s*第([\d０-９一二三四五六七八九十]+)章[:：]?\s*(.+)/);return t?t[2].trim():""}function qe(){const e=document.getElementById("settings");if(!e)return;e.classList.add("generating"),e.style.pointerEvents="none",e.style.opacity="0.65",e.querySelectorAll("button, select, input, textarea").forEach(a=>{a.id==="btn-ln-abort"||a.id==="btn-ln-next"||a.hasAttribute("data-ln-locked")||(a.setAttribute("data-ln-locked",a.disabled?"true":"false"),a.disabled=!0)});const t=document.getElementById("btn-generate");t&&(t.textContent="🔒 長編進行中",t.disabled=!0)}function at(){const e=document.getElementById("settings");if(!e)return;e.classList.remove("generating"),e.style.pointerEvents="",e.style.opacity="",e.querySelectorAll("button, select, input, textarea").forEach(a=>{a.getAttribute("data-ln-locked")==="false"&&(a.disabled=!1),a.removeAttribute("data-ln-locked")});const t=document.getElementById("btn-generate");t&&(t.textContent="ストーリー生成",t.disabled=!1)}function me(e){var t;const a=document.getElementById("long-novel-panel"),n=document.getElementById("output-panel"),r=document.getElementById("btn-ln-pause"),s=document.getElementById("btn-ln-abort"),o=[document.getElementById("btn-ln-copy-novel"),document.getElementById("btn-ln-save-novel"),document.getElementById("btn-ln-copy-memo"),document.getElementById("btn-ln-save-memo")];a&&(e?(a.classList.add("ln-generating"),n==null||n.classList.remove("ln-novel-scroll"),n==null||n.classList.add("ln-live-preview"),r&&(r.disabled=!1,r.textContent=(t=l.longNovel)!=null&&t.isPaused?"一時停止予約中":"章末で一時停止"),s&&(s.disabled=!1,s.style.opacity="1",s.classList.remove("hidden")),o.forEach(i=>{i&&(i.disabled=!0,i.style.opacity="0.3")})):(a.classList.remove("ln-generating"),n==null||n.classList.remove("ln-live-preview"),s&&(s.disabled=!1,s.style.opacity=""),o.forEach(i=>{i&&(i.disabled=!1,i.style.opacity="")})))}function ye(){var e;const t=l.longNovel,a=document.getElementById("long-novel-panel"),n=document.getElementById("ln-work-title"),r=document.getElementById("ln-progress"),s=document.getElementById("ln-char-count"),o=document.getElementById("ln-target"),i=document.getElementById("ln-progress-bar"),c=document.getElementById("btn-ln-pause"),u=document.getElementById("btn-ln-abort");if(!a)return;a.classList.remove("hidden"),n.textContent=((e=t.headerInfo)==null?void 0:e.title)||"生成中...",r.textContent=`${t.currentChapter} / ${t.totalChapters} 章`;const p=t.cleanText.length;s.textContent=p.toLocaleString();const g=pa(t.settings,t.headerInfo,t.totalChapters);o.textContent=g?`約${g.toLocaleString()}字`:"数万字";const d=t.totalChapters>0?Math.round(t.currentChapter/t.totalChapters*100):0;i.style.width=`${d}%`;const y=a.classList.contains("ln-generating");if(t.totalChapters>0&&t.currentChapter>=t.totalChapters){const h=document.getElementById("output-panel");h&&h.classList.add("ln-novel-scroll"),c&&(c.disabled=!0,c.textContent="✅ 全章完了"),a.classList.add("ln-completed"),a.classList.remove("ln-generating"),at(),u&&(u.disabled=!0,u.style.opacity="0.3")}else{if(c)if(y){const v=Math.min(t.currentChapter+1,t.totalChapters||1);c.disabled=!1,c.textContent=t.isPaused?`一時停止予約中（第${v}章後）`:`章末で一時停止（第${v}章後）`}else t.isPaused?(c.disabled=!1,c.textContent="▶️ 生成を再開"):(c.disabled=!0,c.textContent="次章へ自動継続中");a.classList.remove("ln-completed");const h=document.getElementById("output-panel");h&&(t.currentChapter>0&&!y?h.classList.add("ln-novel-scroll"):h.classList.remove("ln-novel-scroll"))}u&&(u.classList.remove("hidden"),u.disabled=!1);const f=document.getElementById("btn-ln-copy-novel");f&&(p>kn?(f.disabled=!0,f.title=`クリップボードの容量制限（${Math.floor(kn/1e4)}万字）を超えるためコピーできません。TXT保存を使用してください。`,f.textContent="⚠ 容量超過 (ブラウザ制限につきコピー不可)"):(f.disabled=!1,f.title="小説本文をコピー",f.textContent="📋 コピー"))}function D(e){const t=document.getElementById("progress-log");if(!t)return;t.textContent+=`
`+e;const a=document.getElementById("progress-content");a&&(a.scrollTop=a.scrollHeight)}function Us(e){return new Promise(t=>setTimeout(t,e))}function Tn(e){return!!e&&e.active&&!e.isPaused&&e.currentChapter<e.totalChapters}async function $a(e,t){if(e&&e.currentChapter>=e.totalChapters){e.active=!1,_s(e),D(`[進行] 全${e.totalChapters}章の生成が完了しました ✅`),Q({phase:"全章生成完了",totalChars:(e.cleanText||"").length,extra:`${e.totalChapters}章完了`,level:"idle"});const n=Ks(e);va(n,!0),D(`[採点] 伏線回収度 ${n.plotRecovery}点 / 起承転結の構造 ${n.structure}点 / 制約遵守度 ${n.constraint}点`);try{const o=await Xn(l.apiKey,e.cleanText||"",e.settings||{},D,c=>D("[Eval] fallback: "+c)),i=Yn(o);i&&D(i)}catch(o){D("[Eval] Gen-4 evaluation skipped: "+(o&&o.message||o))}const r=document.getElementById("output"),s=document.querySelector(".char-counter");r&&Te(r,s,e.cleanText||"","",{phase:"全章生成完了",level:"idle"}),ye();return}if(!Tn(e)){D(`[進行] 第${t}章で停止しました。次章は自動生成されません。`),Q({phase:`第${t}章で停止中`,chapterNum:t,totalChars:(e.cleanText||"").length,extra:"再開待ち",level:"idle"}),ye();return}const a=e.currentChapter+1;D(`[進行] 第${t}章を保存しました。第${a}章へ進みます...`),Q({phase:`第${a}章へ移行中`,chapterNum:a,totalChars:(e.cleanText||"").length}),ye(),await Us(600),Tn(e)&&await un()}function Ws(){var e;const t=l.longNovel;t.cleanText&&wa(t.cleanText,((e=t.headerInfo)==null?void 0:e.title)||"長編小説","本文")}function Ca(e){return!e||!e.settings||!e.headerInfo?!1:!e.active||e.totalChapters>0&&e.currentChapter>=e.totalChapters}function Js(){var e;const t=l.longNovel;let a=t.memoText||"";if(Ca(t)){const n=gt(t.settings,t.headerInfo,l);a.includes("再現用マスター指示書")||(a+=(a?`

`:"")+n)}a&&wa(a,((e=t.headerInfo)==null?void 0:e.title)||"長編小説","メモ・指示書")}function wa(e,t,a){const n=new Date,r=`${n.getFullYear()}${String(n.getMonth()+1).padStart(2,"0")}${String(n.getDate()).padStart(2,"0")}${String(n.getHours()).padStart(2,"0")}${String(n.getMinutes()).padStart(2,"0")}${String(n.getSeconds()).padStart(2,"0")}`,s=`${t}_${a}_${r}.txt`,o=new Blob([e],{type:"text/plain;charset=utf-8"}),i=URL.createObjectURL(o),c=document.createElement("a");c.href=i,c.download=s,document.body.appendChild(c),c.click(),document.body.removeChild(c),URL.revokeObjectURL(i)}function cn(){const e=l.longNovel,t=document.getElementById("ln-memo-text");t&&(t.textContent=e.memoText||"（まだメモはありません）")}async function _n(e,t){if(e)try{await navigator.clipboard.writeText(e);const a=document.getElementById(t);if(a){const n=a.textContent;a.textContent="✅ コピーしました",a.classList.add("ln-copied"),setTimeout(()=>{a.textContent=n,a.classList.remove("ln-copied")},2e3)}}catch(a){console.error("Copy failed:",a)}}async function Ea(e,t,a,n,r,s=null){var o,i;const c=l.apiKey,u=Ge(c,l.apiProvider);if(!u.ok){a.innerHTML='<span class="error-msg">'+K(u.message)+"</span>",t.textContent="✨ 生成する",t.disabled=!1,(o=document.querySelector(".settings-panel"))==null||o.classList.remove("generating");return}const p=s&&s.counts?s.counts:null,g=s&&s.notes?s.notes:null;Pe(),s&&(l.longNovel.chapterRetryCounts=p||{},l.longNovel.chapterRetryNotes=g||{}),l.longNovel.active=!0,l.longNovel.settings=JSON.parse(JSON.stringify(e));const{prompt:d,tags:y}=nr(e);if(n){n.innerHTML="";const C=c.startsWith("sk-")?'<span class="tag tag-openai">ChatGPT</span>':'<span class="tag tag-gemini">Gemini</span>';n.innerHTML=C+'<span class="tag">📖 長編小説</span>'+y.map(w=>`<span class="tag">${w}</span>`).join("")}a.className="output-box text-selectable",a.textContent="📖 長編小説の第1章を生成中...（プロット設計→第1章執筆）";const f=ve[0].value;l.longNovel.usedModel=f,qe(),l.longNovel.totalChapters=Ot(e),ye(),me(!0),Q({phase:"第1章の生成準備中",chapterNum:1,totalChars:0});const h=document.getElementById("btn-ln-pause");h&&(h.disabled=!1,h.textContent="章末で一時停止（第1章後）");let v=0;const b=setInterval(()=>{if(!l.longNovel.active){clearInterval(b);return}v++,t.textContent=`⏳ AIが考え中... (${v}秒経過)`,h&&l.longNovel.active&&(h.textContent=l.longNovel.isPaused?"一時停止予約中（第1章後）":`章末で一時停止（第1章後・${v}秒）`)},1e3),$=new AbortController;l.longNovel.abortController=$;try{let C="",w=f;const I=Rt(e,null,10),S=ha($.signal);w=(await ke(c,w,d+Zt(e,"long"),({text:T,isThought:F})=>{l.longNovel.active&&(F||(C+=T,Te(a,r,"",C,{phase:"第1章を執筆中",chapterNum:1})))},T=>{t.innerHTML=`<span class="spinner"></span>フォールバック: ${T}`},S)).usedModel;let E=0;for(;E<5;){const T=((i=C.match(/([#＃]\s*第[1１一]章[\s\S]*)/))==null?void 0:i[1])||C,F=ya(T,!1,I);if(F.finished)break;E++,D(`[通信] 第1章: 未完了/文字数不足（本文 ${F.bodyChars.toLocaleString()} / 最低 ${F.minChars.toLocaleString()}字、raw ${F.rawChars.toLocaleString()}字、文脈メモ ${F.hasMemo?"あり":"なし"}）。続きを自動リクエスト中... (${E}/5)`);const R=ba(1,!1,C,I);let B="";const re=await ke(c,w,R,({text:Y,isThought:fe})=>{l.longNovel.active&&(fe||(B+=Y,Te(a,r,"",dt(C,B),{phase:"第1章を自動継続中",chapterNum:1,extra:`継続 ${E}/5`})))},Y=>{t.innerHTML=`<span class="spinner"></span>フォールバック: ${Y}`},S);C=dt(C,B),w=re.usedModel}if(l.longNovel.usedModel=w,!l.longNovel.active)return;const N=As(C);l.longNovel.headerInfo=N,l.longNovel.totalChapters=Ot(e,N),l.longNovel.headerInfo.totalChapters=l.longNovel.totalChapters;const P=Rt(e,N,l.longNovel.totalChapters),k=C.match(/([#＃]\s*第[1１一]章[\s\S]*)/),M=k?k[1]:C;let{body:x,memo:_}=Me(we(M));const H=k?C.substring(0,k.index).trim():"";let L="";if(x&&x.trim().length>100){t.textContent="🔍 第1章 矛盾検査中...",Q({phase:"第1章を検査中",chapterNum:1,chapterChars:x.length,totalChars:l.longNovel.cleanText.length||x.length});const T=F=>{console.log("[LN Audit Ch1]",F);const R=document.getElementById("progress-log");if(R){R.textContent+=`
`+F;const B=document.getElementById("progress-content");B&&(B.scrollTop=B.scrollHeight)}};try{const F=await Xt(c,x,l.longNovel.settings||e,{onStatus:T,chapterNum:1,isLastChapter:!1,fixMinorIssues:!0,failOnAuditError:!0,maxFixAttempts:2,validateFixedText:nt,sanitizeText:J});if(F.wasFixed&&(x=we(F.text)),F.remainingCriticalCount>0)throw T(`[検査] 第1章: 重大な矛盾が${F.remainingCriticalCount}件残存 ⚠️`),new Error(`重大な設定矛盾・出力汚染が解消できなかったため、第1章を棄却しました（残存: ${F.remainingCriticalCount}件）`);F.wasFixed&&T("[検査] 第1章: 矛盾修正が完了しました ✅"),F.issues.length>0&&(L=J(Jn(F.issues,1)))}catch(F){throw console.warn("第1章の矛盾検査でエラー:",F.message),T("[検査] 第1章: 検査エラー — 保存を停止します"),new Error(`第1章の検査に失敗したため保存を停止しました: ${F.message||F}`)}}D("[品質] 第1章: 本文保存前チェックを実行中..."),Q({phase:"第1章の保存前チェック中",chapterNum:1,chapterChars:x.length,totalChars:l.longNovel.cleanText.length||x.length}),x=we(x),{body:x,memo:_}=De(x,_),x=ze(x),x=Ye(x),x=z(x);let V=Z(x,{chapterNum:1,isLast:!1,minChars:P,totalChapters:l.longNovel.totalChapters});if(V.length>0&&(D(`[品質] 第1章: 保存前チェックで問題を検出: ${V.join(" / ")}`),x=we(x),{body:x,memo:_}=De(x,_),x=ze(x),x=Ye(x),x=z(x),V=Z(x,{chapterNum:1,isLast:!1,minChars:P,totalChapters:l.longNovel.totalChapters})),V.length>0)throw new Error(`第1章の保存前品質ゲートで停止しました: ${V.join(" / ")}`);D("[品質] 第1章: 保存前チェック通過。本文を採用します。"),l.longNovel.chapters.push({title:tt(ln(M),1)||rn(x,1)||sn(1,l.longNovel.totalChapters||1,be(e),N.logline||""),body:x,contextMemo:_}),l.longNovel.currentChapter=1,l.longNovel.fullText=C,D(`[進行] 第1章を保存しました（${x.length.toLocaleString()}字）。現在 ${l.longNovel.currentChapter} / ${l.longNovel.totalChapters} 章。`);const U=l.longNovel.chapters[0].title||"第一章",ie=ga(H,N,e,l.longNovel.totalChapters);l.longNovel.cleanText=ie+(ie?`

`:"")+`# 第1章: ${U}

`+x,l.longNovel.memoText=_?`--- 第1章の文脈メモ ---
${_}`:"",L&&(l.longNovel.memoText+=(l.longNovel.memoText?`

`:"")+L),Te(a,r,l.longNovel.cleanText,"",{phase:"第1章を保存しました",chapterNum:1,level:"idle"}),cn(),me(!1),ye(),qe(),clearInterval(b),await $a(l.longNovel,1)}catch(C){const w=(C==null?void 0:C.message)||String(C);if(D(`[Stop] Chapter 1 error: ${w}`),!l.longNovel.active)return;const I=["検査に失敗","重大な設定矛盾","出力汚染","棄却","残存","保存前品質ゲート","章本文が短すぎます"].some(N=>w.includes(N)),S=Number(l.longNovel.chapterRetryCounts&&l.longNovel.chapterRetryCounts[1]||0),E=/\u9577\u3044\u8AAC\u660E\u6BB5\u843D|\u5834\u9762\u6BB5\u843D\u6570|\u5834\u9762\u306E\u5207\u308C\u76EE|Too few prose paragraphs|\u7a7a\u884c\u304c\u591a\u3059\u304e|\u7a7a\u884c\u304c\u9023\u7d9a|\u6bb5\u843d\u304c\u7d30\u5207\u308c|\u7ae0\u672b\u304c\u5b9a\u578b\u7684\u306a\u60c5\u666f\u4f59\u97fb/.test(w)?4:2;if(I&&S<E){l.longNovel.chapterRetryCounts=l.longNovel.chapterRetryCounts||{},l.longNovel.chapterRetryNotes=l.longNovel.chapterRetryNotes||{};const N=S+1;l.longNovel.chapterRetryCounts[1]=N,l.longNovel.chapterRetryNotes[1]=[`The previous chapter 1 was rejected by the pre-save quality gate. Reason: ${w}`,"Rewrite chapter 1 completely while preserving the same logline and full outline.","If the previous ending sounded like a preview, teaser, next-chapter announcement, scenery-only afterglow, or polished emotional landing, end this retry on a concrete physical reaction, awkward spoken line, mundane task, object, cost, or unresolved pressure instead.","Use visible paragraph breaks with single newlines every 80-350 Japanese characters; do not insert blank empty lines after every sentence, and avoid giant explanation blocks.","Do not output design notes, quality-check text, regeneration explanations, or references to the previous failed attempt."].join(`
`);const P={counts:{...l.longNovel.chapterRetryCounts},notes:{...l.longNovel.chapterRetryNotes}};D(`[Regenerate] Chapter 1 rejected; regenerating the full chapter (${N}/${E})`),me(!0),qe(),Q({phase:"Regenerating chapter 1",chapterNum:1,totalChars:0,extra:`retry ${N}/${E}`,level:"active"}),ye(),setTimeout(()=>{l.apiKey&&Ea(e,t,a,n,r,P)},600);return}a.innerHTML=`<span class="error-msg">Error: ${w}</span>`,me(!1),Pe(),Q({phase:"Chapter 1 stopped",chapterNum:1,extra:w,level:"error"}),at()}finally{clearInterval(b)}}async function un(){var e,t;const a=l.longNovel;if(!a.active){D("[停止] 次章生成を開始できません。長編セッションが非アクティブです。");return}if(a.currentChapter>=a.totalChapters){D(`[進行] 現在 ${a.currentChapter} / ${a.totalChapters} 章のため、次章生成は不要です。`);return}const n=l.apiKey;if(!n){D("[停止] 次章生成を開始できません。APIキーがメモリ上で取得できません。");return}const r=a.currentChapter+1,s=r>=a.totalChapters,o=a.totalChapters?r>=Math.max(1,a.totalChapters-3):s;document.getElementById("long-novel-panel");const i=document.getElementById("btn-ln-pause"),c=document.getElementById("output"),u=document.querySelector(".char-counter");me(!0),Q({phase:`第${r}章の生成準備中`,chapterNum:r,totalChars:(a.cleanText||"").length}),i&&(i.disabled=!1,i.textContent=`章末で一時停止（第${r}章後）`);let p=0;const g=setInterval(()=>{if(!a.active){clearInterval(g);return}p++,i&&(i.textContent=a.isPaused?`一時停止予約中（第${r}章後）`:`章末で一時停止（第${r}章後・${p}秒）`)},1e3),d=a.chapters.slice(-2).map(($,C)=>`# 第${a.currentChapter-1+C+1}章: ${$.title}
${$.body}`).join(`
...
`):""].filter(Boolean).join(`
`),v=sr(r,a.totalChapters,a.settings,y,d,f,s,h)+Zt(a.settings,"long"),b=new AbortController;a.abortController=b;try{let $="",C=a.usedModel||ve[0].value;const w=Rt(a.settings,a.headerInfo,a.totalChapters),I=ha(b.signal);C=(await ke(n,C,v,({text:x,isThought:_})=>{a.active&&(_||($+=x,Te(c,u,a.cleanText,$,{phase:`第${r}章を執筆中`,chapterNum:r})))},x=>{D(`[通信] 第${r}章: フォールバック ${x}`)},I)).usedModel;let S=0;for(;S<5;){const x=ya($,s,w);if(x.finished)break;S++,D(`[通信] 第${r}章: 未完了/文字数不足（本文 ${x.bodyChars.toLocaleString()} / 最低 ${x.minChars.toLocaleString()}字、raw ${x.rawChars.toLocaleString()}字、文脈メモ ${x.hasMemo?"あり":"なし"}、完結 ${x.hasFinish?"あり":"なし"}）。続きを自動リクエスト中... (${S}/5)`);const _=Hs($,s,x),H=ba(r,s,_,w);let L="";const V=await ke(n,C,H,({text:U,isThought:ie})=>{if(a.active&&!ie){L+=U;const T=dt($,L,{isLast:s});Te(c,u,a.cleanText,T,{phase:`第${r}章を自動継続中`,chapterNum:r,extra:`継続 ${S}/5`})}},U=>{D(`[通信] 第${r}章: フォールバック ${U}`)},I);$=dt($,L,{isLast:s}),C=V.usedModel}if(a.usedModel=C,!l.longNovel.active)return;let{body:E,memo:N}=Me(we($)),P="";if(E&&E.trim().length>100){i&&(i.textContent=a.isPaused?`一時停止予約中（第${r}章後）`:`章末で一時停止（第${r}章後）`),Q({phase:`第${r}章を検査中`,chapterNum:r,chapterChars:E.length,totalChars:(a.cleanText||"").length+E.length});const x=_=>{console.log(`[LN Audit Ch${r}]`,_);const H=document.getElementById("progress-log");if(H){H.textContent+=`
`+_;const L=document.getElementById("progress-content");L&&(L.scrollTop=L.scrollHeight)}};try{const _=await Xt(n,E,a.settings,{onStatus:x,chapterNum:r,allContextMemos:f,recentChaptersFull:d,isLastChapter:s,fixMinorIssues:!0,failOnAuditError:!0,maxFixAttempts:o?3:2,validateFixedText:nt,sanitizeText:J});if(_.wasFixed&&(E=we(_.text)),_.remainingCriticalCount>0)throw x(`[検査] 第${r}章: 重大な矛盾が${_.remainingCriticalCount}件残存 ⚠️`),new Error(`重大な設定矛盾・出力汚染が解消できなかったため、第${r}章を棄却しました（残存: ${_.remainingCriticalCount}件）`);_.wasFixed&&x(`[検査] 第${r}章: 矛盾修正が完了しました ✅`),_.issues.length>0&&(P=J(Jn(_.issues,r)))}catch(_){throw console.warn(`第${r}章の矛盾検査でエラー:`,_.message),x(`[検査] 第${r}章: 検査エラー — 保存を停止します`),new Error(`第${r}章の検査に失敗したため保存を停止しました: ${_.message||_}`)}}D(`[品質] 第${r}章: 本文保存前チェックを実行中...`),Q({phase:`第${r}章の保存前チェック中`,chapterNum:r,chapterChars:E.length,totalChars:(a.cleanText||"").length+E.length}),E=we(E),{body:E,memo:N}=De(E,N),E=ze(E),E=Ye(E),E=z(E),s&&(E=Sn(E));let k=Z(E,{chapterNum:r,isLast:s,minChars:w,totalChapters:a.totalChapters,previousChapters:a.chapters});if(k.length>0&&(D(`[品質] 第${r}章: 保存前チェックで問題を検出: ${k.join(" / ")}`),E=we(E),{body:E,memo:N}=De(E,N),E=ze(E),E=Ye(E),E=z(E),s&&(E=Sn(E)),k=Z(E,{chapterNum:r,isLast:s,minChars:w,totalChapters:a.totalChapters,previousChapters:a.chapters})),k.length>0)throw new Error(`第${r}章の保存前品質ゲートで停止しました: ${k.join(" / ")}`);D(`[品質] 第${r}章: 保存前チェック通過。本文を採用します。`);const M=tt(ln($),r)||rn(E,r)||sn(r,a.totalChapters||r,be(a.settings||{}),(a.headerInfo||{}).logline||"");if(a.chapters.push({title:M,body:E,contextMemo:N}),a.currentChapter=r,a.chapterRetryNotes&&delete a.chapterRetryNotes[r],a.chapterRetryCounts&&delete a.chapterRetryCounts[r],a.fullText+=`

---

`+$,D(`[進行] 第${r}章を保存しました（${E.length.toLocaleString()}字）。現在 ${a.currentChapter} / ${a.totalChapters} 章。`),a.cleanText+=`

---

# 第${r}章: ${M}

`+E,N&&(a.memoText+=(a.memoText?`

`:"")+`--- 第${r}章の文脈メモ ---
${N}`),P&&(a.memoText+=(a.memoText?`

`:"")+P),Te(c,u,a.cleanText,"",{phase:`第${r}章を保存しました`,chapterNum:r,level:"idle"}),s&&a.settings&&a.headerInfo){const x=gt(a.settings,a.headerInfo,l);a.memoText+=`

`+x}cn(),me(!1),ye(),clearInterval(g),await $a(a,r)}catch($){const C=($==null?void 0:$.message)||String($);if(D(`[停止] 第${r}章処理でエラー: ${C}`),!a.active)return;const w=/検査に失敗|重大な設定矛盾|出力汚染|棄却|残存|保存前品質ゲート|章本文が短すぎます/.test(C),I=Number(((t=a.chapterRetryCounts)==null?void 0:t[r])||0),S=/前章以前の本文と長い重複段落|重複段落|冒頭一致/.test(C),E=a.chapterRetryNotes&&a.chapterRetryNotes[r]||"",N=S||/前章以前の本文と長い重複段落|重複段落|冒頭一致|前章本文/.test(E),P=!s&&(r===a.totalChapters-1||/Whole-story resolution/.test(C)&&a.totalChapters&&r>=Math.max(1,Math.ceil(a.totalChapters*.5))),k=/\u9577\u3044\u8AAC\u660E\u6BB5\u843D|\u5834\u9762\u6BB5\u843D\u6570|\u5834\u9762\u306E\u5207\u308C\u76EE|Too few prose paragraphs|\u7a7a\u884c\u304c\u591a\u3059\u304e|\u7a7a\u884c\u304c\u9023\u7d9a|\u6bb5\u843d\u304c\u7d30\u5207\u308c|\u7ae0\u672b\u304c\u5b9a\u578b\u7684\u306a\u60c5\u666f\u4f59\u97fb/.test(C),M=/重大な設定矛盾|重大な矛盾|設定矛盾|空間矛盾|時系列エラー|キャラクター不整合|伏線の矛盾|解消できなかった|残存/.test(C),x=/Whole-story resolution|\u7ae0\u672b\u304c\u4e88\u544a|\u7ae0\u672b\u304c\u5b9a\u578b\u7684\u306a\u60c5\u666f\u4f59\u97fb|\u4fdd\u5b58\u524d\u54c1\u8cea\u30b2\u30fc\u30c8|Too few prose paragraphs|\u7a7a\u884c\u304c\u591a\u3059\u304e|\u7a7a\u884c\u304c\u9023\u7d9a|\u6bb5\u843d\u304c\u7d30\u5207\u308c|\u5834\u9762\u6bb5\u843d\u6570|\u9577\u3044\u8aac\u660e\u6bb5\u843d/.test(E),_=o?5:N||P||k||M||x?4:2;if(w&&I<_){a.chapterRetryCounts=a.chapterRetryCounts||{},a.chapterRetryNotes=a.chapterRetryNotes||{};const H=I+1,L=N?["重複または巻き戻しで棄却されたため、前章本文の冒頭・段落・比喩・会話・場面配置を一切コピーしないこと。",`ただし時系列は変えないこと。第${r}章は直前章の最後の場所・時刻・負傷・関係状態から開始し、前章の移動・到着・目撃済み事件を再演しないこと。`,"必要なら直前章末の現場から一歩ずれた隣接地点・数分後へ移るが、未到着だったように書かないこと。","前章本文から連続しているように見える書き出し、同じ説明段落、同じ会話の再演を禁止すること。"]:[],V=P?["This is not the final chapter. Do not write full resolution, victory declaration, total villain defeat, social reconstruction, or full payoff.","Do not stop, destroy, silence, collapse, or fully resolve the central system, core, grand reset, antagonist, company, or society.","Do not write ambulance transfer, hospital awakening, quiet morning, several days later, or any epilogue-like aftermath.","Avoid phrases meaning everything ended or everything is over, even as threat or hypothesis.","Keep the central system/core/conspiracy active or only partly damaged; do not make this chapter the successful shutdown/destruction scene.","End with an unresolved core, maximum crisis, irreversible choice, or heavy cost reserved for the final chapter."]:[],U=k?["Use visible paragraph breaks with single newlines every 80-350 Japanese characters; do not insert blank empty lines after every sentence.","Do not write the chapter as four or fewer giant blocks; use at least seven visible prose paragraphs.","Every 2-4 paragraphs, move the scene through place, action, dialogue, choice, or consequence.","For the final two paragraphs, avoid sunset/sky/wind/light/echo afterglow; end with concrete human friction such as a messy spoken line, practical task, bodily discomfort, awkward silence, mundane noise, or unfinished obligation."]:[],ie=M?["整合性検査で修正しきれない矛盾が残ったため、小手先の修正ではなく章の設計から組み直すこと。","執筆前に、保存済み直近章の位置・時刻・所持品・負傷・生死・関係状態を固定し、その状態表から外れないこと。","地理移動・覚醒・死亡確認・アイテム発見・合流を、保存済み章で発生済みなら初発イベントとして再演しないこと。"]:[];a.chapterRetryCounts[r]=H,a.chapterRetryNotes[r]=[`前回の第${r}章は保存前検査で棄却された。原因: ${C}`,`第${r}章を、直近の文脈メモと次章GMC+Sから完全に書き直すこと。`,`失敗した第${r}章本文は正史ではない。保存済みの直近章だけを正史として続け、前回出力の移動経路・到着イベント・都市覚醒などを引き継がないこと。`,...L,...V,...U,...ie,"Canon-state retry lock: saved chapters and context memos are the only canon; rejected retry drafts and old outline beats are not canon.","Start after the immediately previous saved chapter final state: place/time, injuries, destroyed or lost items, fired weapons, deaths/exits, handoffs, and unresolved crisis.","Do not replay, rewind, undo, hallucinate, or re-stage completed trigger pulls, injuries, item destruction/loss, arrivals, escapes, awakenings, system shutdowns, or public collapses.","If a hand, item, weapon, body part, device, or route was destroyed, lost, burned, broken, disabled, or spent in saved canon, it cannot function normally or reappear intact in this chapter.","前章までに発生済み・紛失済み・負傷済み・回収済み・退場済みになった出来事を、初発イベントとして再演しないこと。","古い全体プロットよりも、直近章の文脈メモ、人物状態、回収待ち伏線、次章シーン設計を優先すること。"].join(`
`),D(`[再生成] 第${r}章: 検査失敗のため章全体を再生成します（${H}/${_}）`),me(!0),qe(),Q({phase:`第${r}章を再生成します`,chapterNum:r,totalChars:(a.cleanText||"").length,extra:`再生成 ${H}/${_}`,level:"active"}),ye(),setTimeout(()=>{var T;(T=l.longNovel)!=null&&T.active&&l.longNovel.currentChapter<r&&un()},600);return}c&&(c.textContent=a.cleanText||`⚠ 第${r}章の生成でエラーが発生しました: ${C}`),me(!1),Q({phase:`第${r}章で停止`,chapterNum:r,totalChars:(a.cleanText||"").length,extra:C,level:"error"}),i&&(i.disabled=!1,i.textContent=`📖 第${r}章を再試行`)}finally{clearInterval(g)}}function zs(){const e=l.longNovel;if(!e.active)return;if(e.active=!1,e.abortController&&e.abortController.abort(),me(!1),e.settings&&e.headerInfo){const c=gt(e.settings,e.headerInfo,l);e.memoText+=(e.memoText?`

`:"")+c,cn()}const t=Math.max(1,e.currentChapter||0),a=Math.max(0,e.currentChapter||0);e.totalChapters=Math.max(e.totalChapters||0,t),ye();const n=document.getElementById("long-novel-panel");n==null||n.classList.add("ln-completed");const r=document.getElementById("output-panel");r&&r.classList.add("ln-novel-scroll");const s=document.getElementById("long-novel-title");s&&(s.textContent=a>0?`長編小説モード（第${a}章で中断）`:`長編小説モード（第${t}章生成中に中断）`),at();const o=document.getElementById("btn-ln-pause"),i=document.getElementById("btn-ln-abort");o&&(o.disabled=!0,o.textContent="⏹ 中断済み"),i&&(i.disabled=!0,i.style.opacity="0.3"),Q({phase:"中断済み",chapterNum:t,totalChars:(e.cleanText||"").length,extra:a>0?`${a}章まで保存済み`:"保存済み章なし",level:"error"})}document.addEventListener("DOMContentLoaded",()=>{const e=document.getElementById("btn-ln-pause");e&&e.addEventListener("click",()=>{const i=l.longNovel,c=document.getElementById("long-novel-panel");if(!i.active)return;const u=c==null?void 0:c.classList.contains("ln-generating");if(i.isPaused)if(i.isPaused=!1,e.disabled=!1,u){const p=Math.min(i.currentChapter+1,i.totalChapters||1);e.textContent=`章末で一時停止（第${p}章後）`,D("[操作] 一時停止予約を解除しました。")}else e.textContent="次章へ自動継続中",e.disabled=!0,un();else i.isPaused=!0,e.textContent="一時停止予約中（現在章の後で停止）",e.disabled=!1,D("[操作] 現在章の完了後に一時停止します。")});const t=document.getElementById("btn-ln-abort");t&&t.addEventListener("click",()=>{confirm(`現在の進捗で生成を中断しますか？
（ここまでの全文はコピー・TXT保存が可能です）`)&&zs()});const a=document.getElementById("btn-ln-copy-novel");a&&a.addEventListener("click",()=>{_n(l.longNovel.cleanText,"btn-ln-copy-novel")});const n=document.getElementById("btn-ln-save-novel");n&&n.addEventListener("click",()=>{Ws()});const r=document.getElementById("btn-ln-copy-memo");r&&r.addEventListener("click",()=>{const i=l.longNovel;let c=i.memoText||"";if(Ca(i)){const u=gt(i.settings,i.headerInfo,l);c.includes("再現用マスター指示書")||(c+=(c?`

`:"")+u)}_n(c,"btn-ln-copy-memo")});const s=document.getElementById("btn-ln-save-memo");s&&s.addEventListener("click",()=>{Js()});const o=document.getElementById("ln-memo-toggle");o&&o.addEventListener("click",i=>{if(i.target.closest(".btn-ln-action"))return;const c=document.getElementById("ln-memo-content"),u=document.getElementById("ln-memo-arrow");c&&c.classList.toggle("hidden"),u&&u.classList.toggle("open")})});fa=function(e,{chapterNum:t,isLast:a,totalChapters:n}={}){const r=[],s=String(e||"").trim();if(!s||a)return r;const o=Number(n)||0,i=Number(t)||0;if(!o)return r;const c=Math.max(1,Math.ceil(o*.5));if(i<c)return r;const u=s.split(/[\u3002\uff01\uff1f!?\n]+/).map(y=>y.trim()).filter(Boolean),p=[{re:/\u3053\u308c\u306b\u3066\u4e00\u4ef6\u843d\u7740/},{re:/\u3059\u3079\u3066(?:\u304c|\u3001)?\u7d42\u308f/},{re:/\u7d42\u308f\u3063\u305f(?:\u306e\u306d|\u306e\u3060|\u306e\u304b|\u308f\u3051|\u306f\u305a|\u3068\u601d)/},{re:/(?:\u4eba\u3005|\u5e02\u6c11|\u6771\u4eac)[^\u3002\n]{0,120}(?:\u601d\u3044\u51fa|\u76ee\u899a\u3081)/},{re:/(?:\u6551\u6025\u8eca|\u642c\u9001|\u75c5\u5ba4|\u30d9\u30c3\u30c9|\u671d\u306e\u5149|\u9759\u304b\u306a\u671d)[^\u3002\n]{0,140}(?:\u76ee\u899a|\u8a18\u61b6|\u7d42\u308f|\u9759\u304b|\u623b)/},{re:/\u5b8c\u5168\u52dd\u5229|\u9ed2\u5e55\u5b8c\u5168\u6557\u5317|\u4f1a\u793e\u518d\u5efa(?:\u304c|\u306f)?\u5b8c\u4e86|\u5168\u9762\u5951\u7d04/}],g=[{re:/(?:\u30b7\u30b9\u30c6\u30e0|\u30b0\u30e9\u30f3\u30c9\u30fb\u30ea\u30bb\u30c3\u30c8|\u8abf\u5f8b)[^\u3002\n]{0,80}(?:\u505c\u6b62|\u6b62\u307e|\u5d29\u58ca|\u6c88\u9ed9|\u6d88\u3048)/},{re:/(?:\u30b3\u30a2|\u4e2d\u67a2|\u7089|\u8a18\u61b6\u88c5\u7f6e|\u5b9f\u9a13|\u8a08\u753b|\u9670\u8b00|\u30cd\u30c3\u30c8\u30ef\u30fc\u30af)[^\u3002\n]{0,120}(?:\u7834\u58ca|\u505c\u6b62|\u5d29\u58ca|\u6c88\u9ed9|\u6d88\u6ec5|\u6b62\u307e|\u7d42\u308f)/}],d=/(?:\u9632|\u963b\u6b62|\u5931\u6557|\u672a\u9042|\u672a\u5b8c|\u4e0d\u5b8c\u5168|\u90e8\u5206|\u5c40\u6240|\u4e00\u6642|\u5bf8\u524d|\u76f4\u524d|\u8a66\u307f|\u72d9|\u307e\u3060|\u7d9a|\u7a3c\u50cd|\u751f\u304d|\u6b62\u307e\u3089|\u56de\u907f|\u672a\u89e3\u6c7a|\u6b8b|\u7dad\u6301|\u4fdd\u305f|\u89e3\u9664\u3067\u304d\u306a\u3044|\u7834\u58ca\u3067\u304d\u306a\u3044|\u58ca\u305b\u306a\u3044|\u5d29\u58ca\u3057\u306a\u3044|\u6c88\u9ed9\u3057\u306a\u3044|\u6d88\u3048\u306a\u3044)/;for(const y of p)y.re.test(s)&&r.push(`Whole-story resolution appears before the final chapter (${y.re.toString()})`);for(const y of g)for(const f of u)if(y.re.test(f)&&!d.test(f)){r.push(`Whole-story resolution appears before the final chapter (${y.re.toString()})`);break}return r};const Ys=J;J=function(e){const t=Ys(e);return String(t||"").replace(/(?:^|\n)\s*(?:#{1,6}\s*)?(?:[【\[]\s*)?第[\d０-９一二三四五六七八九十]+章\s*終了時点での[\s\S]*$/g,`
`).replace(/(?:^|\n)\s*(?:#{1,6}\s*)?(?:CONTEXT MEMO|GMC\+S|Chapter\s+\d+\s+context memo)[\s\S]*$/gi,`
`).replace(/\n{3,}/g,`

`).trim()};const Xs=nt;nt=function(e){const t=Xs(e),a=String(e||"");return/(?:^|\n)\s*(?:#{1,6}\s*)?(?:[【\[]\s*)?第[\d０-９一二三四五六七八九十]+章\s*終了時点での|CONTEXT MEMO|GMC\+S|再現用マスター指示書/.test(a)&&t.push("Long-novel context memo fragment remains in chapter body"),t};const Qs=ae;ae=function(e){const t=String(e||"").trim();return Qs(e)||/^[\u3010\[]\s*(?:\u7ae0\u5185|\u7ae0\u672b|\u5834\u9762|\u8a2d\u8a08|\u30e1\u30e2|\u4f59\u97fb|\u30bf\u30fc\u30f3|\u4f0f\u7dda|GMC|Context|Plot|Turn|Aftertaste)[^\u3011\]\n]{0,60}[\u3011\]]?$/i.test(t)};const dn=e=>{const t=String(e||"").trim();if(!/^(?:[-*]|\u30fb)\s*/.test(t))return!1;const a=t.replace(/^(?:[-*]|\u30fb)\s*/,"").trim();return a?a.length>240?!1:/(?:\u6b21\u7ae0|\u5e03\u77f3|\u5c0e\u7dda|\u4f0f\u7dda|\u56de\u53ce|\u4e88\u5146|\u7aef\u7dd2|\u73fe\u5b9f\u6539\u5909|\u4e88\u5b9a|\u30e1\u30e2|\u5834\u9762|\u7ae0|GMC|Context|Plot|Turn|Aftertaste|arc)/i.test(a)||!/[\u3002\uff01\uff1f!?\u300d\u300f]$/.test(a)&&/(?:\u3068\u306a\u308b|\u3068\u3057\u3066|\u3078|\u306b|\u306e\u5e03\u77f3|\u306e\u5c0e\u7dda)$/.test(a):!0},Zs=z;z=function(e){let t=Zs(e);for(let a=0;a<5;a++){const n=String(t||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`).split(`
`);let r=n.length-1;for(;r>=0&&!n[r].trim();)r--;if(r<0)return"";let s=r;for(;s>=0&&dn(n[s]);)s--;if(s===r)break;t=n.slice(0,s+1).join(`
`).trimEnd()}return t};const eo=Z;Z=function(e,t){const a=eo(e,t),n=String(e||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`).split(`
`).map(s=>s.trim()).filter(Boolean).filter(s=>s!=="---");let r=n.length-1;for(;r>=0&&dn(n[r]);)r--;return r<n.length-1&&a.push("章末にラベルなし設計メモの箇条書きが残っています"),a};const to=ae,no=e=>String(e||"").trim().replace(/^[\u2010-\u2015\-]+\s*/,"").trim(),vt=e=>{const t=String(e||"").trim();if(!t)return!1;if(/^(?:[-*_]{1,4}|[-=]{3,}|[\u2010-\u2015]{1,4}|\uff0a+)$/.test(t)||/^[\uff08(]\s*(?:\u7d9a(?:\u304f|\u30fb|\u304d)?|continued?|to\s*be\s*continued)?\s*[\uff09)]?$/i.test(t)||/^(?:\u7d9a\u304f|to\s*be\s*continued)$/i.test(t)||dn(t)||/^(?:[-*]|\u30fb)\s*/.test(t))return!0;const a=no(t);return!!(a.length<=220&&/(?:^\u6b21\u7ae0|^\u7b2c[\d\uff10-\uff19\u4e00-\u9fff]+\u7ae0|\u6b21\u7ae0\s*[:\uff1a]|(?:\u5e03\u77f3|\u5c0e\u7dda|\u4f0f\u7dda|\u56de\u53ce|\u4e88\u5146|\u7aef\u7dd2|\u5834\u9762|\u8a2d\u8a08|\u30e1\u30e2|GMC|Context|Plot|Turn|Aftertaste))/i.test(a)||a.length<=80&&/^[\u3010\[]?\s*(?:\u7ae0\u5185|\u7ae0\u672b|\u5834\u9762|\u8a2d\u8a08|\u30e1\u30e2|\u4f59\u97fb|\u30bf\u30fc\u30f3|\u4f0f\u7dda|Plot|Turn|Aftertaste)/i.test(a))};ae=function(e){return to(e)||vt(e)};const ao=z;z=function(e){let t=ao(e);for(let a=0;a<8;a++){const n=String(t||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`).split(`
`);let r=n.length-1;for(;r>=0&&!n[r].trim();)r--;if(r<0)return"";let s=r;for(;s>=0&&vt(n[s]);)s--;if(s===r)break;t=n.slice(0,s+1).join(`
`).trimEnd()}return t};const ro=Z;Z=function(e,t){const a=ro(e,t),n=String(e||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`).split(`
`).map(s=>s.trim()).filter(Boolean).filter(s=>s!=="---");let r=n.length-1;for(;r>=0&&vt(n[r]);)r--;return r<n.length-1&&a.push("章末に設計・継続メモ断片が残っています"),a};const pn=e=>/^[<\uFF1C\u3010\[\(\uFF08]?\s*\u7B2C[\d\uFF10-\uFF19\u4E00\u4E8C\u4E09\u56DB\u4E94\u516D\u4E03\u516B\u4E5D\u5341\u767E\u5343]+\u7AE0\s*[\u3001,\u30FB:\uFF1A]?\s*(?:\u4E86|\u7D42|\u5B8C|\u7D42\u4E86|\u7D42\u308F\u308A|\u304A\u308F\u308A)\s*[\u30FB\u3001\u3002.\s\u30FC\u2010-\u2015-]*[>\uFF1E\u3011\]\)\uFF09]?$/.test(String(e||"").trim()),so=/(?:^|\n)\s*[<\uFF1C\u3010\[\(\uFF08]?\s*\u7B2C[\d\uFF10-\uFF19\u4E00\u4E8C\u4E09\u56DB\u4E94\u516D\u4E03\u516B\u4E5D\u5341\u767E\u5343]+\u7AE0\s*[\u3001,\u30FB:\uFF1A]?\s*(?:\u4E86|\u7D42|\u5B8C|\u7D42\u4E86|\u7D42\u308F\u308A|\u304A\u308F\u308A)\s*[\u30FB\u3001\u3002.\s\u30FC\u2010-\u2015-]*[>\uFF1E\u3011\]\)\uFF09]?(?=\n|$)/g,je=e=>/^\s*\u7B2C[\d\uFF10-\uFF19\u4E00\u4E8C\u4E09\u56DB\u4E94\u516D\u4E03\u516B\u4E5D\u5341\u767E\u5343]+\u7AE0(?:\u3067\u306F|\u3067|\u306B\u304A\u3044\u3066|\u306E\u4E2D\u3067|\u3068\u3044\u3046)/.test(String(e||"").trim())&&/[\u3002\uFF01\uFF1F!?\u300D\u300F]$/.test(String(e||"").trim()),oo=ae;ae=function(e){return je(e)?!1:oo(e)||pn(e)};const io=J;J=function(e){const t=io(e);return String(t||"").replace(so,`
`).replace(/\n{3,}/g,`

`).trim()};const lo=z;z=function(e){const t=String(e||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`),a=t.split(`
`);let n=a.length-1;for(;n>=0&&!a[n].trim();)n--;if(n>=0&&je(a[n]))return t.trim();let r=lo(e);for(let s=0;s<8;s++){const o=String(r||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`).split(`
`);let i=o.length-1;for(;i>=0&&!o[i].trim();)i--;if(i<0)return"";let c=i;for(;c>=0&&!je(o[c])&&(pn(o[c])||vt(o[c]));)c--;if(c===i)break;r=o.slice(0,c+1).join(`
`).trimEnd()}return r};const co=Z;Z=function(e,t){const a=String(e||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`).split(`
`).map(r=>r.trim()).filter(Boolean);let n=co(e,t);return je(a[a.length-1]||"")&&(n=n.filter(r=>!String(r).includes("章末に設計・継続メモ断片"))),a.some(r=>pn(r))&&n.push("章本文に章了・章完了ラベル断片が残っています"),n};const uo=/^\s*[<\uFF1C\[\(\uFF08\u3010]?\s*(?:END\s+(?:OF\s+)?CHAPTER\s*\d+|CHAPTER\s*\d+\s*(?:END|DONE|COMPLETE(?:D)?|FINISH(?:ED)?|CLOSE(?:D)?)|(?:END|DONE|COMPLETE(?:D)?|FINISH(?:ED)?)\s+CHAPTER\s*\d+)\s*[>\uFF1E\]\)\uFF09\u3011]?\s*[.。・:：,\u3001\u2010-\u2015-]*\s*$/i,hn=e=>uo.test(String(e||"").trim()),po=ae;ae=function(e){return hn(e)||po(e)};const ho=J;J=function(e){const t=ho(e);return String(t||"").replace(/(?:^|\n)\s*[<\uFF1C\[\(\uFF08\u3010]?\s*(?:END\s+(?:OF\s+)?CHAPTER\s*\d+|CHAPTER\s*\d+\s*(?:END|DONE|COMPLETE(?:D)?|FINISH(?:ED)?|CLOSE(?:D)?)|(?:END|DONE|COMPLETE(?:D)?|FINISH(?:ED)?)\s+CHAPTER\s*\d+)\s*[>\uFF1E\]\)\uFF09\u3011]?\s*[.。・:：,\u3001\u2010-\u2015-]*\s*(?=\n|$)/gi,`
`).replace(/\n{3,}/g,`

`).trim()};const mo=z;z=function(e){let t=mo(e);for(let a=0;a<8;a++){const n=String(t||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`).split(`
`);let r=n.length-1;for(;r>=0&&!n[r].trim();)r--;if(r<0)return"";if(!hn(n[r]))break;t=n.slice(0,r).join(`
`).trimEnd()}return t};const go=Z;Z=function(e,t){const a=String(e||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`).split(`
`).map(r=>r.trim()).filter(Boolean),n=go(e,t);return a.some(r=>hn(r))&&n.push("章本文に英語の章完了制御ラベルが残っています"),n};const fo=e=>String(e||"").trim().replace(/^[>＞\s]+/,"").replace(/^[<＜【\[(\uFF08]+/,"").replace(/[>＞】\])\uFF09]+$/,"").replace(/[\u30FB\u3001\u3002.:\uFF1A,\u2010-\u2015\-\s]*$/,"").trim(),Nn="第[\\d０-９一二三四五六七八九十百千]+章",yo=new RegExp("^(?:"+Nn+"\\s*[\\u3001,\\u30FB:\\uFF1A]?\\s*(?:\\u7D9A\\u304F|\\u7D9A\\u304D|\\u3064\\u3065\\u304F|\\u7D99\\u7D9A|\\u6B21\\u7AE0\\u3078|\\u6B21\\u306E\\u7AE0|\\u6B21\\u7AE0)|"+Nn+"\\s*[\\u3001,\\u30FB:\\uFF1A]?\\s*(?:\\u4E86|\\u7D42|\\u5B8C|\\u7D42\\u4E86|\\u7D42\\u308F\\u308A|\\u304A\\u308F\\u308A)|(?:\\u7D9A\\u304F|\\u7D9A\\u304D|\\u3064\\u3065\\u304F|\\u6B21\\u7AE0\\u3078|\\u6B21\\u7AE0|\\u7D42\\u7AE0\\u3078|To\\s+be\\s+continued|Continued|Next\\s+chapter)|(?:END\\s+(?:OF\\s+)?CHAPTER\\s*\\d+|CHAPTER\\s*\\d+\\s*(?:END|DONE|COMPLETE(?:D)?|FINISH(?:ED)?|CLOSE(?:D)?|CONTINUES?)|(?:END|DONE|COMPLETE(?:D)?|FINISH(?:ED)?)\\s+CHAPTER\\s*\\d+|CONTINUED\\s+IN\\s+CHAPTER\\s*\\d+|NEXT\\s+CHAPTER)|\\u6587\\u8108\\u7DAD\\u6301[^\\n]{0,20}\\u30E1\\u30E2|\\u6B21\\u7AE0\\u9023\\u7D50[^\\n]{0,20}\\u30E1\\u30E2|\\u7D9A\\u304F\\u7AE0[^\\n]*)$","i"),xa=e=>{const t=String(e||"").trim();return!!(t.length>120&&/[\u3002\uFF01\uFF1F!?\u300D\u300F]$/.test(t)||/^\s*第[\d\uFF10-\uFF19\u4E00-\u9FFF]+章(?:では|で|において|の中で|という|に|を|が|は|から|まで|と)/.test(t)&&/[\u3002\uFF01\uFF1F!?\u300D\u300F]$/.test(t)||/\u300C.*\u7D9A\u304F.*\u300D/.test(t)&&t.length>20||/^\u7D9A\u304F[\u4E00-\u9FFF\u3040-\u309F\u30A0-\u30FF]/.test(t)&&t.length>15&&/[\u3002\uFF01\uFF1F!?\u300D\u300F]$/.test(t))},ka=e=>/^\s*[#＃]+\s*第[\d\uFF10-\uFF19\u4E00-\u9FFF]+章\s*[:：]?\s*.{2,}/.test(String(e||"").trim()),Ve=e=>{const t=String(e||"").trim();if(!t||ka(t)||xa(t)||je(t))return!1;const a=fo(t);return a?yo.test(a):!1},vo=e=>String(e||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`).split(`
`).filter(t=>!Ve(t)).join(`
`).replace(/\n{3,}/g,`

`).trim(),bo=ae;ae=function(e){return xa(e)||je(e)?!1:Ve(e)||bo(e)};const $o=J;J=function(e){const t=$o(e);return vo(t)};const Co=z;z=function(e){let t=Co(e);for(let a=0;a<8;a++){const n=String(t||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`).split(`
`);let r=n.length-1;for(;r>=0&&!n[r].trim();)r--;if(r<0)return"";if(!Ve(n[r]))break;t=n.slice(0,r).join(`
`).trimEnd()}return t};const wo=Z;Z=function(e,t){const a=String(e||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`).split(`
`).map(r=>r.trim()).filter(Boolean),n=wo(e,t);return a.some(r=>Ve(r))&&n.push("章本文にチャプターコントロールアーティファクト（続く/了/END CHAPTER等）が残っています"),n};const Eo=/^(?:【(?:作品ヘッダー情報|あらすじ|完)】|\[(?:作品ヘッダー情報|あらすじ)\])$/,mn=/(?:文脈|次章|後半|補完|接続|連結|構造|設計|章末|章内|伏線|回収|ロスター|モチーフ|サブキャラ|管理|指示|維持|導入|状態|補足|GMC|GMC\+S|メモ)/i,xo=/(?:メモ|設計|補完|接続|連結|構造|管理|指示|状態|伏線|ロスター|モチーフ|GMC|GMC\+S)$/i,ko=e=>String(e||"").trim().replace(/^[#＃]+\s*/,"").replace(/^[>＞\s]+/,"").replace(/^[<＜【\[(（]+/,"").replace(/[>＞】\])）]+$/,"").replace(/[\u30FB\u3001\u3002.:\uFF1A,\u2010-\u2015\-\s]*$/,"").trim(),pt=e=>{const t=String(e||"").trim();if(!t||t.length>140||Eo.test(t)||ka(t))return!1;const a=ko(t);if(!a||a.length>120||/^(?:作品ヘッダー情報|あらすじ|完)$/.test(a))return!1;const n=/^[【\[(（].{1,130}[】\])）]$/.test(t),r=/第[\d\uFF10-\uFF19一二三四五六七八九十百千]+章|章末|章内/.test(a),s=mn.test(a),o=xo.test(a);return s&&(o||n||r)},Ao=e=>{const t=String(e||"").trim();return t?/^(?:[-*・•‣◦]|\d+[\).、．]|[①-⑳])\s*/.test(t)||/^(?:目的|狙い|要点|補足|接続|次章|伏線|状態|メモ|設計|構造|回収|Note|Notes|Revision|Finding|Weakest|Strongest|Hint)\s*[:：]/i.test(t)||t.length<=120&&mn.test(t)&&!/[。！？!?」』]$/.test(t)?"skip":"":"blank"},Aa=e=>{const t=String(e||"").trim();if(!/^(?:[-*・•‣◦]|\d+[\).、．]|[①-⑳])\s*/.test(t))return!1;const a=t.replace(/^(?:[-*・•‣◦]|\d+[\).、．]|[①-⑳])\s*/,"").trim();return!a||a.length>260?!1:mn.test(a)||/(?:前章|次章|章末|章内|幕間|伏線|回収|補完|接続|連結|構造|設計|プロット|ロスター|モチーフ|導入|状態|橋渡し|フック|文脈|GMC|GMC\+S)/i.test(a)},bt=e=>{const t=String(e||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`).split(`
`),a=[];for(let n=0;n<t.length;){const r=t[n];if(pt(r)){for(n++;n<t.length&&!(pt(t[n])||Ve(t[n]));){const s=Ao(t[n]);if(s==="skip"){n++;continue}if(s==="blank"){n++;break}break}continue}if(Ve(r)){n++;continue}if(Aa(r)){n++;continue}a.push(r),n++}return a.join(`
`).replace(/\n{3,}/g,`

`).trim()},So=e=>String(e||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`).split(`
`).some(t=>pt(t)||Aa(t)),Lo=J;J=function(e){return bt(Lo(e))};const Io=Me;Me=function(e){const t=Io(e);return{body:bt(t.body),memo:t.memo}};const To=De;De=function(e,t){const a=To(e,t);return{body:bt(a.body),memo:a.memo}};const _o=z;z=function(e){return bt(_o(e))};const No=ae;ae=function(e){return pt(e)||No(e)};const Mo=Z;Z=function(e,t){const a=Mo(e,t);return So(e)&&a.push("章本文に管理メモ/接続メモ/構造メモ等の管理ブロックまたは設計箇条書きが残っています"),a};
