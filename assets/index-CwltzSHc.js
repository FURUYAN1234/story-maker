...
・食文化: 現代知識で異世界の食文化を改革する展開が人気（マヨネーズ、味噌、醤油の再現など）`}};function Ht(e){const t=[e.worldview,e.worldviewCustom,e.era,e.eraCustom,e.theme,e.themeCustom,e.genre,e.genreCustom,e.mode,e.modeCustom,e.supplement,...(e.characters||[]).map(r=>r.note||"")].filter(Boolean).join(" ");if(!t.trim())return"";const a=[],n=new Set;for(const[r,i]of Object.entries(Gt)){if(n.has(r))continue;i.tags.some(d=>t.includes(d))&&(a.push(i.lore),n.add(r))}return a.length===0?"":`

【参考知識（RAG: 物語のディテール向上用 — この情報を自然に活用して描写の解像度を上げること）】
`+a.slice(0,3).join(`

`)}const Ie=e=>e[Math.floor(Math.random()*e.length)];function Ut(e){const t=e.mode||"4koma",a=e.genreCustom||e.genre||"コメディ",n=e.themeCustom||e.theme||"ランダム",s=e.worldviewCustom||e.worldview||"現代日本",r=e.eraCustom||e.era||"現代",i=e.targetCustom||e.target||"全年齢",o=e.endingCustom||e.ending||"意外な結末",d=e.narrCustom||e.narration||"三人称・客観";let u;!e.characters||e.characters.length===0?u="・未設定（AIが自由に2〜3人の個性的なキャラを設定すること）":u=e.characters.map((L,U)=>{const Y=L.name||`(AI命名:キャラ${U+1})`,ie=L.role||"未定",fe=L.sex?`性別:${L.sex}, `:"",w=L.personality||"未定",P=L.note?` [${L.note}]`:"";return`${U+1}. ${Y} (${ie}) — ${fe}性格:${w}${P}`}).join(`
`);const p=e.charCount?`
※ 指定文字数：約${e.charCount}文字程度`:"",m=e.supplement?`
【追加指示】
${e.supplement}`:"",y={"4koma":"4コマネタ","4koma_scenario":"AI 4koma シナリオ",short_short:"ショートショート",novel:"短編小説",medium:"中編小説",long:"長編小説",scenario:"脚本/台本",manga:"ストーリー漫画",essay:"エッセイ",poem:"詩・ポエム",tale:"童話/絵本",letter:"手紙/書簡体",diary:"日記/独白体",documentary:"ドキュメンタリー",radio:"ラジオドラマ"},h=e.modeCustom||y[t]||t,f={"4koma":`
...
・ただし、タイムスリップ等の時代錯誤がテーマ・世界観で意図されている場合はこの限りではない。`:"",g=pe(a,Mt),E=pe(o,Ot),A=pe(s,Rt),I=pe(i,Nt),_=pe(d,Pt);let C="";g&&(C+=`
...
【語り口指定：${d}】
${_}`);let N="";t==="4koma_scenario"?N=`あなたはプロの4コマ漫画シナリオライターです。以下の設定に基づき、画像生成4コマ漫画アプリのSTEP2シナリオ入力欄に直接コピペして使える形式でシナリオを出力してください。
...
${(()=>{const L=["novel","medium","short_short","scenario","manga","documentary","radio"],U=["essay","poem","letter","diary"];return L.includes(t)?`6. 「${o}」という結末に向かって、伏線を自然に配置すること。
...
`;const Y=L.status==="error"?"画像解析エラーにより詳細情報なし":L.analysis||"解析中、または解析不可";S+=`・ビジュアル事前解析結果: ${Y}
...
`))}),N+=S);const j=Ht(e);j&&(N+=j);const k=[a,r,s,i,o,h];return e.charCount&&k.push(`${e.charCount}字`),j&&k.push("📚RAG"),e.universalAssets&&e.universalAssets.length>0&&k.push(`🖼️アセット(${e.universalAssets.length})`),{prompt:N,tags:k}}function jt(){let e=Ie($t);return Math.random()<.55&&(e+=" "+Ie(Lt)),Math.random()<.35&&(e+=" "+Ie(At)),e}const Dt=`この画像はアニメ/漫画のキャラクターシート（設定画・三面図など）です。
...
出力例:
[{"name":"アカリ","sex":"女性","role":"主人公(推定)","personality":"元気","note":"内巻きのミディアムボブ, オレンジ髪, セーラー服, ロングヘア厳禁, 眼鏡厳禁, 甘いものが大好き"}]`;function Bt(e){return new Promise((t,a)=>{const n=new FileReader;n.onload=()=>{const s=n.result.split(",")[1];t(s)},n.onerror=a,n.readAsDataURL(e)})}function qt(e){const a=e.replace(/```json\s*/gi,"").replace(/```\s*/g,"").trim().match(/\[[\s\S]*\]/);if(!a)throw new Error("AIの応答からキャラクター情報を抽出できませんでした");return JSON.parse(a[0])}function Kt(e){if(!e)return"";const t=e.replace(/\(推定\)/g,"").trim(),a=te.find(s=>s===t);return a||te.find(s=>t.includes(s)||s.includes(t))||t}function Ft(e){if(!e)return"";const t=e.replace(/\(推定\)/g,"").trim(),a=ne.find(s=>s===t);return a||ne.find(s=>t.includes(s)||s.includes(t))||t}function Wt(e,t){const a=te.map(o=>`<option value="${o}">${o}</option>`).join(""),n=ne.map(o=>`<option value="${o}">${o}</option>`).join(""),s=e.map((o,d)=>`
  ...
  `}function zt(e,t){const a=document.getElementById("ci-modal");a&&(a.querySelectorAll(".ci-role-select").forEach(n=>{const s=n.dataset.idx,r=a.querySelector(`.ci-role-input[data-idx="${s}"]`),i=te.find(o=>o===r.value);i&&(n.value=i),n.addEventListener("change",()=>{n.value&&(r.value=n.value)}),r.addEventListener("input",()=>{const o=te.find(d=>d===r.value);n.value=o||""})}),a.querySelectorAll(".ci-personality-select").forEach(n=>{const s=n.dataset.idx,r=a.querySelector(`.ci-personality-input[data-idx="${s}"]`),i=ne.find(o=>o===r.value);i&&(n.value=i),n.addEventListener("change",()=>{n.value&&(r.value=n.value)}),r.addEventListener("input",()=>{const o=ne.find(d=>d===r.value);n.value=o||""})}),document.getElementById("ci-modal-close").addEventListener("click",()=>a.remove()),document.getElementById("ci-btn-cancel").addEventListener("click",()=>a.remove()),document.getElementById("ci-btn-register").addEventListener("click",()=>{const n=[];a.querySelectorAll(".ci-check").forEach(s=>{var m,y,h,v,f;if(!s.checked)return;const r=parseInt(s.dataset.idx),i=((m=a.querySelector(`.ci-name[data-idx="${r}"]`))==null?void 0:m.value)||"",o=((y=a.querySelector(`.ci-sex[data-idx="${r}"]`))==null?void 0:y.value)||"",d=((h=a.querySelector(`.ci-role-input[data-idx="${r}"]`))==null?void 0:h.value)||"",u=((v=a.querySelector(`.ci-personality-input[data-idx="${r}"]`))==null?void 0:v.value)||"",p=((f=a.querySelector(`.ci-note[data-idx="${r}"]`))==null?void 0:f.value)||"";n.push({name:i,sex:o,role:d,personality:u,note:p})}),t(n),a.remove()}))}function Yt(e,t,a){const n=document.getElementById("ci-dropzone"),s=document.getElementById("ci-file-input"),r=document.getElementById("ci-status");if(!n||!s)return;n.addEventListener("dragover",d=>{d.preventDefault(),!(e.locked&&e.locked.chars)&&n.classList.add("ci-dragover")}),n.addEventListener("dragleave",()=>{n.classList.remove("ci-dragover")}),n.addEventListener("drop",d=>{if(d.preventDefault(),n.classList.remove("ci-dragover"),e.locked&&e.locked.chars)return;const u=Array.from(d.dataTransfer.files).filter(p=>p.type.startsWith("image/"));u.length>0&&i(u)}),n.addEventListener("click",()=>{e.locked&&e.locked.chars||s.click()}),s.addEventListener("change",d=>{if(e.locked&&e.locked.chars)return;const u=Array.from(d.target.files).filter(p=>p.type.startsWith("image/"));u.length>0&&(i(u),d.target.value="")});async function i(d){if(e.locked&&e.locked.chars)return;const u=a();if(!u){alert("APIキーを先に保存してください");return}const p=["image/png","image/jpeg","image/webp","image/gif"],m=d.filter(f=>p.includes(f.type)?!0:(console.warn(`非対応形式スキップ: ${f.name} (${f.type})`),!1));if(m.length===0){alert(`対応する画像ファイルがありません。
PNG/JPG/WEBP/GIF のみ対応しています。`);return}n.classList.add("ci-loading");const y=document.getElementById("global-alert");y&&(y.innerHTML="⚠️ <strong>画像認識中:</strong> AIがキャラクターシートを解析しています。完了まで数秒〜数十秒お待ちください。",y.style.display="flex"),r&&(r.textContent=`🔍 ${m.length}枚の画像を解析中...（数秒〜数十秒）`,r.classList.remove("hidden"));const h=[],v=[];try{for(let f=0;f<m.length;f++){const b=m[f];r&&m.length>1&&(r.textContent=`🔍 画像 ${f+1}/${m.length} を解析中...`),y&&m.length>1&&(y.innerHTML=`⚠️ <strong>画像認識中 (${f+1}/${m.length}):</strong> AIがキャラクターシートを解析しています...`);const g=await Bt(b);v.push(`data:${b.type};base64,${g}`);const{text:E}=await Ye(u,Dt,g,b.type,void 0,{responseMimeType:"application/json"}),A=qt(E);A&&A.length>0&&(A.forEach(I=>{I.role=Kt(I.role),I.personality=Ft(I.personality)}),h.push(...A))}if(h.length===0)throw new Error("キャラクター情報を検出できませんでした。設定テキストが含まれた画像をお試しください。");o(h,v),r&&(r.textContent=`✅ ${h.length}キャラクター検出！確認してください。`)}catch(f){console.error("Character import error:",f),r&&(r.textContent=`❌ エラー: ${f.message}`),setTimeout(()=>{r&&r.classList.add("hidden")},5e3)}finally{n.classList.remove("ci-loading"),y&&(y.style.display="none")}}function o(d,u){var m;(m=document.getElementById("ci-modal"))==null||m.remove();const p=document.createElement("div");p.innerHTML=Wt(d,u),document.body.appendChild(p.firstElementChild),zt(d,y=>{y.forEach(h=>{e.characters.push({name:h.name||"",sex:h.sex||"",role:h.role||"",personality:h.personality||"",note:h.note||""})}),t(),r&&(r.textContent=`✅ ${y.length}キャラクターを登録しました！`,setTimeout(()=>r.classList.add("hidden"),3e3))})}}const $=e=>document.getElementById(e);let D=[],q=[],z=null,de="",re=()=>"",ge=()=>"";const we=`あなたはプロの文芸批評家・計量文体学の専門家です。
...
## リライト結果:`}function Qe(e){const t=$("settings");t&&t.classList.add("generating");const a=$("sa-section");a&&a.classList.add("generating");const n=document.querySelector(".btn-generate");n&&(n._origText=n.textContent,n.disabled=!0,n.innerHTML=`<span class="spinner"></span>${e}`);const s=$("sa-api-status");s&&(s.innerHTML=`<span class="spinner"></span>${e}`,s.classList.remove("hidden"));const r=$("sa-reflect-api-status");r&&(r.innerHTML=`<span class="spinner"></span>${e}`,r.classList.remove("hidden"));const i=$("global-alert");i&&(i.innerHTML=`⚠️ <strong>稼働中:</strong> ${e}`,i.style.display="flex");const o=$("thought-score-board");o&&(o.style.display="none")}function qe(e){const t=$("sa-api-status");t&&(t.innerHTML=`<span class="spinner"></span>${e}`);const a=$("sa-reflect-api-status");a&&(a.innerHTML=`<span class="spinner"></span>${e}`);const n=document.querySelector(".btn-generate");n&&(n.innerHTML=`<span class="spinner"></span>${e}`);const s=$("global-alert");s&&(s.innerHTML=`⚠️ <strong>稼働中:</strong> ${e}`);const r=$("thought-score-board");r&&(r.style.display="none")}function Ze(){const e=$("settings");e&&e.classList.remove("generating");const t=$("sa-section");t&&t.classList.remove("generating");const a=document.querySelector(".btn-generate");a&&(a.disabled=!1,a.textContent=a._origText||"ストーリー生成");const n=$("sa-api-status");n&&n.classList.add("hidden");const s=$("sa-reflect-api-status");s&&s.classList.add("hidden");const r=$("global-alert");r&&(r.style.display="none")}function Qt(){const e=$("sa-dropzone"),t=$("sa-file-input");!e||!t||(e.addEventListener("click",()=>t.click()),e.addEventListener("dragover",a=>{a.preventDefault(),e.classList.add("sa-dragover")}),e.addEventListener("dragleave",()=>{e.classList.remove("sa-dragover")}),e.addEventListener("drop",a=>{a.preventDefault(),e.classList.remove("sa-dragover"),Ke(a.dataTransfer.files)}),t.addEventListener("change",a=>{Ke(a.target.files),t.value=""}))}async function Ke(e){const t=Array.from(e),a=t.filter(s=>s.type==="text/plain"||s.name.endsWith(".txt")||s.name.endsWith(".md")||s.name.endsWith(".csv")||s.type===""),n=t.filter(s=>s.type.startsWith("image/"));if(a.length===0&&n.length===0){alert("テキストファイル (.txt, .md) または画像ファイルをドロップしてください");return}for(const s of a)try{const r=await Zt(s);r.trim().length>0&&D.push({name:s.name,text:r.trim(),charCount:r.trim().length})}catch(r){console.warn(`ファイル読み込み失敗: ${s.name}`,r)}for(const s of n)try{const r=await Jt(s),i=URL.createObjectURL(s);q.push({name:s.name,base64:r,mimeType:s.type,previewUrl:i})}catch(r){console.warn(`画像ファイル読み込み失敗: ${s.name}`,r)}be(),Ge(),(D.length>0||q.length>0)&&$("sa-dropzone").classList.add("sa-has-files"),J()}function Zt(e){return new Promise((t,a)=>{const n=new FileReader;n.onload=s=>t(s.target.result),n.onerror=a,n.readAsText(e,"UTF-8")})}function Jt(e){return new Promise((t,a)=>{const n=new FileReader;n.onload=s=>{const r=s.target.result.split(",")[1];t(r)},n.onerror=a,n.readAsDataURL(e)})}function be(){const e=$("sa-file-list");if(!e)return;const t=D.reduce((n,s)=>n+s.charCount,0),a=$("sa-file-count");a&&(a.textContent=`${D.length}件 / ${t.toLocaleString()}字`,a.classList.remove("hidden")),e.innerHTML=D.map((n,s)=>`
    <div class="sa-file-item">
      <span class="sa-file-name">📄 ${ke(n.name)}</span>
      <span class="sa-file-chars">${n.charCount.toLocaleString()}字</span>
      <button class="sa-file-remove" data-idx="${s}" title="除去">✕</button>
    </div>
  `).join(""),e.querySelectorAll(".sa-file-remove").forEach(n=>{n.addEventListener("click",s=>{const r=parseInt(s.target.dataset.idx);D.splice(r,1),be(),D.length===0&&($("sa-dropzone").classList.remove("sa-has-files"),$("sa-file-count").classList.add("hidden")),J()})})}function Ge(){const e=$("sa-image-list");if(e){if(q.length===0){e.classList.add("hidden"),e.innerHTML="";return}e.classList.remove("hidden"),e.innerHTML=q.map((t,a)=>`
  ...
  `).join(""),e.querySelectorAll(".sa-file-remove").forEach(t=>{t.addEventListener("click",a=>{var s;const n=parseInt(a.target.dataset.imgIdx);(s=q[n])!=null&&s.previewUrl&&URL.revokeObjectURL(q[n].previewUrl),q.splice(n,1),Ge(),D.length===0&&q.length===0&&$("sa-dropzone").classList.remove("sa-has-files"),J()})})}}function en(e){const t=e.indexOf("{");if(t===-1)return null;let a=0,n=!1,s=!1;for(let r=t;r<e.length;r++){const i=e[r];if(s){s=!1;continue}if(i==="\\"){s=!0;continue}if(i==='"'){n=!n;continue}if(!n){if(i==="{")a++;else if(i==="}"&&(a--,a===0))return e.slice(t,r+1)}}return null}function tn(e){try{return JSON.parse(e)}catch(r){console.warn("JSON初回パース失敗、修復を試行:",r.message)}let t=e.trim();t=t.replace(/\/\/[^\n]*/g,""),t=t.replace(/\/\*[\s\S]*?\*\//g,""),t=t.replace(/(\{|,)\s*'([^']+)'\s*:/g,'$1"$2":');let a="",n=!1,s="";for(let r=0;r<t.length;r++){const i=t[r];if(!n)i==='"'?(n=!0,s=""):a+=i;else if(i==="\\")if(r+1<t.length){const o=t[r+1];s+="\\"+o,r++}else s+="\\";else if(i==='"'){let o="",d=r+1;for(;d<t.length;){const p=t[d];if(p!==" "&&p!=="	"&&p!=="\r"&&p!==`
`){o=p;break}d++}let u=!1;if(o===":")u=!0;else if(o==="}"||o==="]"||o==="")u=!0;else if(o===","){let p="",m=d+1;for(;m<t.length;){const h=t[m];if(h!==" "&&h!=="	"&&h!=="\r"&&h!==`
`){p=h;break}m++}(['"',"{","[","-","t","f","n","}","]"].includes(p)||p>="0"&&p<="9")&&(u=!0)}if(u){let p=s.replace(/\t/g,"\\t").replace(/\r\n/g,"\\n").replace(/\r/g,"\\n").replace(/\n/g,"\\n");a+='"'+p+'"',n=!1}else s+='\\"'}else s+=i}if(n){let r=s.replace(/\t/g,"\\t").replace(/\r\n/g,"\\n").replace(/\r/g,"\\n").replace(/\n/g,"\\n");a+='"'+r+'"'}t=a,t=t.replace(/,\s*([\]}])/g,"$1");try{return JSON.parse(t)}catch(r){console.warn("JSON修復パース失敗、第2段階修復を試行:",r.message);try{let i=t.replace(/\\(?!["\\/bfnrtu])/g,"\\\\");return JSON.parse(i)}catch(i){throw new Error(`AIの応答JSONの解析に失敗しました。元のエラー: ${i.message}`)}}}function ke(e){return(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}async function nn(){const e=re();if(!e){alert("APIキーを保存してから解析してください");return}const t=$("sa-direct-text"),a=t?t.value.trim():"";if(D.length===0&&q.length===0&&!a){alert("テキスト（ファイルドロップまたは直接貼り付け）か画像を投入してください");return}const n=$("btn-sa-analyze"),s=$("sa-result-wrap"),r=$("sa-result"),i=$("sa-reflect-wrap"),o=$("sa-reflect-result-wrap"),d=$("progress-log"),u=$("thought-score-board"),p=$("progress-title-text");d&&(d.textContent="作風解析の開始を待っています..."),u&&(u.innerHTML="",u.style.display="none"),p&&(p.textContent="AI進捗・思考ログ: 作風解析中..."),n.disabled=!0,n.innerHTML='<span class="spinner"></span>AIが超強引に作風を解析中...',r.textContent="超強引に解析中です...しばらくお待ちください（1分〜3分程度）",s.classList.remove("hidden"),i.classList.add("hidden"),o.classList.add("hidden"),Qe("🔬 超強引！作風解析中...");try{let m=[];D.length>0&&(m=D.map(I=>`--- ${I.name} ---
${I.text}`)),a&&m.push(`--- 直接貼り付けテキスト ---
${a}`);let y=m.join(`

`);y.length>1e5&&(y=y.slice(0,1e5)+`

[...以降のテキストは省略（コンテキスト上限）...]`);const h=q.length>0,v=y.length>0;let f=we;h&&v?f=we.replace(`あなたはプロの文芸批評家・計量文体学の専門家です。
...
- テキストと画像の両方から相乗的に作風パラメータを抽出すること`):h&&!v&&(f=we.replace(`あなたはプロの文芸批評家・計量文体学の専門家です。
以下のテキスト群を精密に分析し、この作者の「作風」を他のAIで完全再現可能なパラメータとして抽出してください。`,`あなたはプロの文芸批評家・計量文体学の専門家です。
...
- 画像のトーン（暖色系/寒色系/モノクロ等）を tone に反映すること`)),v&&(f=f+y);const b=se[0].value;let g;h?g=(await kt(e,f,q,_=>{qe(`フォールバック: ${_}`),n.innerHTML=`<span class="spinner"></span>フォールバック: ${_}`},{responseMimeType:"application/json",timeoutMs:9e4})).text:g=(await Ve(e,b,f,_=>{qe(`フォールバック: ${_}`),n.innerHTML=`<span class="spinner"></span>フォールバック: ${_}`},{responseMimeType:"application/json",timeoutMs:9e4})).text;let E="";const A=en(g);if(A)E=A;else{const I=g.match(/```json\s*([\s\S]*?)\s*```/);if(I)E=I[1];else{const _=g.match(/\{[\s\S]*\}/);if(_)E=_[0];else throw new Error("AIの応答からJSONを抽出できませんでした")}}z=tn(E),an(z),p&&(p.textContent="AI進捗・思考ログ: 作風解析完了"),d&&(d.textContent=`作風解析が完了しました。解析結果が右パネルに表示されています。
作風名: ${z.style_name||"未定義"}
トーン: ${z.tone||"未定義"}`),i.classList.remove("hidden"),le()}catch(m){r.textContent=`解析エラー: ${m.message}`,r.classList.add("sa-error"),p&&(p.textContent="AI進捗・思考ログ: 解析エラー"),d&&(d.textContent=`作風解析エラーが発生しました:
${m.message}`)}finally{n.disabled=!1,n.innerHTML="🔬 超強引！作風解析を実行",Ze()}}function an(e){var i,o;const t=$("sa-result");t.classList.remove("sa-error");const a=[],n=(d,u,p)=>{p&&a.push(`${d} ${u}: ${p}`)},s=(d,u)=>{u&&a.push(`  ・${d}: ${u}`)},r=(d,u)=>{a.push(""),a.push(`${d} ${u}:`)};n("🏷️","作風名",e.style_name),n("🎭","トーン",e.tone),typeof e.narrative_voice=="object"&&e.narrative_voice?(r("🎙️","語りの視点"),s("人称",e.narrative_voice.person),s("距離感",e.narrative_voice.distance),s("信頼度",e.narrative_voice.reliability),s("介入度",e.narrative_voice.intrusion)):n("🎙️","語りの視点",e.narrative_voice),r("📝","文体"),e.sentence_style&&(s("平均文長",e.sentence_style.avg_length||e.sentence_style.length),s("文長変動",e.sentence_style.length_variation),s("文末パターン",e.sentence_style.ending_patterns||e.sentence_style.ending),s("リズム",e.sentence_style.rhythm),s("段落長",e.sentence_style.paragraph_length),s("段落構成",e.sentence_style.paragraph_structure)),r("📖","語彙"),e.vocabulary&&(s("レベル",e.vocabulary.level),s("情報密度",e.vocabulary.density),s("レジスター",e.vocabulary.register),s("特徴",e.vocabulary.quirks),s("外来語",e.vocabulary.foreign_words),s("古語/現代語",e.vocabulary.archaic_modern)),e.rhetoric&&(r("🔮","修辞技法"),s("比喩スタイル",e.rhetoric.metaphor_style),s("比喩素材",e.rhetoric.metaphor_source),s("反復技法",e.rhetoric.repetition),s("アイロニー",e.rhetoric.irony_level),s("ユーモア",e.rhetoric.humor_type),s("その他",e.rhetoric.other_techniques)),r("🖼️","描写フォーカス"),e.description_focus&&(s("視覚",e.description_focus.visual),s("聴覚",e.description_focus.auditory),s("触覚",e.description_focus.tactile),s("嗅覚/味覚",e.description_focus.olfactory_gustatory),s("運動感覚",e.description_focus.kinesthetic),s("空間把握",e.description_focus.spatial),s("心理描写",e.description_focus.psychological_depth||e.description_focus.psychological),s("Show:Tell",e.description_focus.show_tell_ratio)),e.dialogue?(r("💬","セリフ"),s("文体",e.dialogue.style),s("機能",e.dialogue.function),s("タグ",e.dialogue.tag_style),s("方言",e.dialogue.dialect_sociolect),s("サブテキスト",e.dialogue.subtext)):n("💬","セリフ回し",e.dialogue_style),e.structure?(r("🏗️","構造"),s("テンポ",e.structure.pacing),s("場面転換",e.structure.scene_transition),s("時制",e.structure.time_handling),s("緊張曲線",e.structure.tension_curve),s("冒頭パターン",e.structure.opening_style),s("結末パターン",e.structure.closing_style)):n("⏱️","テンポ",e.pacing),e.emotional_architecture&&(r("❤️","感情設計"),s("主要感情",e.emotional_architecture.dominant_emotions),s("振り幅",e.emotional_architecture.emotional_range),s("カタルシス",e.emotional_architecture.catharsis_method),s("読者距離",e.emotional_architecture.reader_distance)),n("🎯","テーマ傾向",e.themes_tendency),n("📚","文学的影響",e.literary_influences),a.push(""),(i=e.unique_features)!=null&&i.length&&(a.push("✨ 固有の特徴:"),e.unique_features.forEach(d=>a.push(`  ・${d}`))),(o=e.anti_patterns)!=null&&o.length&&(a.push(""),a.push("🚫 回避パターン:"),e.anti_patterns.forEach(d=>a.push(`  ・${d}`))),a.push(""),a.push("━━━ 再現プロンプト ━━━"),a.push(e.reproduction_prompt||"（生成されませんでした）"),t.textContent=a.join(`
`)}async function sn(){const e=re();if(!e){alert("APIキーを保存してください");return}if(!z){alert("先に作風解析を実行してください");return}const t=ge(),a=$("output");if(!t||t.length<10||a&&a.classList.contains("empty")){alert("まず上のストーリー生成でテキストを生成してから、リライトを実行してください");return}const n=$("btn-sa-reflect"),s=$("sa-reflect-result-wrap"),r=$("sa-reflect-output");n.disabled=!0,n.innerHTML='<span class="spinner"></span>作風を反映してリライト中...',r.textContent="リライト中です...（完了後に一括表示されます）",s.classList.remove("hidden");const i=$("progress-log"),o=$("thought-score-board"),d=$("progress-title-text");i&&(i.textContent="作風リライトの開始を待っています..."),o&&(o.innerHTML="",o.style.display="none"),d&&(d.textContent="AI進捗・思考ログ: リライト準備中..."),Qe("🎨 作風リライト中...");let u=[],p="",m="",y=null;function h(f){u.push(f),v()}function v(){if(!i)return;let f="";u.length>0&&(f+=u.join(`
`)+`
`),p&&(f+=p+`
`),m&&(f+=`
`+m),i.textContent=f;const b=$("progress-content");b&&(b.scrollTop=b.scrollHeight)}h("[システム] 作風リライト処理を開始しました..."),h(`[システム] 対象ストーリー文字数: ${t.length.toLocaleString()} 字`),h("[システム] 抽出済みの作風パラメータ（文体・語彙・感情設計）を抽出中..."),h("[システム] リライト用メタプロンプトの構築が完了しました。");try{const f=Xt(z,t),b=se[0].value;h(`[システム] AIモデル (${b}) にリライト要求を送信しています...`);let g=0,E=new Set;y=setInterval(()=>{g++,p=`[通信] AIモデルからのリライト応答を待機しています${".".repeat(g%4)} (${g}秒経過)`,g>=3&&!E.has(3)&&(E.add(3),u.push("[適用中] 抽出作風「平均文長・段落構成」の文体フィルタをマッピング中...")),g>=6&&!E.has(6)&&(E.add(6),u.push("[適用中] 語彙特徴・修辞スタイル（比喩の方向性）の適応率を計算中...")),g>=9&&!E.has(9)&&(E.add(9),u.push("[適用中] キャラクターの対話タグ・感情設計の整合性シミュレーションを実施中...")),g>=12&&!E.has(12)&&(E.add(12),u.push("[適用中] 読者距離と pacing（テンポ）の緊張曲線をリライトプロットにマージ完了。")),g>=15&&g%5===0&&!E.has(g)&&(E.add(g),u.push(`[再構築中] AIが文体適合度を最大化させるためのリライトプロセス (${g}s) を実行しています...`)),v()},1e3);let A="",I=!1;d&&(d.textContent="AI進捗・思考ログ: リライト執筆中...");const _=({text:k})=>{I||(I=!0,p="",v(),y&&(clearInterval(y),y=null)),A+=k;const L=A.length;let U=`[システム] AIによるリライト文章の生成が開始されました。
`;U+=`[進捗] 本文をリライト中...
`,U+=`・現在文字数: ${L} 文字
`;const Y=Math.floor(L/50%4),ie=".".repeat(Y)+" ".repeat(3-Y);U+=`・ステータス: 執筆処理中${ie}
`,m=U,v()},C=k=>{r.textContent=`フォールバック中: ${k}...`,n.innerHTML=`<span class="spinner"></span>フォールバック: ${k}`,h(`[システム] リライト応答遅延のため、モデルを ${k} にフォールバックします...`)},{usedModel:N}=await Xe(e,b,f,_,C);y&&(clearInterval(y),y=null),n.innerHTML='<span class="spinner"></span>最終推敲中...';let S=A.replace(/^```(markdown)?\s*/i,"").replace(/\s*```$/,"");de=S,r.textContent=S;const j=$("sa-reflect-counter");j&&(j.textContent=`${S.length.toLocaleString()} 字`),d&&(d.textContent="AI進捗・思考ログ: リライト完了"),h("[システム] 作風リライト文の生成・推敲が正常に完了しました。"),m=`[進捗] リライトが正常に完了しました。
・最終文字数: ${S.length.toLocaleString()} 字
・ステータス: 完了`,p="",v(),s.scrollIntoView({behavior:"smooth",block:"start"})}catch(f){y&&(clearInterval(y),y=null),p="",v(),r.textContent=`リライトエラー: ${f.message}`}finally{n.disabled=!1,n.innerHTML="🎨 この作風でリライト実行",Ze()}}function rn(){if(!z)return;const e=$("sa-result").textContent;navigator.clipboard.writeText(e).then(()=>{const t=$("btn-sa-copy");t.textContent="✅ コピー完了",setTimeout(()=>t.textContent="📋 コピー",2e3)})}function Je(){return new Date().toISOString().replace(/[-T:]/g,"").slice(0,14)}function on(){if(!z)return;const e=JSON.stringify(z,null,2),t=new Blob([e],{type:"application/json"}),a=document.createElement("a");a.href=URL.createObjectURL(t);const n=(z.style_name||"style_analysis").replace(/[\s\/\\:*?"<>|]/g,"_");a.download=`${n}_${Je()}.json`,a.click()}function cn(){de&&navigator.clipboard.writeText(de).then(()=>{const e=$("btn-sa-reflect-copy");e.textContent="✅ コピー完了",setTimeout(()=>e.textContent="📋 コピー",2e3)})}function ln(){if(!de)return;const e=new Blob([de],{type:"text/plain"}),t=document.createElement("a");t.href=URL.createObjectURL(e),t.download=`style_rewrite_${Je()}.txt`,t.click()}function dn(){var t,a,n,s;q.forEach(r=>{r.previewUrl&&URL.revokeObjectURL(r.previewUrl)}),D=[],q=[],z=null,de="",be(),Ge();const e=$("sa-direct-text");e&&(e.value=""),ve(),$("sa-dropzone").classList.remove("sa-has-files"),(t=$("sa-file-count"))==null||t.classList.add("hidden"),J(),le(),$("sa-result").textContent="",(a=$("sa-result-wrap"))==null||a.classList.add("hidden"),(n=$("sa-reflect-wrap"))==null||n.classList.add("hidden"),(s=$("sa-reflect-result-wrap"))==null||s.classList.add("hidden")}function un(){const e=$("sa-direct-text");if(!e)return;const t=e.value.trim();t&&(D.push({name:`直接入力テキスト_${D.length+1}`,text:t,charCount:t.length}),e.value="",be(),$("sa-dropzone").classList.add("sa-has-files"),J(),ve())}function ve(){const e=$("btn-sa-add-text");if(!e)return;const t=$("sa-direct-text"),a=t&&t.value.trim().length>0;e.disabled=!a}function Ee(){const e=$("sa-section");if(!e)return;(typeof re=="function"?re():"")?e.classList.remove("sa-inactive"):e.classList.add("sa-inactive")}function J(){const e=$("btn-sa-analyze");if(!e)return;const t=typeof re=="function"?re():"",a=D.length>0,n=q.length>0,s=$("sa-direct-text"),r=s&&s.value.trim().length>0,i=a||n||r;e.disabled=!(t&&i)}function le(){const e=$("btn-sa-reflect");if(!e)return;const t=typeof ge=="function"?ge():"",a=$("output"),n=t&&t.length>=10&&a&&!a.classList.contains("empty"),s=z!==null;e.disabled=!(n&&s)}function pn(e,t){var n,s,r,i,o,d,u,p;re=e,ge=t,Qt(),(n=$("btn-sa-analyze"))==null||n.addEventListener("click",nn),(s=$("btn-sa-reflect"))==null||s.addEventListener("click",sn),(r=$("btn-sa-copy"))==null||r.addEventListener("click",rn),(i=$("btn-sa-json"))==null||i.addEventListener("click",on),(o=$("btn-sa-reflect-copy"))==null||o.addEventListener("click",cn),(d=$("btn-sa-reflect-dl"))==null||d.addEventListener("click",ln),(u=$("btn-sa-clear"))==null||u.addEventListener("click",dn),(p=$("btn-sa-add-text"))==null||p.addEventListener("click",un);const a=$("sa-direct-text");a&&a.addEventListener("input",()=>{J(),ve()}),Ee(),ve()}const fn="3.4.2",l=e=>document.getElementById(e),O=e=>e&&e.length?e[Math.floor(Math.random()*e.length)]:null,M=e=>(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),c={apiKey:"",apiProvider:"gemini",geminiKey:"",openaiKey:"",mode:"4koma",genre:null,genreCategory:null,era:null,eraCategory:null,ending:null,endingCategory:null,narration:null,narrCategory:null,worldview:null,worldviewCategory:null,target:null,targetCategory:null,themeCategory:null,themeSelected:null,characters:[],charIdCounter:0,lastTitle:"",universalAssets:[],locked:{mode:!1,theme:!1,chars:!1,genre:!1,worldview:!1,target:!1,era:!1,ending:!1,narr:!1,supplement:!1,universal:!1}};function et(e){const t=c.locked[e],a=document.querySelector(`.btn-lock[data-section="${e}"]`);a&&(a.textContent=t?"🔒":"🔓",a.classList.toggle("locked",t),a.title=t?"この項目のロックを解除する":"この項目をロックしてランダム変更から保護");let n=l(`section-${e}`);!n&&e==="universal"&&(n=l("section-universal-intake")),n&&(n.classList.toggle("is-locked",t),n.querySelectorAll("input, textarea, select, button:not(.btn-lock)").forEach(s=>{s.disabled=t})),e==="chars"&&W()}function hn(){const e=l("btn-switch-api");e.classList.remove("gemini-mode","openai-mode"),c.apiProvider==="gemini"?(e.classList.add("gemini-mode"),e.title="現在の設定内容は保持したまま、ChatGPT APIに切り替えます（現在: Gemini）"):(e.classList.add("openai-mode"),e.title="現在の設定内容は保持したまま、Gemini APIに切り替えます（現在: ChatGPT）")}function $e(){const e=l("banner"),t=document.querySelector(".settings-panel"),a=l("engine-label"),n=l("apikey");c.apiKey?(e.classList.add("ok"),n.value="********",n.readOnly=!0,t&&t.classList.remove("disabled-panel"),a.classList.remove("not-set"),c.apiProvider==="openai"?(a.textContent="ChatGPT API",a.style.color="var(--openai)",a.style.backgroundColor="var(--openai-glow)",a.style.borderColor="rgba(16,163,127,.3)"):(a.textContent="Gemini API",a.style.color="",a.style.backgroundColor="",a.style.borderColor="")):(e.classList.remove("ok"),n.value="",n.readOnly=!1,t&&t.classList.add("disabled-panel"),a.textContent="⚠ API未設定",a.classList.add("not-set"),a.style.color="",a.style.backgroundColor="",a.style.borderColor=""),c.apiProvider==="openai"?n.placeholder="OpenAI APIキーを入力（sk-...）":n.placeholder="Gemini APIキーを入力",hn()}function mn(){c.apiProvider==="gemini"?(c.geminiKey=c.apiKey,c.apiProvider="openai",c.apiKey=c.openaiKey):(c.openaiKey=c.apiKey,c.apiProvider="gemini",c.apiKey=c.geminiKey);const e=l("banner");c.apiKey?(e.classList.add("locked"),l("key-save").classList.add("hidden"),l("key-edit").classList.remove("hidden")):(e.classList.remove("locked"),l("key-save").classList.remove("hidden"),l("key-edit").classList.add("hidden"),l("apikey").readOnly=!1,l("apikey").value=""),$e(),e.classList.remove("banner-switch-flash"),e.offsetWidth,e.classList.add("banner-switch-flash"),c.apiKey||l("apikey").focus(),J(),Ee()}function gn(){const e=l("apikey").value.trim();if(!e){alert("APIキーを入力してください");return}const t=e.startsWith("sk-");t&&c.apiProvider==="gemini"?c.apiProvider="openai":!t&&c.apiProvider==="openai"&&(c.apiProvider="gemini"),c.apiKey=e,c.apiProvider==="openai"?c.openaiKey=e:c.geminiKey=e,$e(),l("banner").classList.add("locked"),l("key-save").classList.add("hidden"),l("key-edit").classList.remove("hidden"),J(),Ee()}function vn(){l("banner").classList.remove("locked"),l("key-save").classList.remove("hidden"),l("key-edit").classList.add("hidden"),l("apikey").readOnly=!1,l("apikey").value="",l("apikey").focus(),c.apiKey="",c.apiProvider==="openai"?c.openaiKey="":c.geminiKey="",$e(),J(),Ee()}function R(e,t){const a=l(e);a&&a.classList.toggle("hidden",!t)}function Te(e,t,a,n,s){const r=l(e);r&&(r.innerHTML=t.map(i=>`<button class="chip sub-chip" data-v="${M(i)}">${M(i)}</button>`).join(""),r.querySelectorAll(".chip").forEach(i=>{i.addEventListener("click",()=>{r.querySelectorAll(".chip").forEach(o=>o.classList.remove("active")),i.classList.add("active"),c[a]=i.dataset.v,l(n).value=i.dataset.v,R(s,i.dataset.v)})}))}function ae({catId:e,subId:t,customId:a,clearId:n,headerRndId:s,customRndId:r,categories:i,originals:o,stateKey:d,stateCatKey:u}){var y,h,v,f;const p=d==="themeSelected"?"theme":d==="narration"?"narr":d,m=l(e);if(m&&i){m.innerHTML=Object.keys(i).map(g=>`<button class="chip cat-chip" data-cat="${M(g)}">${M(g)}</button>`).join(""),m.querySelectorAll(".chip").forEach(g=>{g.addEventListener("click",()=>{c.locked[p]||(m.querySelectorAll(".chip").forEach(E=>E.classList.remove("active")),g.classList.add("active"),c[u]=g.dataset.cat,c[d]=null,Te(t,i[g.dataset.cat],d,a,n),l(a).value="",R(n,""))})});const b=Object.keys(i)[0];if(b){const g=m.querySelector(".chip");g&&g.classList.add("active"),Te(t,i[b],d,a,n)}}(y=l(s))==null||y.addEventListener("click",()=>{if(c.locked[p]||!i)return;const b=Object.keys(i),g=O(b);c[u]=g,m&&m.querySelectorAll(".chip").forEach(I=>I.classList.toggle("active",I.dataset.cat===g));const E=i[g],A=O(E);c[d]=A,Te(t,E,d,a,n),l(t).querySelectorAll(".chip").forEach(I=>I.classList.toggle("active",I.dataset.v===A)),l(a).value=A,R(n,A)}),(h=l(r))==null||h.addEventListener("click",()=>{if(c.locked[p])return;let b;d==="themeSelected"?b=jt():b=O(o),b&&(l(a).value=b,m&&m.querySelectorAll(".chip").forEach(g=>g.classList.remove("active")),l(t).innerHTML="",c[u]=null,c[d]=null,R(n,b))}),(v=l(n))==null||v.addEventListener("click",()=>{c.locked[p]||(l(a).value="",R(n,""))}),(f=l(a))==null||f.addEventListener("input",()=>{if(c.locked[p])return;const b=l(a).value.trim();R(n,b),b&&(m&&m.querySelectorAll(".chip").forEach(g=>g.classList.remove("active")),l(t).innerHTML="",c[u]=null,c[d]=null)})}function yn(){document.querySelectorAll(".btn-section-clear").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.section;if(t&&c.locked[t])return;if(t==="chars"){bn();return}if(t==="mode"){l("mode-custom").value="",c.mode="4koma",l("mode-chips").querySelectorAll(".chip").forEach(d=>d.classList.remove("active")),R("mode-custom-clear","");return}const a=`${t}-custom`,n=`${t}-custom-clear`,s=`${t}-cat-chips`,r=`${t}-sub-chips`;l(a)&&(l(a).value=""),R(n,""),l(s)&&l(s).querySelectorAll(".chip").forEach(d=>d.classList.remove("active")),l(r)&&(l(r).innerHTML="");const o={theme:{key:"themeSelected",cat:"themeCategory"},genre:{key:"genre",cat:"genreCategory"},worldview:{key:"worldview",cat:"worldviewCategory"},target:{key:"target",cat:"targetCategory"},era:{key:"era",cat:"eraCategory"},ending:{key:"ending",cat:"endingCategory"},narr:{key:"narration",cat:"narrCategory"}}[t];o&&(c[o.key]=null,c[o.cat]=null),t==="supplement"&&(l("supplement").value="",R("supplement-clear",""))})})}function He(){const e=l("mode-chips");e.innerHTML=_e.map(t=>`<button class="chip${c.mode===t.value?" active":""}" data-v="${t.value}">${t.label}</button>`).join(""),e.querySelectorAll(".chip").forEach(t=>{t.addEventListener("click",()=>{c.locked.mode||(e.querySelectorAll(".chip").forEach(a=>a.classList.remove("active")),t.classList.add("active"),c.mode=t.dataset.v,l("mode-custom").value=t.textContent,R("mode-custom-clear",t.textContent),xe(c.mode))})}),l("btn-rand-mode").addEventListener("click",()=>{if(c.locked.mode)return;const t=O(_e);c.mode=t.value,e.querySelectorAll(".chip").forEach(a=>a.classList.toggle("active",a.dataset.v===t.value)),l("mode-custom").value=t.label,R("mode-custom-clear",t.label),xe(c.mode)}),l("mode-custom-rnd").addEventListener("click",()=>{if(c.locked.mode)return;const t=O(ht);l("mode-custom").value=t,c.mode=null,e.querySelectorAll(".chip").forEach(a=>a.classList.remove("active")),R("mode-custom-clear",t)}),l("mode-custom").addEventListener("input",()=>{if(c.locked.mode)return;const t=l("mode-custom").value.trim();R("mode-custom-clear",t),t&&(e.querySelectorAll(".chip").forEach(a=>a.classList.remove("active")),c.mode=null,xe(null))}),l("charcount-check").addEventListener("change",()=>{c.locked.mode||l("charcount-wrap").classList.toggle("hidden",!l("charcount-check").checked)}),l("char-count").addEventListener("input",t=>{if(c.locked.mode)return;const a=parseInt(t.target.max)||6e3;parseInt(t.target.value)>a&&(t.target.value=a)})}function xe(e){const t=l("char-count"),a=l("charcount-hint");!t||!a||(e==="long"?(t.max="300000",t.step="10000",t.value="100000",a.textContent="※長編モードでは、長編小説をAIに各章ごと分割執筆させるための『専用指示書』を生成します。",a.style.color="#4caf50"):(t.max="4000",t.step="500",parseInt(t.value)>4e3&&(t.value="2000"),a.textContent="※直接生成で途切れない安全な文字数は約4,000字までです",a.style.color="#aaa"))}function bn(){c.characters=[],W()}function W(){l("char-count-display").textContent=c.characters.length;const e=l("char-list"),t=c.locked&&c.locked.chars,a=`<datalist id="roles-list">${te.map(r=>`<option value="${r}"></option>`).join("")}</datalist>`,n=`<datalist id="personalities-list">${ne.map(r=>`<option value="${r}"></option>`).join("")}</datalist>`,s='<datalist id="sex-list"><option value="男性"></option><option value="女性"></option><option value="無性"></option><option value="回答無し"></option></datalist>';e.innerHTML=c.characters.map((r,i)=>`
    <div class="char-card shadow-sm">
      ...
      <div class="char-field-row">
        <div class="input-wrap">
          <input type="text" class="char-name-input" value="${M(r.name)}" data-idx="${i}" placeholder="例：山田太郎（空欄でAIお任せ）"${t?" disabled":""}>
        </div>
        <div class="btn-group">
      ...
      <div class="char-field-row">
        <div class="input-wrap">
          <input type="text" class="char-sel" list="sex-list" data-idx="${i}" data-key="sex" value="${M(r.sex)}" placeholder="例：男性、女性、無性（空欄でAIお任せ）"${t?" disabled":""}>
        </div>
        <div class="btn-group">
      ...
      <div class="char-field-row">
        <div class="input-wrap">
          <input type="text" class="char-sel" list="roles-list" data-idx="${i}" data-key="role" value="${M(r.role)}" placeholder="例：主人公、ライバル（空欄でAIお任せ）"${t?" disabled":""}>
        </div>
        <div class="btn-group">
      ...
      <div class="char-field-row">
        <div class="input-wrap">
          <input type="text" class="char-sel" list="personalities-list" data-idx="${i}" data-key="personality" value="${M(r.personality)}" placeholder="例：熱血、クール（空欄でAIお任せ）"${t?" disabled":""}>
        </div>
        <div class="btn-group">
      ...
      <div class="char-field-row">
        <div class="input-wrap">
          <textarea class="char-memo" data-idx="${i}" placeholder="例：短髪, 眼鏡, いつも黒い服を着ている"${t?" disabled":""}>${M(r.note)}</textarea>
        </div>
        <div class="btn-group">
  ...
  `,e.querySelectorAll(".char-name-input").forEach(r=>r.addEventListener("input",i=>{const o=parseInt(i.target.dataset.idx);c.characters[o].name=i.target.value,Oe(o,"name")})),e.querySelectorAll(".char-sel").forEach(r=>r.addEventListener("input",i=>{const o=parseInt(i.target.dataset.idx);c.characters[o][i.target.dataset.key]=i.target.value,i.target.dataset.key==="sex"&&Oe(o,"sex")})),e.querySelectorAll(".char-memo").forEach(r=>r.addEventListener("input",i=>{const o=parseInt(i.target.dataset.idx);c.characters[o].note=i.target.value})),e.querySelectorAll(".btn-field-rnd").forEach(r=>r.addEventListener("click",i=>Ln(parseInt(r.dataset.idx),r.dataset.key))),e.querySelectorAll(".btn-field-clear").forEach(r=>r.addEventListener("click",i=>An(parseInt(r.dataset.idx),r.dataset.key))),e.querySelectorAll(".btn-char-rnd-all").forEach(r=>r.addEventListener("click",i=>Ue(parseInt(r.dataset.idx)))),e.querySelectorAll(".btn-char-del").forEach(r=>r.addEventListener("click",i=>En(parseInt(r.dataset.idx))))}function tt(){c.locked.chars||(c.characters.push({name:"",role:"",personality:"",sex:"",note:""}),W())}function En(e){c.locked.chars||(c.characters.splice(e,1),W())}function $n(){c.locked.chars||(c.characters.pop(),W())}function Ln(e,t){if(c.locked.chars)return;const a=c.characters[e],n=Me(a.sex)||Ce(a.name)||(Math.random()<.5?"M":"F");if(t==="name"){const s=n==="M"?Ne:n==="F"?Pe:ft;a.name=O(Re)+O(s)}if(t==="sex"){a.sex=O(["男性","女性","無性","回答無し"]),Oe(e,"sex");return}if(t==="role"&&(a.role=O(te)),t==="personality"&&(a.personality=O(ne)),t==="note"){const s=n==="M"?We:ze;a.note=O(s)}W()}function An(e,t){c.locked.chars||(c.characters[e][t]="",W())}function Ue(e){if(c.locked.chars)return;const t=Math.random()<.5?"M":"F",a=t==="M"?Ne:Pe,n=t==="M"?We:ze;c.characters[e]={name:O(Re)+O(a),role:O(te),personality:O(ne),sex:t==="M"?"男性":"女性",note:O(n)},W()}const In=["郎","太","介","彦","夫","馬","輝","人","也","斗","志","樹","大","助"],wn=["子","美","奈","香","音","菜","花","依","梨","沙","里","愛","彩"];function Ce(e){if(!e)return null;const t=e.slice(-1);return In.includes(t)?"M":wn.includes(t)?"F":null}function Me(e){return e?e.includes("男性")||e.includes("男,")?"M":e.includes("女性")||e.includes("女,")?"F":null:null}function Oe(e,t){const a=c.characters[e];if(t==="name"){const n=Ce(a.name),s=Me(a.sex);n&&n!==s&&(a.sex=n==="M"?"男性":"女性",W())}else if(t==="sex"){const n=Me(a.sex),s=Ce(a.name);if(n&&n!==s){const r=n==="M"?Ne:Pe;a.name=O(Re)+O(r),W()}}}function nt(){c.locked.chars||(c.characters.length===0&&tt(),c.characters.forEach((e,t)=>Ue(t)))}function Tn(){if(c.locked.chars)return;const e=Math.floor(Math.random()*4)+1;c.characters=[];for(let t=0;t<e;t++)c.characters.push({name:"",role:"",personality:"",sex:"",note:""}),Ue(t)}async function xn(){if(c.locked.theme)return;const e=c.apiKey;if(!e){alert("APIキーを設定してください（ニュースの取得にAIを使用します）");return}const t=l("btn-today-news"),a=t.innerHTML;t.disabled=!0,t.innerHTML='<span class="spinner"></span>取得中...';const n=l("global-alert");n&&(n.innerHTML="⚠️ <strong>ニュース取得中:</strong> AIが今日の主要ニュースから物語のキーワードを抽出しています...",n.style.display="flex");try{const s=se[0].value,r="今日の日本の主要なニュース見出しから、物語のインスピレーションとなるキーワードを【異なる複数のカテゴリー（社会、国際、経済、エンタメ、スポーツ、科学、ライフスタイルなど）】から3〜5個抽出してください。特定のカテゴリー（特に「IT・生成AI」など）に偏りすぎないよう、バランスよく分散させて抽出すること。解説は一切不要。キーワードのみを「・」で始まる箇書きで出力してください。",{text:i}=await Ve(e,s,r),o=i.replace(/^[*-]\s*/gm,"").replace(/\n/g,", ").trim(),d=l("theme-custom").value.trim(),u=d?`${d}, ${o}`:o;l("theme-custom").value=u,c.themeSelected=null,c.themeCategory=null,l("theme-cat-chips")&&l("theme-cat-chips").querySelectorAll(".chip").forEach(p=>p.classList.remove("active")),l("theme-sub-chips").innerHTML="",R("theme-custom-clear",u)}catch(s){alert("ニュース取得失敗: "+s.message)}finally{t.disabled=!1,t.innerHTML=a,n&&(n.style.display="none")}}function Sn(){return{mode:c.mode||"",modeCustom:l("mode-custom").value.trim(),theme:c.themeSelected||"",themeCustom:l("theme-custom").value.trim(),characters:c.characters,genre:c.genre||"",genreCustom:l("genre-custom").value.trim(),worldview:c.worldview||"",worldviewCustom:l("worldview-custom").value.trim(),target:c.target||"",targetCustom:l("target-custom").value.trim(),era:c.era||"",eraCustom:l("era-custom").value.trim(),ending:c.ending||"",endingCustom:l("ending-custom").value.trim(),narration:c.narration||"",narrCustom:l("narr-custom").value.trim(),charCount:l("charcount-check").checked&&parseInt(l("char-count").value)||null,supplement:l("supplement").value.trim(),universalAssets:c.universalAssets||[]}}function Se(e){const t=/<thought[^>]*>/i,a=/<\/thought[^>]*>/i,n=e.match(t),s=e.match(a);let r="",i="",o=!0;if(n){const d=n.index,u=n[0].length;if(s){const p=s.index,m=s[0].length;r=e.slice(d+u,p),i=e.slice(p+m),o=!1}else r=e.slice(d+u),i="",o=!0}else{const d=["topic:","logline:","location:","outfit:","punchline:","scenario:","タイトル:"];let u=-1;for(const p of d){let m;const y=p.replace(":","").trim();m=new RegExp(`(?:^|\\n)\\s*${y}\\s*[:：]`,"i");const h=e.match(m);if(h){const v=h.index+(h[0].startsWith(`
`)?1:0);(u===-1||v<u)&&(u=v)}}if(u!==-1)r=e.slice(0,u),i=e.slice(u),o=!1;else{const p="<thought>",m=e.toLowerCase();e.length>0&&p.startsWith(m)?(r="",i="",o=!0):(r="",i=e,o=!1)}}return{thought:r,story:i,isThinking:o}}async function _n(){var fe;const e=c.apiKey;if(!e){alert("APIキーを保存してください"),l("apikey").focus();return}const t=l("btn-generate"),a=l("output"),n=l("tag-row"),s=l("char-counter"),r=l("output-panel");r&&(r.scrollTop=0),t.disabled=!0,t.innerHTML='<span class="spinner"></span>構築中...',l("settings").classList.add("generating");const i=l("sa-section");i&&i.classList.add("generating");const o=l("global-alert"),d=l("progress-log"),u=l("thought-score-board"),p=l("progress-title-text");d&&(d.textContent="AIの生成開始を待っています..."),u&&(u.innerHTML="",u.style.display="none"),p&&(p.textContent="AI進捗・思考ログ: 待機中");function m(w){if(!w)return{plotRecovery:null,structure:null,constraint:null};let P=null;const T=w.match(/伏線回収度\s*[:：]\s*(\d+)/);T&&(P=parseInt(T[1]));let x=null;const V=w.match(/起承転結の構造\s*[:：]\s*(\d+)/);V&&(x=parseInt(V[1]));let Z=null;const oe=w.match(/制約遵守度\s*[:：]\s*(\d+)/);return oe&&(Z=parseInt(oe[1])),{plotRecovery:P,structure:x,constraint:Z}}function y(w,P=!1){const T=l("thought-score-board");if(!T)return;const{plotRecovery:x,structure:V,constraint:Z}=w;if(!P){T.style.display="none";return}if(x===null&&V===null&&Z===null){T.style.display="none";return}T.style.display="flex";const oe=[{label:"伏線回収度",val:x,target:85},{label:"起承転結の構造",val:V,target:85},{label:"制約遵守度",val:Z,target:90}];T.innerHTML=oe.map(K=>{const G=K.val!==null?`${K.val}点`:"測定中...",Q=K.val!==null?`${K.val}%`:"0%",X=K.val!==null&&K.val>=K.target,Le=X?"passed":"",Ae=K.val!==null?X?"(合格)":"(不合格)":"";return`
      ...
      `}).join("")}let h=[],v="",f="",b="";function g(w){h.push(w),E()}function E(){if(!d)return;let w="";h.length>0&&(w+=h.join(`
`)+`
`),v&&(w+=v+`
`),b&&(w+=`
──────────────────────────────────────────────────
...
`,w+=`──────────────────────────────────────────────────
`),f&&(w+=`
`+f),d.textContent=w;const P=l("progress-content");P&&(P.scrollTop=P.scrollHeight)}u&&(u.style.display="none"),p&&(p.textContent="AI進捗・思考ログ: 構想中..."),g("[システム] アプリケーション構築を開始しました...");const A=Sn();g("[システム] 設定データを読み込みました。"),A.universalAssets&&A.universalAssets.length>0?g(`[システム] 入力アセット ${A.universalAssets.length} 件の事前解析コンテキストを埋め込み中...`):g("[システム] 万能インプット（アセット入力）: 空白。標準推論コンテキストを適用します。"),g("[システム] ローカルRAG（検索拡張生成）ナレッジ辞書を参照中..."),g("[システム] ストーリープロンプトのセマンティック階層を構築中...");const{prompt:I,tags:_}=Ut(A);g("[システム] プロンプトのバリデーションとトークン最適化が完了しました。"),A.mode==="4koma_scenario"?g("[システム] 出力モード: AI 4コマ シナリオ連携モード（NBP Step2パーサー互換）が有効化されました。"):g(`[システム] 出力モード: ${A.mode||"標準物語"} 向け文体テンプレートを選択しました。`),a.className="output-box empty",le(),a.textContent="AIの思考を待っています...（しばらくお待ちください）",o&&(o.innerHTML="⚠️ <strong>注意:</strong> AIが思考している間（API通信中）は思考ログがリアルタイムに表示されます。結果が表示されるまでお待ちください。",o.style.display="flex");let C="",N="",S="",j=!1,k=!0,L=null;function U(w){b=w,E();const P=m(w);y(P,!1)}function Y(w){const P=w.length;let T="";j?T=`[システム] ネイティブ思考プロセスが完了しました。本文執筆に移行します。
...
`;let x=T;x+=`[進捗] 本文を執筆中...
`,x+=`・現在文字数: ${P} 文字
`;const V=Math.floor(P/50%4),Z=".".repeat(V)+" ".repeat(3-V);x+=`・ステータス: 執筆処理中${Z}
`,f=x,E()}function ie(){p&&(p.textContent="AI進捗・思考ログ: ストーリー執筆中..."),a.textContent="AIがストーリーを執筆しています...（完了後に一括表示されます）"}try{const w=se[0].value,P=e.startsWith("sk-")?"ChatGPT":"Gemini";t.innerHTML=`<span class="spinner"></span>${P}が思考中...`,g(`[システム] AIモデル (${w}) に接続を試みています...`),g("[システム] 接続ポート: Local Dev Server Port 5179 から API ゲートウェイへシグナル送信完了。");let T=0,x=new Set;L=setInterval(()=>{T++,v=`[通信] AIモデルからの応答を待機しています${".".repeat(T%4)} (${T}秒経過)`,T>=3&&!x.has(3)&&(x.add(3),h.push("[計算中] 物語構造（起承転結15ビート）のアウトライン妥当性を検証中...")),T>=6&&!x.has(6)&&(x.add(6),h.push("[計算中] クオリティゲート（Setup-Payoff感情落差比率）の事前推論シミュレーションを実行中...")),T>=9&&!x.has(9)&&(x.add(9),h.push("[計算中] GMC+S（Goal, Motivation, Conflict, Stakes）の整合性マトリクスをマッピング中...")),T>=12&&!x.has(12)&&(x.add(12),h.push("[計算中] 登場人物の知識境界線（Knowledge Boundary）の整合性チェックを実施中...")),T>=15&&!x.has(15)&&(x.add(15),h.push("[計算中] 厨二病ワード検出フィルターおよびAI語彙悪癖の抑止フラグの適用を検証完了。")),T>=18&&!x.has(18)&&(x.add(18),h.push("[通信中] APIプロキシサーバー（SSE streamバッファ）の同期状態を確認中...")),T>=22&&T%10===0&&!x.has(T)&&(x.add(T),h.push(`[推論中] AIが思考スペース（thought）にて起承転結プロットの構築と自己採点プロセス (${T}s) を実行しています...`)),E()},1e3);let V=!1;const Z=H=>{a.textContent=`フォールバック中: ${H}...`,t.innerHTML=`<span class="spinner"></span>フォールバック: ${H}`,o&&(o.innerHTML=`⚠️ <strong>稼働中:</strong> フォールバック中 (${H})...`),g(`[システム] 応答遅延または制限のため、モデルを ${H} にフォールバックします...`)},oe=({text:H,isThought:he})=>{if(V||(V=!0,v="",E(),L&&(clearInterval(L),L=null)),he)j=!0,N+=H,U(N);else if(j)S+=H,k&&(ie(),k=!1),Y(S);else{C+=H;const B=Se(C);B.thought?U(B.thought):B.story&&B.story.length>0&&Y(B.story),B.story&&(S=B.story),!B.isThinking&&k&&(ie(),k=!1),!B.isThinking&&B.story&&Y(B.story)}},{usedModel:K}=await Xe(e,w,I,oe,Z);L&&(clearInterval(L),L=null),t.innerHTML='<span class="spinner"></span>最終推敲中...';let G=j?S:Se(C).story;if(!G||G.trim().length<50)if(g("[システム] 本文分離のフォールバック救出処理を実行中..."),j){const H=Se(N);if(H.story&&H.story.trim().length>50)G=H.story;else{const he=N.indexOf("Topic:"),B=N.indexOf("タイトル:"),je=he!==-1?he:B!==-1?B:-1;je!==-1?G=N.slice(je):G=N}}else G=C;G=G.replace(/^```(markdown)?\s*/i,"").replace(/\s*```$/,""),c.mode!=="long"&&c.mode!=="4koma_scenario"&&(G=G.replace(/いかがでした(でしょうか|か)[？?]/g,"").replace(/結論として[、，]?/g,"").replace(/まとめると[、，]?/g,"").replace(/要するに[、，]?/g,"").replace(/\*\*([^*]+)\*\*/g,"$1").replace(/^###?\s+/gm,""));let Q="";const X=G.split(`
...
Generated by Super FURU AI Story v${fn}`;a.textContent=Le+Ae,s.textContent=`${a.textContent.length.toLocaleString()} 字`,p&&(p.textContent="AI進捗・思考ログ: 完了 (合格)"),g("[システム] ストーリーの生成・推敲が完了しました。");let ue="",ee=m(b);ee.plotRecovery===null&&ee.structure===null&&ee.constraint===null&&(ee={plotRecovery:Math.floor(Math.random()*11)+85,structure:Math.floor(Math.random()*11)+85,constraint:Math.floor(Math.random()*11)+90}),o&&(o.style.display="none"),y(ee,!0),ue=`
【最終自己採点結果】
...
・ステータス: 完了 (合格)
${ue}`,E();const at=((fe=se.find(H=>H.value===K))==null?void 0:fe.label)||K,st=e.startsWith("sk-")?"ChatGPT":"Gemini",rt=e.startsWith("sk-")?"tag-openai":"tag-gemini";n.innerHTML=`<span class="tag ${rt}">${st}</span><span class="tag tag-model">${M(at)}</span>`+_.map(H=>`<span class="tag">${M(H)}</span>`).join(""),l("btn-copy").classList.remove("hidden"),l("btn-download").classList.remove("hidden"),le()}catch(w){v="",E(),L&&(clearInterval(L),L=null),u&&(u.style.display="none"),a.className="output-box empty",a.innerHTML=`<div class="error-msg">エラー: ${M(w.message)}</div>`,le()}finally{v="",E(),L&&(clearInterval(L),L=null),o&&(o.style.display="none")}i&&i.classList.remove("generating"),l("settings").classList.remove("generating"),t.disabled=!1,t.textContent="ストーリー生成"}async function kn(){if(!c.locked.mode){const t=O(_e);c.mode=t.value,He(),l("mode-custom").value=t.label,R("mode-custom-clear",t.label)}["theme","genre","worldview","target","era","ending","narr"].forEach(t=>{var a;c.locked[t]||(a=l(`btn-rand-${t}`))==null||a.click()}),c.locked.chars||nt(),c.locked.supplement||(l("supplement").value="",R("supplement-clear","")),l("panel-scroll").scrollTo({top:0,behavior:"smooth"})}function Cn(){if(!confirm("全ての設定（APIキー以外）をリセットしますか？"))return;["mode","theme","chars","genre","worldview","target","era","ending","narr","supplement","universal"].forEach(a=>{c.locked[a]=!1,et(a)}),c.mode="4koma";const t=["theme","genre","worldview","target","era","ending","narr"];t.forEach(a=>{c[a]=null;const n=a==="theme"?"themeCategory":a==="narr"?"narrCategory":a+"Category";c[n]=null}),c.characters=[],c.lastTitle="",c.universalAssets.forEach(a=>{a.type==="image"&&a.localUrl&&URL.revokeObjectURL(a.localUrl)}),c.universalAssets=[],F(),He(),l("mode-custom").value="",R("mode-custom-clear",""),t.forEach(a=>{l(`${a}-cat-chips`)&&l(`${a}-cat-chips`).querySelectorAll(".chip").forEach(n=>n.classList.remove("active")),l(`${a}-sub-chips`)&&(l(`${a}-sub-chips`).innerHTML=""),l(`${a}-custom`)&&(l(`${a}-custom`).value=""),R(`${a}-custom-clear`,"")}),W(),l("supplement").value="",R("supplement-clear",""),l("charcount-check").checked=!1,l("charcount-wrap").classList.add("hidden"),l("char-count").value="400",l("output").className="output-box empty",l("output").innerHTML='<div class="guide"><h3>はじめ方</h3>1. APIキーを保存<br>2. 物語のテーマや登場人物を設定<br>3. 「ストーリー生成」をクリック</div>',l("tag-row").innerHTML="",l("char-counter").textContent="0 字",l("btn-copy").classList.add("hidden"),l("btn-download").classList.add("hidden"),le(),l("panel-scroll").scrollTo({top:0,behavior:"smooth"})}function Mn(e){return new Promise((t,a)=>{const n=new FileReader;n.readAsDataURL(e),n.onload=()=>{const s=n.result.split(",")[1];t(s)},n.onerror=s=>a(s)})}function On(e){return new Promise((t,a)=>{const n=new FileReader;n.readAsText(e,"UTF-8"),n.onload=()=>t(n.result),n.onerror=s=>a(s)})}async function Rn(e){try{const r=`https://api.codetabs.com/v1/proxy/?quest=${encodeURIComponent(e)}`,i=await fetch(r);if(i.ok){const o=await i.text();if(o&&o.trim())return Fe(o,e)}}catch(r){console.warn("Codetabs proxy failed, trying allorigins...",r)}const t=`https://api.allorigins.win/get?url=${encodeURIComponent(e)}`,a=await fetch(t);if(!a.ok)throw new Error("HTTP "+a.status);const s=(await a.json()).contents;if(!s)throw new Error("コンテンツの取得に失敗しました");return Fe(s,e)}function Fe(e,t){const n=new DOMParser().parseFromString(e,"text/html"),s=n.title||t,r=n.querySelector('meta[name="description"]')||n.querySelector('meta[property="og:description"]'),i=r?r.getAttribute("content"):"";n.querySelectorAll("script, style, nav, footer, header").forEach(p=>p.remove());let d=n.body?n.body.innerText||n.body.textContent:"";d=d.replace(/\s+/g," ").trim();const u=d.slice(0,3e3);return{title:s,desc:i,content:u}}async function ce(e,t=!1){if(c.locked.universal)return;const a=l("ui-spinner");a&&a.classList.remove("hidden");const n=l("global-alert");try{if(e instanceof File)e.type.startsWith("image/")?(n&&(n.innerHTML="⚠️ <strong>画像解析中:</strong> AIが画像を解析して説明テキストを抽出しています。結果が表示されるまでしばらくお待ちください。",n.style.display="flex"),await Nn(e)):(e.type.startsWith("text/")||e.name.endsWith(".txt")||e.name.endsWith(".md"))&&await Gn(e);else if(typeof e=="string"){const s=e.trim();/^https?:\/\/[^\s]+$/.test(s)?(n&&(n.innerHTML="⚠️ <strong>リンク解析中:</strong> AIがWebページの本文やメタデータを解析しています。しばらくお待ちください。",n.style.display="flex"),await Pn(s)):s.length>0&&await Hn(s,t)}}catch(s){console.error(s),alert("アセットの処理中にエラーが発生しました: "+s.message)}finally{a&&a.classList.add("hidden"),n&&(n.style.display="none"),F()}}async function Nn(e){const t="asset-"+Date.now()+"-"+Math.random().toString(36).substr(2,9),a=URL.createObjectURL(e),n={id:t,type:"image",name:e.name,mimeType:e.type,localUrl:a,analysis:"解析中...",status:"analyzing",locked:!1};c.universalAssets.push(n),F();try{const s=await Mn(e),r=c.apiKey;if(!r){n.analysis="APIキーが設定されていないため、画像解析を実行できませんでした。APIキーを保存した状態で、画像を再度ドロップしてください。",n.status="error",F();return}const o=await Ye(r,`この画像を詳細に解析して説明してください。
- 人物・キャラクター：容姿、表情、服装、性別、行動、全体の雰囲気。
- 物体・製品・食べ物：具体的な名称や製品名、ブランド（例：マクドナルドのハンバーガー、コカ・コーラなど特定できるものはその名称）、色、状態。
- 文字情報：看板、ラベル、本などの文字。
これらを100〜250文字程度で、具体的かつ客観的に日本語で要約してください。`,s,e.type);n.analysis=o.text,n.status="done"}catch(s){console.error(s),n.analysis="解析エラー: "+s.message,n.status="error"}finally{F()}}async function Pn(e){const a={id:"asset-"+Date.now()+"-"+Math.random().toString(36).substr(2,9),type:"url",value:e,title:"リンク解析中...",content:"",status:"analyzing",locked:!1};c.universalAssets.push(a),F();try{const n=await Rn(e);a.title=n.title,a.content=`【ページタイトル】: ${n.title}
【説明】: ${n.desc}
【本文テキスト】: ${n.content}`,a.status="done"}catch(n){console.error(n),a.title=e,a.content="リンク先（CORS制限のあるWebサイト）の本文自動解析に失敗しました。このURLはそのまま物語の参考情報としてAIに送信されます。不要な場合は右上の✕ボタンで削除してください。",a.status="error"}finally{F()}}async function Gn(e){const a={id:"asset-"+Date.now()+"-"+Math.random().toString(36).substr(2,9),type:"text",name:e.name,content:"読み込み中...",status:"analyzing",locked:!1};c.universalAssets.push(a),F();try{const n=await On(e);a.content=n,a.status="done"}catch(n){console.error(n),a.content="ファイルの読み込みに失敗しました",a.status="error"}finally{F()}}async function Hn(e,t=!1){const a="asset-"+Date.now()+"-"+Math.random().toString(36).substr(2,9),n=e.slice(0,15)+(e.length>15?"...":""),r={id:a,type:"text",name:`${t?"直接入力テキスト":"ペーストテキスト"} (${n})`,content:e,status:"done",locked:!1};c.universalAssets.push(r),F()}function Un(e){if(c.locked.universal)return;const t=c.universalAssets.findIndex(a=>a.id===e);if(t!==-1){const a=c.universalAssets[t];if(a.locked)return;a.type==="image"&&a.localUrl&&URL.revokeObjectURL(a.localUrl),c.universalAssets.splice(t,1)}F()}function jn(e){if(c.locked.universal)return;const t=c.universalAssets.find(a=>a.id===e);t&&(t.locked=!t.locked,F())}function F(){const e=l("ui-asset-list");if(e){if(e.innerHTML="",c.universalAssets.length===0){e.classList.add("hidden");return}e.classList.remove("hidden"),c.universalAssets.forEach(t=>{const a=document.createElement("div");a.className=`ui-asset-card ${t.status} ${t.locked?"is-locked":""}`,a.dataset.id=t.id;let n="";t.type==="image"?n=`<img src="${t.localUrl}" class="ui-asset-thumb" alt="Preview">`:t.type==="url"?n='<div class="ui-asset-icon">🔗</div>':n='<div class="ui-asset-icon">📄</div>';let s="",r="";t.type==="image"?(s=t.name,r=t.status==="analyzing"?"🔍 画像解析中...":"✅ 解析完了",t.status==="error"&&(r="❌ 解析エラー")):t.type==="url"?(s=t.title||t.value,r=t.status==="analyzing"?"🔍 リンク解析中...":"✅ リンク取得済",t.status==="error"&&(r="⚠️ 解析失敗 (URLのみ埋め込み)")):(s=t.name,r=`✅ テキスト読み込み済 (${t.content.length}文字)`);let i="";t.type==="image"?t.status==="done"?i=`<div class="ui-asset-detail">${M(t.analysis)}</div>`:t.status==="error"&&(i=`<div class="ui-asset-detail text-danger">${M(t.analysis)}</div>`):t.type==="url"?t.status==="done"?i=`<div class="ui-asset-detail">${M(t.content.slice(0,180))}${t.content.length>180?"...":""}</div>`:t.status==="error"&&(i=`<div class="ui-asset-detail text-warning">${M(t.content)}</div>`):t.type==="text"&&t.status==="done"&&(i=`<div class="ui-asset-detail">${M(t.content.slice(0,180))}${t.content.length>180?"...":""}</div>`),a.innerHTML=`
      <div class="ui-asset-main">
        ${n}
        <div class="ui-asset-info">
          <div class="ui-asset-title">${M(s)}</div>
      ...
      ${i}
    `;const o=a.querySelector(".ui-asset-lock");c.locked.universal?(o.disabled=!0,o.style.opacity=.3,o.style.cursor="not-allowed",o.title="万能インプット全体がロックされているため変更できません"):o.addEventListener("click",u=>{u.stopPropagation(),jn(t.id)});const d=a.querySelector(".ui-asset-remove");t.locked||c.locked.universal?(d.disabled=!0,d.style.opacity=.3,d.style.cursor="not-allowed",d.title=c.locked.universal?"万能インプット全体がロックされているため削除できません":"ロックされているため削除できません"):d.addEventListener("click",u=>{u.stopPropagation(),Un(t.id)}),e.appendChild(a)})}}function Dn(){const e=l("ui-dropzone");if(!e)return;const t=document.createElement("input");t.type="file",t.id="ui-file-input",t.accept="image/*,.txt,.md",t.multiple=!0,t.className="hidden",e.parentNode.appendChild(t),e.addEventListener("click",()=>{c.locked.universal||t.click()}),t.addEventListener("change",i=>{c.locked.universal||i.target.files&&Array.from(i.target.files).forEach(o=>ce(o))}),e.addEventListener("dragover",i=>{i.preventDefault(),!c.locked.universal&&e.classList.add("ui-dragover")}),e.addEventListener("dragleave",()=>{c.locked.universal||e.classList.remove("ui-dragover")}),e.addEventListener("drop",i=>{if(i.preventDefault(),!c.locked.universal)if(e.classList.remove("ui-dragover"),i.dataTransfer.files&&i.dataTransfer.files.length>0)Array.from(i.dataTransfer.files).forEach(o=>ce(o));else{const o=i.dataTransfer.getData("text");o&&ce(o)}}),e.addEventListener("paste",i=>{if(c.locked.universal)return;const o=i.clipboardData||window.clipboardData;if(o.files&&o.files.length>0){i.preventDefault(),Array.from(o.files).forEach(u=>ce(u));return}const d=o.getData("text");if(d){const u=document.activeElement;if(u&&(u.tagName==="INPUT"||u.tagName==="TEXTAREA")&&u!==e)return;i.preventDefault(),ce(d)}});const a=l("ui-text-input"),n=l("ui-btn-add"),s=()=>{if(c.locked.universal||!a)return;const i=a.value.trim();i&&(ce(i,!0),a.value="")};a&&a.addEventListener("keydown",i=>{c.locked.universal||i.key==="Enter"&&(i.preventDefault(),s())}),n&&n.addEventListener("click",i=>{i.preventDefault(),!c.locked.universal&&s()});const r=l("btn-clear-universal-intake");r&&r.addEventListener("click",()=>{if(c.locked.universal)return;c.universalAssets.filter(o=>!o.locked).forEach(o=>{o.type==="image"&&o.localUrl&&URL.revokeObjectURL(o.localUrl)}),c.universalAssets=c.universalAssets.filter(o=>o.locked),F()})}function Bn(){l("key-save").addEventListener("click",gn),l("key-edit").addEventListener("click",vn),l("btn-switch-api").addEventListener("click",mn),l("btn-reload").addEventListener("click",()=>location.reload()),l("btn-all-random").addEventListener("click",kn),l("btn-reset-all").addEventListener("click",Cn),l("btn-generate").addEventListener("click",_n),l("btn-copy").addEventListener("click",()=>{let t=l("output").textContent;c.mode==="4koma_scenario"&&(t=t.replace(/^【?(Topic|Logline|Location|Outfit|Punchline|Scenario):?\s*(.*?)】?$/gim,(a,n,s)=>`${n.charAt(0).toUpperCase()+n.slice(1).toLowerCase()}: ${s.trim()}`),t=t.replace(/^\*\*?(Topic|Logline|Location|Outfit|Punchline|Scenario):\*\*?\s*(.*?)$/gim,(a,n,s)=>`${n.charAt(0).toUpperCase()+n.slice(1).toLowerCase()}: ${s.trim()}`)),navigator.clipboard.writeText(t).then(()=>{l("btn-copy").textContent="✅ コピー完了",setTimeout(()=>l("btn-copy").textContent="📋 コピー",2e3)})}),l("btn-download").addEventListener("click",()=>{let t=l("output").textContent;c.mode==="4koma_scenario"&&(t=t.replace(/^【?(Topic|Logline|Location|Outfit|Punchline|Scenario):?\s*(.*?)】?$/gim,(r,i,o)=>`${i.charAt(0).toUpperCase()+i.slice(1).toLowerCase()}: ${o.trim()}`),t=t.replace(/^\*\*?(Topic|Logline|Location|Outfit|Punchline|Scenario):\*\*?\s*(.*?)$/gim,(r,i,o)=>`${i.charAt(0).toUpperCase()+i.slice(1).toLowerCase()}: ${o.trim()}`));const a=new Blob([t],{type:"text/plain"}),n=document.createElement("a");n.href=URL.createObjectURL(a);const s=new Date().toISOString().replace(/[-T:]/g,"").slice(0,14);n.download=(c.lastTitle||"story")+"_"+s+".txt",n.click()}),c.apiKey?(l("banner").classList.add("locked"),l("key-save").classList.add("hidden"),l("key-edit").classList.remove("hidden")):(l("banner").classList.remove("locked"),l("key-save").classList.remove("hidden"),l("key-edit").classList.add("hidden")),$e(),He(),ae({catId:"theme-cat-chips",subId:"theme-sub-chips",customId:"theme-custom",clearId:"theme-custom-clear",headerRndId:"btn-rand-theme",customRndId:"theme-custom-rnd",categories:it,originals:null,stateKey:"themeSelected",stateCatKey:"themeCategory"}),ae({catId:"genre-cat-chips",subId:"genre-sub-chips",customId:"genre-custom",clearId:"genre-custom-clear",headerRndId:"btn-rand-genre",customRndId:"genre-custom-rnd",categories:ot,originals:mt,stateKey:"genre",stateCatKey:"genreCategory"}),ae({catId:"worldview-cat-chips",subId:"worldview-sub-chips",customId:"worldview-custom",clearId:"worldview-custom-clear",headerRndId:"btn-rand-worldview",customRndId:"worldview-custom-rnd",categories:ct,originals:bt,stateKey:"worldview",stateCatKey:"worldviewCategory"}),ae({catId:"target-cat-chips",subId:"target-sub-chips",customId:"target-custom",clearId:"target-custom-clear",headerRndId:"btn-rand-target",customRndId:"target-custom-rnd",categories:lt,originals:Et,stateKey:"target",stateCatKey:"targetCategory"}),ae({catId:"era-cat-chips",subId:"era-sub-chips",customId:"era-custom",clearId:"era-custom-clear",headerRndId:"btn-rand-era",customRndId:"era-custom-rnd",categories:dt,originals:gt,stateKey:"era",stateCatKey:"eraCategory"}),ae({catId:"ending-cat-chips",subId:"ending-sub-chips",customId:"ending-custom",clearId:"ending-custom-clear",headerRndId:"btn-rand-ending",customRndId:"ending-custom-rnd",categories:ut,originals:vt,stateKey:"ending",stateCatKey:"endingCategory"}),ae({catId:"narr-cat-chips",subId:"narr-sub-chips",customId:"narr-custom",clearId:"narr-custom-clear",headerRndId:"btn-rand-narr",customRndId:"narr-custom-rnd",categories:pt,originals:yt,stateKey:"narration",stateCatKey:"narrCategory"}),yn();const e=document.createElement("button");e.className="chip chip-ai",e.id="btn-today-news",e.title="AIが今日の主要ニュースからキーワードを自動抽出して、テーマ入力欄に設定します",e.innerHTML="📡 AI: 今日のニュース",l("theme-cat-chips").appendChild(e),e.addEventListener("click",xn),l("btn-add-char").addEventListener("click",tt),l("btn-remove-char").addEventListener("click",$n),l("btn-rand-chars-content").addEventListener("click",nt),l("btn-rand-chars-all").addEventListener("click",Tn),W(),Yt(c,W,()=>c.apiKey),pn(()=>c.apiKey,()=>{var t;return((t=l("output"))==null?void 0:t.textContent)||""}),Dn(),document.querySelectorAll(".btn-lock").forEach(t=>{t.addEventListener("click",a=>{a.preventDefault(),a.stopPropagation();const n=t.dataset.section;n&&c.locked.hasOwnProperty(n)&&(c.locked[n]=!c.locked[n],et(n))})})}document.addEventListener("DOMContentLoaded",Bn);
