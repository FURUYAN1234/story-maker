...
[各モデルのエラー詳細]
${o.join(`
`)}`,new Error(b)}async function Xe(e,t,a,n,s={}){if(e.trim().startsWith("sk-"))return xt(e.trim(),a,n,s);const r=["gemini-3.5-flash","gemini-2.5-flash","gemini-2.5-pro","gemini-flash-latest","gemini-pro-latest"],i=new Set([t,...r,...ie.map(y=>y.value)]),o=Array.from(i),d=[];let p=!1,u=!1,h=!1;for(const y of o)try{return y!==t&&n&&n(y),{text:await It(e,y,a,s),usedModel:y}}catch(f){const v=f.message||"";console.warn(`Model ${y} failed:`,v),d.push(`${y}: ${v}`);const m=v.toLowerCase();(m.includes("safety")||m.includes("prohibited")||m.includes("block"))&&(p=!0),(m.includes("quota")||m.includes("429")||m.includes("limit"))&&(u=!0),(m.includes("api key")||m.includes("403")||m.includes("invalid"))&&(h=!0);continue}console.log("All models failed. Running diagnosis...");const b=await be(e);console.error("DIAGNOSIS RESULT:",b);let g=`全モデル接続失敗: ${b}
...
`;D+=`[進捗] 本文をリライト中...
`,D+=`・現在文字数: ${$} 文字
`;const Y=Math.floor($/50%4),le=".".repeat(Y)+" ".repeat(3-Y);D+=`・ステータス: 執筆処理中${le}
...
・ステータス: 完了`,u="",y(),s.scrollIntoView({behavior:"smooth",block:"start"})}catch(f){b&&(clearInterval(b),b=null),u="",y(),r.textContent=`リライトエラー: ${f.message}`}finally{n.disabled=!1,n.innerHTML="🎨 この作風でリライト実行",Je()}}function un(){if(!z)return;const e=_("sa-result").textContent;navigator.clipboard.writeText(e).then(()=>{const t=_("btn-sa-copy");t.textContent="✅ コピー完了",setTimeout(()=>t.textContent="📋 コピー",2e3)})}function et(){return new Date().toISOString().replace(/[-T:]/g,"").slice(0,14)}function pn(){if(!z)return;const e=JSON.stringify(z,null,2),t=new Blob([e],{type:"application/json"}),a=document.createElement("a");a.href=URL.createObjectURL(t);const n=(z.style_name||"style_analysis").replace(/[\s\/\\:*?"<>|]/g,"_");a.download=`${n}_${et()}.json`,a.click()}function fn(){pe&&navigator.clipboard.writeText(pe).then(()=>{const e=_("btn-sa-reflect-copy");e.textContent="✅ コピー完了",setTimeout(()=>e.textContent="📋 コピー",2e3)})}function hn(){if(!pe)return;const e=new Blob([pe],{type:"text/plain"}),t=document.createElement("a");t.href=URL.createObjectURL(e),t.download=`style_rewrite_${et()}.txt`,t.click()}function mn(){var t,a,n,s;B.forEach(r=>{r.previewUrl&&URL.revokeObjectURL(r.previewUrl)}),q=[],B=[],z=null,pe="",Ee(),He();const e=_("sa-direct-text");e&&(e.value=""),ve(),_("sa-dropzone").classList.remove("sa-has-files"),(t=_("sa-file-count"))==null||t.classList.add("hidden"),J(),ue(),_("sa-result").textContent="",(a=_("sa-result-wrap"))==null||a.classList.add("hidden"),(n=_("sa-reflect-wrap"))==null||n.classList.add("hidden"),(s=_("sa-reflect-result-wrap"))==null||s.classList.add("hidden")}function gn(){const e=_("sa-direct-text");if(!e)return;const t=e.value.trim();t&&(q.push({name:`直接入力テキスト_${q.length+1}`,text:t,charCount:t.length}),e.value="",Ee(),_("sa-dropzone").classList.add("sa-has-files"),J(),ve())}function ve(){const e=_("btn-sa-add-text");if(!e)return;const t=_("sa-direct-text"),a=t&&t.value.trim().length>0;e.disabled=!a}function _e(){const e=_("sa-section");if(!e)return;(typeof oe=="function"?oe():"")?e.classList.remove("sa-inactive"):e.classList.add("sa-inactive")}function J(){const e=_("btn-sa-analyze");if(!e)return;const t=typeof oe=="function"?oe():"",a=q.length>0,n=B.length>0,s=_("sa-direct-text"),r=s&&s.value.trim().length>0,i=a||n||r;e.disabled=!(t&&i)}function ue(){const e=_("btn-sa-reflect");if(!e)return;const t=typeof ye=="function"?ye():"",a=_("output"),n=t&&t.length>=10&&a&&!a.classList.contains("empty"),s=z!==null;e.disabled=!(n&&s)}function yn(e,t){var n,s,r,i,o,d,p,u;oe=e,ye=t,Jt(),(n=_("btn-sa-analyze"))==null||n.addEventListener("click",ln),(s=_("btn-sa-reflect"))==null||s.addEventListener("click",dn),(r=_("btn-sa-copy"))==null||r.addEventListener("click",un),(i=_("btn-sa-json"))==null||i.addEventListener("click",pn),(o=_("btn-sa-reflect-copy"))==null||o.addEventListener("click",fn),(d=_("btn-sa-reflect-dl"))==null||d.addEventListener("click",hn),(p=_("btn-sa-clear"))==null||p.addEventListener("click",mn),(u=_("btn-sa-add-text"))==null||u.addEventListener("click",gn);const a=_("sa-direct-text");a&&a.addEventListener("input",()=>{J(),ve()}),_e(),ve()}const vn="3.5.0",c=e=>document.getElementById(e),N=e=>e&&e.length?e[Math.floor(Math.random()*e.length)]:null,R=e=>(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),l={apiKey:"",apiProvider:"gemini",geminiKey:"",openaiKey:"",mode:"4koma",genre:null,genreCategory:null,era:null,eraCategory:null,ending:null,endingCategory:null,narration:null,narrCategory:null,worldview:null,worldviewCategory:null,target:null,targetCategory:null,themeCategory:null,themeSelected:null,characters:[],charIdCounter:0,lastTitle:"",universalAssets:[],locked:{mode:!1,theme:!1,chars:!1,genre:!1,worldview:!1,target:!1,era:!1,ending:!1,narr:!1,supplement:!1,universal:!1}};function tt(e){const t=l.locked[e],a=document.querySelector(`.btn-lock[data-section="${e}"]`);a&&(a.textContent=t?"🔒":"🔓",a.classList.toggle("locked",t),a.title=t?"この項目のロックを解除する":"この項目をロックしてランダム変更から保護");let n=c(`section-${e}`);!n&&e==="universal"&&(n=c("section-universal-intake")),n&&(n.classList.toggle("is-locked",t),n.querySelectorAll("input, textarea, select, button:not(.btn-lock)").forEach(s=>{s.disabled=t})),e==="chars"&&W()}function bn(){const e=c("btn-switch-api");e.classList.remove("gemini-mode","openai-mode"),l.apiProvider==="gemini"?(e.classList.add("gemini-mode"),e.title="現在の設定内容は保持したまま、ChatGPT APIに切り替えます（現在: Gemini）"):(e.classList.add("openai-mode"),e.title="現在の設定内容は保持したまま、Gemini APIに切り替えます（現在: ChatGPT）")}function $e(){const e=c("banner"),t=document.querySelector(".settings-panel"),a=c("engine-label"),n=c("apikey");l.apiKey?(e.classList.add("ok"),n.value="********",n.readOnly=!0,t&&t.classList.remove("disabled-panel"),a.classList.remove("not-set"),l.apiProvider==="openai"?(a.textContent="ChatGPT API",a.style.color="var(--openai)",a.style.backgroundColor="var(--openai-glow)",a.style.borderColor="rgba(16,163,127,.3)"):(a.textContent="Gemini API",a.style.color="",a.style.backgroundColor="",a.style.borderColor="")):(e.classList.remove("ok"),n.value="",n.readOnly=!1,t&&t.classList.add("disabled-panel"),a.textContent="⚠ API未設定",a.classList.add("not-set"),a.style.color="",a.style.backgroundColor="",a.style.borderColor=""),l.apiProvider==="openai"?n.placeholder="OpenAI APIキーを入力（sk-...）":n.placeholder="Gemini APIキーを入力",bn()}function En(){l.apiProvider==="gemini"?(l.geminiKey=l.apiKey,l.apiProvider="openai",l.apiKey=l.openaiKey):(l.openaiKey=l.apiKey,l.apiProvider="gemini",l.apiKey=l.geminiKey);const e=c("banner");l.apiKey?(e.classList.add("locked"),c("key-save").classList.add("hidden"),c("key-edit").classList.remove("hidden")):(e.classList.remove("locked"),c("key-save").classList.remove("hidden"),c("key-edit").classList.add("hidden"),c("apikey").readOnly=!1,c("apikey").value=""),$e(),e.classList.remove("banner-switch-flash"),e.offsetWidth,e.classList.add("banner-switch-flash"),l.apiKey||c("apikey").focus(),J(),_e()}function _n(){const e=c("apikey").value.trim();if(!e){alert("APIキーを入力してください");return}const t=e.startsWith("sk-");t&&l.apiProvider==="gemini"?l.apiProvider="openai":!t&&l.apiProvider==="openai"&&(l.apiProvider="gemini"),l.apiKey=e,l.apiProvider==="openai"?l.openaiKey=e:l.geminiKey=e,$e(),c("banner").classList.add("locked"),c("key-save").classList.add("hidden"),c("key-edit").classList.remove("hidden"),J(),_e()}function $n(){c("banner").classList.remove("locked"),c("key-save").classList.remove("hidden"),c("key-edit").classList.add("hidden"),c("apikey").readOnly=!1,c("apikey").value="",c("apikey").focus(),l.apiKey="",l.apiProvider==="openai"?l.openaiKey="":l.geminiKey="",$e(),J(),_e()}function P(e,t){const a=c(e);a&&a.classList.toggle("hidden",!t)}function xe(e,t,a,n,s){const r=c(e);r&&(r.innerHTML=t.map(i=>`<button class="chip sub-chip" data-v="${R(i)}">${R(i)}</button>`).join(""),r.querySelectorAll(".chip").forEach(i=>{i.addEventListener("click",()=>{r.querySelectorAll(".chip").forEach(o=>o.classList.remove("active")),i.classList.add("active"),l[a]=i.dataset.v,c(n).value=i.dataset.v,P(s,i.dataset.v)})}))}function re({catId:e,subId:t,customId:a,clearId:n,headerRndId:s,customRndId:r,categories:i,originals:o,stateKey:d,stateCatKey:p}){var b,g,y,f;const u=d==="themeSelected"?"theme":d==="narration"?"narr":d,h=c(e);if(h&&i){h.innerHTML=Object.keys(i).map(m=>`<button class="chip cat-chip" data-cat="${R(m)}">${R(m)}</button>`).join(""),h.querySelectorAll(".chip").forEach(m=>{m.addEventListener("click",()=>{l.locked[u]||(h.querySelectorAll(".chip").forEach(E=>E.classList.remove("active")),m.classList.add("active"),l[p]=m.dataset.cat,l[d]=null,xe(t,i[m.dataset.cat],d,a,n),c(a).value="",P(n,""))})});const v=Object.keys(i)[0];if(v){const m=h.querySelector(".chip");m&&m.classList.add("active"),xe(t,i[v],d,a,n)}}(b=c(s))==null||b.addEventListener("click",()=>{if(l.locked[u]||!i)return;const v=Object.keys(i),m=N(v);l[p]=m,h&&h.querySelectorAll(".chip").forEach(A=>A.classList.toggle("active",A.dataset.cat===m));const E=i[m],L=N(E);l[d]=L,xe(t,E,d,a,n),c(t).querySelectorAll(".chip").forEach(A=>A.classList.toggle("active",A.dataset.v===L)),c(a).value=L,P(n,L)}),(g=c(r))==null||g.addEventListener("click",()=>{if(l.locked[u])return;let v;d==="themeSelected"?v=jt():v=N(o),v&&(c(a).value=v,h&&h.querySelectorAll(".chip").forEach(m=>m.classList.remove("active")),c(t).innerHTML="",l[p]=null,l[d]=null,P(n,v))}),(y=c(n))==null||y.addEventListener("click",()=>{l.locked[u]||(c(a).value="",P(n,""))}),(f=c(a))==null||f.addEventListener("input",()=>{if(l.locked[u])return;const v=c(a).value.trim();P(n,v),v&&(h&&h.querySelectorAll(".chip").forEach(m=>m.classList.remove("active")),c(t).innerHTML="",l[p]=null,l[d]=null)})}function Ln(){document.querySelectorAll(".btn-section-clear").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.section;if(t&&l.locked[t])return;if(t==="chars"){An();return}if(t==="mode"){c("mode-custom").value="",l.mode="4koma",c("mode-chips").querySelectorAll(".chip").forEach(d=>d.classList.remove("active")),P("mode-custom-clear","");return}const a=`${t}-custom`,n=`${t}-custom-clear`,s=`${t}-cat-chips`,r=`${t}-sub-chips`;c(a)&&(c(a).value=""),P(n,""),c(s)&&c(s).querySelectorAll(".chip").forEach(d=>d.classList.remove("active")),c(r)&&(c(r).innerHTML="");const o={theme:{key:"themeSelected",cat:"themeCategory"},genre:{key:"genre",cat:"genreCategory"},worldview:{key:"worldview",cat:"worldviewCategory"},target:{key:"target",cat:"targetCategory"},era:{key:"era",cat:"eraCategory"},ending:{key:"ending",cat:"endingCategory"},narr:{key:"narration",cat:"narrCategory"}}[t];o&&(l[o.key]=null,l[o.cat]=null),t==="supplement"&&(c("supplement").value="",P("supplement-clear",""))})})}function Ue(){const e=c("mode-chips");e.innerHTML=ke.map(t=>`<button class="chip${l.mode===t.value?" active":""}" data-v="${t.value}">${t.label}</button>`).join(""),e.querySelectorAll(".chip").forEach(t=>{t.addEventListener("click",()=>{l.locked.mode||(e.querySelectorAll(".chip").forEach(a=>a.classList.remove("active")),t.classList.add("active"),l.mode=t.dataset.v,c("mode-custom").value=t.textContent,P("mode-custom-clear",t.textContent),Te(l.mode))})}),c("btn-rand-mode").addEventListener("click",()=>{if(l.locked.mode)return;const t=N(ke);l.mode=t.value,e.querySelectorAll(".chip").forEach(a=>a.classList.toggle("active",a.dataset.v===t.value)),c("mode-custom").value=t.label,P("mode-custom-clear",t.label),Te(l.mode)}),c("mode-custom-rnd").addEventListener("click",()=>{if(l.locked.mode)return;const t=N(mt);c("mode-custom").value=t,l.mode=null,e.querySelectorAll(".chip").forEach(a=>a.classList.remove("active")),P("mode-custom-clear",t)}),c("mode-custom").addEventListener("input",()=>{if(l.locked.mode)return;const t=c("mode-custom").value.trim();P("mode-custom-clear",t),t&&(e.querySelectorAll(".chip").forEach(a=>a.classList.remove("active")),l.mode=null,Te(null))}),c("charcount-check").addEventListener("change",()=>{l.locked.mode||c("charcount-wrap").classList.toggle("hidden",!c("charcount-check").checked)}),c("char-count").addEventListener("input",t=>{if(l.locked.mode)return;const a=parseInt(t.target.max)||6e3;parseInt(t.target.value)>a&&(t.target.value=a)})}function Te(e){const t=c("char-count"),a=c("charcount-hint");!t||!a||(e==="long"?(t.max="300000",t.step="10000",t.value="100000",a.textContent="※長編モードでは、長編小説をAIに各章ごと分割執筆させるための『専用指示書』を生成します。",a.style.color="#4caf50"):(t.max="4000",t.step="500",parseInt(t.value)>4e3&&(t.value="2000"),a.textContent="※直接生成で途切れない安全な文字数は約4,000字までです",a.style.color="#aaa"))}function An(){l.characters=[],W()}function W(){c("char-count-display").textContent=l.characters.length;const e=c("char-list"),t=l.locked&&l.locked.chars,a=`<datalist id="roles-list">${te.map(r=>`<option value="${r}"></option>`).join("")}</datalist>`,n=`<datalist id="personalities-list">${ne.map(r=>`<option value="${r}"></option>`).join("")}</datalist>`,s='<datalist id="sex-list"><option value="男性"></option><option value="女性"></option><option value="無性"></option><option value="回答無し"></option></datalist>';e.innerHTML=l.characters.map((r,i)=>`
  ...
  `,e.querySelectorAll(".char-name-input").forEach(r=>r.addEventListener("input",i=>{const o=parseInt(i.target.dataset.idx);l.characters[o].name=i.target.value,Re(o,"name")})),e.querySelectorAll(".char-sel").forEach(r=>r.addEventListener("input",i=>{const o=parseInt(i.target.dataset.idx);l.characters[o][i.target.dataset.key]=i.target.value,i.target.dataset.key==="sex"&&Re(o,"sex")})),e.querySelectorAll(".char-memo").forEach(r=>r.addEventListener("input",i=>{const o=parseInt(i.target.dataset.idx);l.characters[o].note=i.target.value})),e.querySelectorAll(".btn-field-rnd").forEach(r=>r.addEventListener("click",i=>xn(parseInt(r.dataset.idx),r.dataset.key))),e.querySelectorAll(".btn-field-clear").forEach(r=>r.addEventListener("click",i=>Tn(parseInt(r.dataset.idx),r.dataset.key))),e.querySelectorAll(".btn-char-rnd-all").forEach(r=>r.addEventListener("click",i=>De(parseInt(r.dataset.idx)))),e.querySelectorAll(".btn-char-del").forEach(r=>r.addEventListener("click",i=>In(parseInt(r.dataset.idx))))}function nt(){l.locked.chars||(l.characters.push({name:"",role:"",personality:"",sex:"",note:""}),W())}function In(e){l.locked.chars||(l.characters.splice(e,1),W())}function wn(){l.locked.chars||(l.characters.pop(),W())}function xn(e,t){if(l.locked.chars)return;const a=l.characters[e],n=Oe(a.sex)||Me(a.name)||(Math.random()<.5?"M":"F");if(t==="name"){const s=n==="M"?Pe:n==="F"?Ge:ht;a.name=N(Ne)+N(s)}if(t==="sex"){a.sex=N(["男性","女性","無性","回答無し"]),Re(e,"sex");return}if(t==="role"&&(a.role=N(te)),t==="personality"&&(a.personality=N(ne)),t==="note"){const s=n==="M"?ze:Ye;a.note=N(s)}W()}function Tn(e,t){l.locked.chars||(l.characters[e][t]="",W())}function De(e){if(l.locked.chars)return;const t=Math.random()<.5?"M":"F",a=t==="M"?Pe:Ge,n=t==="M"?ze:Ye;l.characters[e]={name:N(Ne)+N(a),role:N(te),personality:N(ne),sex:t==="M"?"男性":"女性",note:N(n)},W()}const Sn=["郎","太","介","彦","夫","馬","輝","人","也","斗","志","樹","大","助"],kn=["子","美","奈","香","音","菜","花","依","梨","沙","里","愛","彩"];function Me(e){if(!e)return null;const t=e.slice(-1);return Sn.includes(t)?"M":kn.includes(t)?"F":null}function Oe(e){return e?e.includes("男性")||e.includes("男,")?"M":e.includes("女性")||e.includes("女,")?"F":null:null}function Re(e,t){const a=l.characters[e];if(t==="name"){const n=Me(a.name),s=Oe(a.sex);n&&n!==s&&(a.sex=n==="M"?"男性":"女性",W())}else if(t==="sex"){const n=Oe(a.sex),s=Me(a.name);if(n&&n!==s){const r=n==="M"?Pe:Ge;a.name=N(Ne)+N(r),W()}}}function at(){l.locked.chars||(l.characters.length===0&&nt(),l.characters.forEach((e,t)=>De(t)))}function Cn(){if(l.locked.chars)return;const e=Math.floor(Math.random()*4)+1;l.characters=[];for(let t=0;t<e;t++)l.characters.push({name:"",role:"",personality:"",sex:"",note:""}),De(t)}async function Mn(){if(l.locked.theme)return;const e=l.apiKey;if(!e){alert("APIキーを設定してください（ニュースの取得にAIを使用します）");return}const t=c("btn-today-news"),a=t.innerHTML;t.disabled=!0,t.innerHTML='<span class="spinner"></span>取得中...';const n=c("global-alert");n&&(n.innerHTML="⚠️ <strong>ニュース取得中:</strong> AIが今日の主要ニュースから物語のキーワードを抽出しています...",n.style.display="flex");try{const s=ie[0].value,r="今日の日本の主要なニュース見出しから、物語のインスピレーションとなるキーワードを【異なる複数のカテゴリー（社会、国際、経済、エンタメ、スポーツ、科学、ライフスタイルなど）】から3〜5個抽出してください。特定のカテゴリー（特に「IT・生成AI」など）に偏りすぎないよう、バランスよく分散させて抽出すること。解説は一切不要。キーワードのみを「・」で始まる箇書きで出力してください。",{text:i}=await Xe(e,s,r),o=i.replace(/^[*-]\s*/gm,"").replace(/\n/g,", ").trim(),d=c("theme-custom").value.trim(),p=d?`${d}, ${o}`:o;c("theme-custom").value=p,l.themeSelected=null,l.themeCategory=null,c("theme-cat-chips")&&c("theme-cat-chips").querySelectorAll(".chip").forEach(u=>u.classList.remove("active")),c("theme-sub-chips").innerHTML="",P("theme-custom-clear",p)}catch(s){alert("ニュース取得失敗: "+s.message)}finally{t.disabled=!1,t.innerHTML=a,n&&(n.style.display="none")}}function On(){return{mode:l.mode||"",modeCustom:c("mode-custom").value.trim(),theme:l.themeSelected||"",themeCustom:c("theme-custom").value.trim(),characters:l.characters,genre:l.genre||"",genreCustom:c("genre-custom").value.trim(),worldview:l.worldview||"",worldviewCustom:c("worldview-custom").value.trim(),target:l.target||"",targetCustom:c("target-custom").value.trim(),era:l.era||"",eraCustom:c("era-custom").value.trim(),ending:l.ending||"",endingCustom:c("ending-custom").value.trim(),narration:l.narration||"",narrCustom:c("narr-custom").value.trim(),charCount:c("charcount-check").checked&&parseInt(c("char-count").value)||null,supplement:c("supplement").value.trim(),universalAssets:l.universalAssets||[]}}function Se(e){const t=/<thought[^>]*>/i,a=/<\/thought[^>]*>/i,n=e.match(t),s=e.match(a);let r="",i="",o=!0;if(n){const d=n.index,p=n[0].length;if(s){const u=s.index,h=s[0].length;r=e.slice(d+p,u),i=e.slice(u+h),o=!1}else r=e.slice(d+p),i="",o=!0}else{const d=["topic:","logline:","location:","outfit:","punchline:","scenario:","タイトル:"];let p=-1;for(const u of d){let h;const b=u.replace(":","").trim();h=new RegExp(`(?:^|\\n)\\s*${b}\\s*[:：]`,"i");const g=e.match(h);if(g){const y=g.index+(g[0].startsWith(`
`)?1:0);(p===-1||y<p)&&(p=y)}}if(p!==-1)r=e.slice(0,p),i=e.slice(p),o=!1;else{const u="<thought>",h=e.toLowerCase();e.length>0&&u.startsWith(h)?(r="",i="",o=!0):(r="",i=e,o=!1)}}return{thought:r,story:i,isThinking:o}}async function Rn(){var me;const e=l.apiKey;if(!e){alert("APIキーを保存してください"),c("apikey").focus();return}const t=c("btn-generate"),a=c("output"),n=c("tag-row"),s=c("char-counter"),r=c("output-panel");r&&(r.scrollTop=0),t.disabled=!0,t.innerHTML='<span class="spinner"></span>構築中...',c("settings").classList.add("generating");const i=c("sa-section");i&&i.classList.add("generating");const o=c("global-alert"),d=c("progress-log"),p=c("thought-score-board"),u=c("progress-title-text");d&&(d.textContent="AIの生成開始を待っています..."),p&&(p.innerHTML="",p.style.display="none"),u&&(u.textContent="AI進捗・思考ログ: 待機中");function h(I){if(!I)return{plotRecovery:null,structure:null,constraint:null};let U=null;const w=I.match(/伏線回収度\s*[:：]\s*(\d+)/);w&&(U=parseInt(w[1]));let x=null;const V=I.match(/起承転結の構造\s*[:：]\s*(\d+)/);V&&(x=parseInt(V[1]));let Z=null;const ce=I.match(/制約遵守度\s*[:：]\s*(\d+)/);return ce&&(Z=parseInt(ce[1])),{plotRecovery:U,structure:x,constraint:Z}}function b(I,U=!1){const w=c("thought-score-board");if(!w)return;const{plotRecovery:x,structure:V,constraint:Z}=I;if(!U){w.style.display="none";return}if(x===null&&V===null&&Z===null){w.style.display="none";return}w.style.display="flex";const ce=[{label:"伏線回収度",val:x,target:85},{label:"起承転結の構造",val:V,target:85},{label:"制約遵守度",val:Z,target:90}];w.innerHTML=ce.map(K=>{const G=K.val!==null?`${K.val}点`:"測定中...",Q=K.val!==null?`${K.val}%`:"0%",X=K.val!==null&&K.val>=K.target,Le=X?"passed":"",Ae=K.val!==null?X?"(合格)":"(不合格)":"";return`
...
`).replace(/^\n+/,"")),Q&&(Q=Q.replace(/^[【\[「『《〈]+/,"").replace(/[】\]」』》〉]+$/,"").trim()),l.lastTitle=Q,a.className="output-box text-selectable";const Le=(Q?"【"+Q+`】
