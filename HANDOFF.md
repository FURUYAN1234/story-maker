...
## Snapshot Date
2026-06-04T13:53:48+09:00

## Current Status
- Version: `v4.0.9`
- Branch: `main`
- Current task: v4.0.9 fixes Gemini API error classification so model/request failures are not falsely shown as an invalid API key, and removes stale `gemini-3.5-flash` fallback candidates.
- Development port: `http://localhost:5179/`
- Deployment/backups: v4.0.9 was deployed to GitHub Pages and verified live. Visible-window PS1 full backup completed: `backups\antigravity_full_backup_2026-06-04_141301.zip`.
