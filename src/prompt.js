...
7. 文体の緩急：物語全体を通じて同じトーン・テンポで書き続けないこと。主人公の心理状態の変化に応じて、文体自体にも変化を持たせること（例：焦燥時は短文の連続、回想時はゆったりとした長文、決断時は力強い断言調など）。特に物語の最大の衝撃・転換点（真相の判明、裏切りの発覚、喪失の瞬間など）では、「息を飲んだ」の一文で処理せず、主人公の思考の断片化・身体反応・時間感覚の歪みなどを通じて、読者にも衝撃を追体験させること。`;
  } else if (baseMode === '4koma') {
    // Tier 2: 4コマ — ライト伏線（フリとオチ）
    return `5. 「起」で何気なく出した要素が「結」のオチに繋がる「フリとオチ」の構造を意識すること。ただし壮大な伏線や重厚な構成は不要で、テンポとオチの切れ味を最優先すること。`;
