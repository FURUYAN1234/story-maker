...
// ─── キャラクターデータ ─────────────────────
export const ROLES = ['主人公', 'ライバル', '相棒', 'ヒロイン', '悪役', '師匠', 'モブ', '謎の人物', '語り部', 'トリックスター'];
export const PERSONALITIES = ['熱血', '冷静沈着', 'ツンデレ', 'お人好し', 'ミステリアス', '臆病', '自信家', 'のんびり屋', '毒舌家', '天然'];
...
export const GIVEN_NAMES_M = ['翔', '健太', '拓海', '大輝', '蓮', '奏太', '颯太', '琉生', '陽向', '悠真'];
export const GIVEN_NAMES_F = ['結衣', '陽葵', '凛', '芽依', '愛菜', '美月', '紬', '澪', '栞奈', '優奈'];
export const GIVEN_NAMES_U = ['光', '葵', '凛', '渚', '空', '悠', '怜', '真尋'];
...
// --- オリジナルリスト (🎲 生成用) ---
export const MODE_ORIGINALS = ['超短編', '連載小説風', '実況台本', '手紙形式', '日記形式', 'インタビュー記事風', 'ラジオドラマ', '絵本のテキスト'];
export const GENRE_ORIGINALS = ['宇宙SFサスペンス', '異世界グルメ紀行', '日常系ホラー', 'タイムループ恋愛', '動物視点のヒューマンドラマ', 'デスゲーム', '職業モノ'];
export const ERA_ORIGINALS = ['ネオ江戸時代', '氷河期の未来', '恐竜時代', 'スチームパンク産業革命', 'バブル期の日本', '2100年のAI社会'];
export const ENDING_ORIGINALS = ['どんでん返し', '夢オチ', '続く...', '走馬灯エンド', '因果応報', '世界線変更', '記憶喪失オチ'];
export const NARR_ORIGINALS = ['読者に語りかける', '動物の視点', '死者の独白', 'AI視点', 'ラジオDJ風', '法廷の証人風'];
export const WORLDVIEW_ORIGINALS = ['浮遊島', '海底都市', '鏡の中の世界', '巨大樹の上の文明', '時間が逆流する世界', '夢と現実が混ざる世界'];
export const TARGET_ORIGINALS = ['猫好き向け', '徹夜明けの人向け', '電車通勤の30分で読める', 'お風呂で読む用', '寝る前の一話'];
export const PERSONALITY_ORIGINALS = ['多重人格', '感情がない', '嘘がつけない', '記憶を失い続ける', '未来が見える'];
export const ROLE_ORIGINALS = ['伝説の武器', '喋る馬', '守護霊', '影のフィクサー', '時空の番人'];
export const DETAIL_ORIGINALS = ['実は宇宙人', '未来から来た自分', '前世の記憶がある', '人間に化けた妖怪', '実は主人公の血縁者'];
