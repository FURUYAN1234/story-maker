...
function normalizeLongNovelChapterTitleForHeader(e,t){return String(e||"").replace(/^[#\uff03]?\s*\u7b2c[\d\uff10-\uff19\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341]+\u7ae0[:\uff1a]?\s*/,"").replace(/\s+/g," ").trim()||"\u7b2c"+t+"\u7ae0"}
function buildLongNovelOutlineFromChapters(e,t,a={},n=""){const r=Math.max(1,Number(t)||((e||[]).length||10)),o=buildLongNovelFallbackOutline(r,a,n).split("\n"),s=new Set;return Array.from({length:r},(i,c)=>{let d=e&&e[c]?normalizeLongNovelChapterTitleForHeader(e[c].title,c+1):"";d&&s.has(d)&&(d="");d&&s.add(d);return"\u7b2c"+(c+1)+"\u7ae0: "+(d||o[c].replace(/^\u7b2c\d+\u7ae0[:\uff1a]\s*/,""))}).join("\n")}
