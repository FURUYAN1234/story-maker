...
`))}),x+=A);const O=Jn(e);O&&(x+=O);const _=[a,s,r,o,l,v];return e.charCount&&_.push(`${e.charCount}字`),O&&_.push("📚RAG"),e.universalAssets&&e.universalAssets.length>0&&_.push(`🖼️アセット(${e.universalAssets.length})`),{prompt:x,tags:_}}const digitalDriftRe=/(?:AI|SNS|電子|電脳|ガジェット|スマホ|アプリ|ロボット|量子|仮想|VR|サイバー|ディストピア|アンドロイド|クローン|宇宙ステーション|火星|月面|巨大企業|監視システム|ネットワーク)/i,digitalAllowRe=/(?:SF|近未来|サイバー|未来|電脳|AI|量子|宇宙|ロボット|クローン)/i;function isDigitalDrift(e){return digitalDriftRe.test(String(e||""))}function allowsDigitalDrift(e){return digitalAllowRe.test(String(e||""))}function Vr(e,t=!1){const a=(e||[]).filter(n=>t||!isDigitalDrift(n));return a.length?a:e||[]}function zr(e,t=null,a=!1){if(!e)return null;let n=t&&e[t]?t:null;if(!n){const r=Object.keys(e||{});n=D(r.length?r:[])}if(!n)return null;const r=e[n]||[],s=Vr(r,a||allowsDigitalDrift(n));return[n,D(s)]}function Yn(){const t=Object.fromEntries(Object.entries(ct).filter(([a])=>!allowsDigitalDrift(a)&&!isDigitalDrift(a)));let e=zr(t,null,!1)||zr(ct,null,!1);e=e?e[1]:Xe(Vr(Pn,!1));return Math.random()<.55&&(e+=" "+Xe(jn)),Math.random()<.35&&(e+=" "+Xe(Bn)),e}function Xn(e){if(typeof e=="number"&&Number.isFinite(e))return Math.max(0,Math.round(e));const t=String(e||"").replace(/[０-９]/g,r=>String.fromCharCode(r.charCodeAt(0)-65248)).replace(/[,，]/g,"");if(!t)return 0;const a=t.match(/(\d+(?:\.\d+)?)\s*万/);if(a)return Math.round(parseFloat(a[1])*1e4);const n=t.match(/(\d{4,})/);return n?parseInt(n[1],10):0}function Ie(e){const t=(x,A)=>{const O=String(x||"").trim();return!O||["ランダム","未設定","おまかせ","AIおまかせ"].includes(O)?A:O},a=t(e.genreCustom||e.genre,"コメディ"),n=t(e.themeCustom||e.theme,"選択"),r=t(e.worldviewCustom||e.worldview,"現代日本"),s=t(e.eraCustom||e.era,"現代"),o=t(e.targetCustom||e.target,"全年齢"),l=t(e.endingCustom||e.ending,"意外な結末"),c=t(e.narrCustom||e.narration,"三人称・客観"),d=Array.isArray(e.characters)&&e.characters.length>0;let p;d?p=`【必須登場人物（ユーザー指定・作中登場ノルマ）】
...
`):"（特定の時代・世界観設定なし）"}function advancedNarrativeContract(e,t="standard"){const a=Ie(e||{}),n=t==="long"?"per chapter":"for the whole output";return "\n\n[Gen-4 quality contract / internal only]\n"+
...
"[Text]\n"+n}function parseAdvancedEval(e){let t=String(e||"").trim();const n=t.match(/\{[\s\S]*\}/);n&&(t=n[0]);const r=JSON.parse(t),s=r.scores||{},o=l=>Math.max(0,Math.min(100,Math.round(Number(s[l])||0)));return{scores:{fact_logic:o("fact_logic"),emotional_arc:o("emotional_arc"),human_noise:o("human_noise"),constraint_fit:o("constraint_fit"),prose_commercial:o("prose_commercial")},strongest_point:String(r.strongest_point||""),weakest_point:String(r.weakest_point||""),findings:Array.isArray(r.findings)?r.findings.map(l=>String(l)).filter(Boolean).slice(0,5):[],revision_hint:String(r.revision_hint||""),pass:r.pass!==!1}}function renderAdvancedEval(e){if(!e)return"";const t=e.scores||{},a=["\u3010Gen-4 AI Evaluation / \u7b2c4\u4e16\u4ee3AI\u7de8\u96c6\u8a55\u4fa1\u3011","- Fact/Logic / \u30d5\u30a1\u30af\u30c8\u30fb\u30ed\u30b8\u30c3\u30af: "+t.fact_logic,"- Emotional Arc / \u611f\u60c5\u66f2\u7dda: "+t.emotional_arc,"- Human Noise / \u4eba\u9593\u7684\u30ce\u30a4\u30ba: "+t.human_noise,"- Constraint Fit / \u6307\u5b9a\u9075\u5b88: "+t.constraint_fit,"- Commercial Prose / \u5546\u696d\u8aad\u5f8c\u611f: "+t.prose_commercial];return e.strongest_point&&a.push("- Strongest / \u5f37\u307f: "+e.strongest_point),e.weakest_point&&a.push("- Weakest / \u5f31\u70b9: "+e.weakest_point),e.revision_hint&&a.push("- Revision Hint / \u6539\u7a3f\u30d2\u30f3\u30c8: "+e.revision_hint),e.findings&&e.findings.length&&a.push("- Findings / \u6240\u898b: "+e.findings.join(" / ")),a.join("\n")}async function runAdvancedEval(e,t,a,n,r){const s=stripAppFooter(t);if(!s||s.trim().length<80)return null;n&&n("[Eval] Running Gen-4 AI editorial evaluation...");const o=await je(e,ge[0].value,advancedEvalPrompt(s,a),r,{temperature:.2,responseMimeType:"application/json",disableGoogleSearch:!0,maxTokens:4096,maxOutputTokens:4096,timeoutMs:9e4,maxModelAttempts:2});const l=parseAdvancedEval(o.text);return n&&n("[Eval] Gen-4 AI editorial evaluation completed."),l}const Ra="4.1.0",appFooterText=()=>`Generated By AI Story Maker V${Ra}`,stripAppFooter=e=>String(e||"").replace(/\n*\s*Generated\s+(?:by\s+Super\s+FURU\s+AI\s+Story\s+v|By\s+AI\s+Story\s+Maker\s+V)[0-9]+(?:\.[0-9]+)*\.?\s*$/i,"").trimEnd(),appendAppFooter=e=>`${stripAppFooter(e).trimEnd()}\n\n${appFooterText()}`.trim(),m=e=>document.getElementById(e),D=e=>e&&e.length?e[Math.floor(Math.random()*e.length)]:null,U=e=>(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),i={apiKey:"",apiProvider:"gemini",geminiKey:"",openaiKey:"",mode:"4koma",genre:null,genreCategory:null,era:null,eraCategory:null,ending:null,endingCategory:null,narration:null,narrCategory:null,worldview:null,worldviewCategory:null,target:null,targetCategory:null,themeCategory:null,themeSelected:null,characters:[],charIdCounter:0,lastTitle:"",universalAssets:[],longNovel:{active:!1,totalChapters:0,currentChapter:0,chapters:[],headerInfo:null,settings:null,usedModel:null,fullText:"",cleanText:"",memoText:"",chapterRetryCounts:{},chapterRetryNotes:{}},locked:{mode:!1,theme:!1,chars:!1,genre:!1,worldview:!1,target:!1,era:!1,ending:!1,narr:!1,supplement:!1,universal:!1},defaultFilled:{},axisSource:{}};function sanitizeApiKeyInput(e){return String(e||"").replace(/[\u200B-\u200D\uFEFF]/g,"").trim().replace(/^["'`]+|["'`]+$/g,"").replace(/\s+/g,"")}function isMaskedApiKeyValue(e){return /^\*{6,}$/.test(sanitizeApiKeyInput(e))}function apiKeySafeSummary(e,t){const raw=String(e||""),a=sanitizeApiKeyInput(e),n=a.startsWith("sk-")?"openai":"gemini",r=/[^A-Za-z0-9._-]/.test(a);return{provider:t||n,length:a.length,masked:isMaskedApiKeyValue(a),short:a.length>0&&a.length<20,empty:!a,badChars:r,sanitizedDelta:raw.length-a.length}}function validateApiKeyForSend(e,t){const a=apiKeySafeSummary(e,t);if(a.empty)return{ok:!1,message:"APIキーが未設定です。編集ボタンを押して実キーを入力してください。",summary:a};if(a.masked)return{ok:!1,message:"APIキーがマスク表示のままです。編集ボタンを押して実キーを入力し直してください。",summary:a};if(a.short)return{ok:!1,message:`APIキーが短すぎます（${a.length}文字）。実キーを入力し直してください。`,summary:a};if(a.badChars)return{ok:!1,message:"APIキーに使用できない文字が含まれています。コピー時の余分な文字を除いて入力し直してください。",summary:a};return{ok:!0,summary:a}}function safeApiKeyLog(e,t){const a=apiKeySafeSummary(e,t);return`provider=${a.provider}; length=${a.length}; masked=${a.masked}; short=${a.short}; badChars=${a.badChars}; sanitizedDelta=${a.sanitizedDelta}`}typeof window!="undefined"&&(window.storyMakerKeyDiagnostic=()=>apiKeySafeSummary(i.apiKey,i.apiProvider));function on(e){const t=i.locked[e],a=document.querySelector(`.btn-lock[data-section="${e}"]`);a&&(a.textContent=t?"🔒":"🔓",a.classList.toggle("locked",t),a.title=t?"この項目のロックを解除する":"この項目をロックしてランダム変更から保護");let n=m(`section-${e}`);!n&&e==="universal"&&(n=m("section-universal-intake")),n&&(n.classList.toggle("is-locked",t),n.querySelectorAll("input, textarea, select, button:not(.btn-lock)").forEach(r=>{r.disabled=t})),e==="chars"&&te()}function Pa(){const e=m("btn-switch-api");e.classList.remove("gemini-mode","openai-mode"),i.apiProvider==="gemini"?(e.classList.add("gemini-mode"),e.title="現在の設定内容は保持したまま、ChatGPT APIに切り替えます（現在: Gemini）"):(e.classList.add("openai-mode"),e.title="現在の設定内容は保持したまま、Gemini APIに切り替えます（現在: ChatGPT）")}function ze(){const e=m("banner"),t=document.querySelector(".settings-panel"),a=m("engine-label"),n=m("apikey");i.apiKey?(e.classList.add("ok"),n.value="********",n.readOnly=!0,t&&t.classList.remove("disabled-panel"),a.classList.remove("not-set"),i.apiProvider==="openai"?(a.textContent="ChatGPT API",a.style.color="var(--openai)",a.style.backgroundColor="var(--openai-glow)",a.style.borderColor="rgba(16,163,127,.3)"):(a.textContent="Gemini API",a.style.color="",a.style.backgroundColor="",a.style.borderColor="")):(e.classList.remove("ok"),n.value="",n.readOnly=!1,t&&t.classList.add("disabled-panel"),a.textContent="⚠ API未設定",a.classList.add("not-set"),a.style.color="",a.style.backgroundColor="",a.style.borderColor=""),i.apiProvider==="openai"?n.placeholder="OpenAI APIキーを入力（sk-...）":n.placeholder="Gemini APIキーを入力",Pa()}function ja(){i.apiProvider==="gemini"?(i.geminiKey=i.apiKey,i.apiProvider="openai",i.apiKey=i.openaiKey):(i.openaiKey=i.apiKey,i.apiProvider="gemini",i.apiKey=i.geminiKey);const e=m("banner");i.apiKey?(e.classList.add("locked"),m("key-save").classList.add("hidden"),m("key-edit").classList.remove("hidden")):(e.classList.remove("locked"),m("key-save").classList.remove("hidden"),m("key-edit").classList.add("hidden"),m("apikey").readOnly=!1,m("apikey").value=""),ze(),e.classList.remove("banner-switch-flash"),e.offsetWidth,e.classList.add("banner-switch-flash"),i.apiKey||m("apikey").focus(),pe(),Je()}async function Ba(){const e=sanitizeApiKeyInput(m("apikey").value);m("apikey").value=e;if(!e){alert("APIキーを入力してください");return}const a=validateApiKeyForSend(e,i.apiProvider);if(!a.ok){alert(a.message);return}const n=m("key-save");n&&(n.disabled=!0);try{const t=e.startsWith("sk-");if(!t){const r=await Ue(e);if(!apiDiagnosisHasModels(r)){alert("Gemini API key check failed: "+r);return}}t&&i.apiProvider==="gemini"?i.apiProvider="openai":!t&&i.apiProvider==="openai"&&(i.apiProvider="gemini"),i.apiKey=e,i.apiProvider==="openai"?i.openaiKey=e:i.geminiKey=e,ze(),m("banner").classList.add("locked"),m("key-save").classList.add("hidden"),m("key-edit").classList.remove("hidden"),pe(),Je()}finally{n&&(n.disabled=!1)}}function Ga(){m("banner").classList.remove("locked"),m("key-save").classList.remove("hidden"),m("key-edit").classList.add("hidden"),m("apikey").readOnly=!1,m("apikey").value="",m("apikey").focus(),i.apiKey="",i.apiProvider==="openai"?i.openaiKey="":i.geminiKey="",ze(),pe(),Je()}function V(e,t){const a=m(e);a&&a.classList.toggle("hidden",!t)}const ln={theme:{catId:"theme-cat-chips",subId:"theme-sub-chips",customId:"theme-custom",clearId:"theme-custom-clear",stateKey:"themeSelected",catKey:"themeCategory",categories:ct,lockKey:"theme"},genre:{catId:"genre-cat-chips",subId:"genre-sub-chips",customId:"genre-custom",clearId:"genre-custom-clear",stateKey:"genre",catKey:"genreCategory",categories:dt,lockKey:"genre"},worldview:{catId:"worldview-cat-chips",subId:"worldview-sub-chips",customId:"worldview-custom",clearId:"worldview-custom-clear",stateKey:"worldview",catKey:"worldviewCategory",categories:ut,lockKey:"worldview"},target:{catId:"target-cat-chips",subId:"target-sub-chips",customId:"target-custom",clearId:"target-custom-clear",stateKey:"target",catKey:"targetCategory",categories:pt,lockKey:"target"},era:{catId:"era-cat-chips",subId:"era-sub-chips",customId:"era-custom",clearId:"era-custom-clear",stateKey:"era",catKey:"eraCategory",categories:ht,lockKey:"era"},ending:{catId:"ending-cat-chips",subId:"ending-sub-chips",customId:"ending-custom",clearId:"ending-custom-clear",stateKey:"ending",catKey:"endingCategory",categories:mt,lockKey:"ending"},narr:{catId:"narr-cat-chips",subId:"narr-sub-chips",customId:"narr-custom",clearId:"narr-custom-clear",stateKey:"narration",catKey:"narrCategory",categories:gt,lockKey:"narr"}};function axisFromStateKey(e){return{themeSelected:"theme",genre:"genre",worldview:"worldview",target:"target",era:"era",ending:"ending",narration:"narr"}[e]||null}function setAxisSource(e,t){e&&(i.axisSource||(i.axisSource={}),t?i.axisSource[e]=t:delete i.axisSource[e])}function Ha(e){const t=axisFromStateKey(e);t&&i.defaultFilled&&delete i.defaultFilled[t]}function axisSource(e){return i.axisSource&&i.axisSource[e]||null}function axisCustomValue(e){const t=ln[e],a=t&&m(t.customId);return a&&a.value.trim()||""}function axisSelectedCategory(e){const t=ln[e];return t&&i[t.catKey]||""}function axisHasDetail(e){const t=ln[e];return!!(t&&(i[t.stateKey]||axisCustomValue(e)))}function axisFixed(e){if(i.locked[e])return!0;const t=axisSource(e);return t==="manual"||t==="selectedDetail"||t==="selectedCategory"?!0:!!((axisCustomValue(e)||axisSelectedCategory(e))&&t!=="default"&&t!=="random")}function modeFixed(){return!!(i.locked.mode||i.modeSource==="manual"||i.modeSource==="selected")}function canAxisRandomize(e){return!i.locked[e]&&!axisFixed(e)}function pickAxisDetail(e,t=null){const a=ln[e];if(!a)return null;const n=t||axisSelectedCategory(e);if(n&&a.categories&&a.categories[n]){const r=Vr(a.categories[n],allowsDigitalDrift(n));return[n,D(r)]}return zr(a.categories,null,!1)}function renderAxisValue(e,t,a){const n=ln[e];if(!n)return;const r=m(n.catId),s=m(n.subId),o=m(n.customId);i.defaultFilled&&delete i.defaultFilled[e],t&&n.categories&&n.categories[t]?(i[n.catKey]=t,i[n.stateKey]=a,r&&r.querySelectorAll(".chip").forEach(l=>l.classList.toggle("active",l.dataset.cat===t)),Pe(n.subId,n.categories[t],n.stateKey,n.customId,n.clearId),m(n.subId)&&m(n.subId).querySelectorAll(".chip").forEach(l=>l.classList.toggle("active",l.dataset.v===a))):(i[n.catKey]=null,i[n.stateKey]=null,r&&r.querySelectorAll(".chip").forEach(l=>l.classList.remove("active")),s&&(s.innerHTML="")),o&&(o.value=a||""),V(n.clearId,a)}function fillOpenDetailWithinFixedCategory(e){const t=ln[e],a=axisSelectedCategory(e);if(!t||!a||axisHasDetail(e))return!1;const n=pickAxisDetail(e,a);return!!(n&&n[1]&&(renderAxisValue(e,n[0],n[1]),setAxisSource(e,"selectedCategory"),!0))}function randomizeAxisRespectingFixed(e){if(!canAxisRandomize(e))return!1;const t=pickAxisDetail(e);return!!(t&&t[1]&&(renderAxisValue(e,t[0],t[1]),setAxisSource(e,"random"),!0))}function be(e,t=0,a=0){const n=Object.keys(e||{}),r=n[t]||n[0]||"",s=r&&e[r]||[];return[r,s[a]||s[0]||""]}function X(e={}){return{theme:be(ct,e.themeCat,e.themeVal),genre:be(dt,e.genreCat,e.genreVal),worldview:be(ut,e.worldCat,e.worldVal),target:be(pt,e.targetCat,e.targetVal),era:be(ht,e.eraCat,e.eraVal),ending:be(mt,e.endingCat,e.endingVal),narr:be(gt,e.narrCat,e.narrVal)}}const Ze=X({themeCat:0,themeVal:0,genreCat:0,genreVal:1,worldCat:0,worldVal:5,targetCat:0,targetVal:2,eraCat:0,eraVal:0,endingCat:0,endingVal:0,narrCat:1,narrVal:1}),Pt={default:Ze,"4koma":Ze,"4koma_scenario":Ze,short_short:X({themeCat:0,themeVal:6,genreCat:0,genreVal:3,worldCat:0,worldVal:5,targetCat:0,targetVal:2,eraCat:0,eraVal:0,endingCat:0,endingVal:4,narrCat:1,narrVal:1}),novel:X({themeCat:3,themeVal:1,genreCat:5,genreVal:2,worldCat:0,worldVal:1,targetCat:1,targetVal:4,eraCat:0,eraVal:0,endingCat:2,endingVal:0,narrCat:1,narrVal:2}),medium:X({themeCat:4,themeVal:8,genreCat:5,genreVal:3,worldCat:0,worldVal:1,targetCat:1,targetVal:4,eraCat:0,eraVal:0,endingCat:2,endingVal:2,narrCat:1,narrVal:2}),long:X({themeCat:3,themeVal:2,genreCat:6,genreVal:4,worldCat:0,worldVal:0,targetCat:2,targetVal:0,eraCat:0,eraVal:0,endingCat:3,endingVal:3,narrCat:1,narrVal:3}),scenario:X({themeCat:0,themeVal:2,genreCat:0,genreVal:5,worldCat:0,worldVal:4,targetCat:0,targetVal:2,eraCat:0,eraVal:0,endingCat:3,endingVal:0,narrCat:2,narrVal:5}),manga:X({themeCat:2,themeVal:3,genreCat:4,genreVal:1,worldCat:4,worldVal:0,targetCat:1,targetVal:2,eraCat:4,eraVal:0,endingCat:3,endingVal:3,narrCat:1,narrVal:3}),essay:X({themeCat:0,themeVal:3,genreCat:5,genreVal:2,worldCat:0,worldVal:0,targetCat:2,targetVal:2,eraCat:0,eraVal:0,endingCat:4,endingVal:1,narrCat:0,narrVal:1}),poem:X({themeCat:4,themeVal:6,genreCat:2,genreVal:5,worldCat:0,worldVal:0,targetCat:1,targetVal:3,eraCat:0,eraVal:0,endingCat:4,endingVal:1,narrCat:0,narrVal:1}),fairy:X({themeCat:1,themeVal:5,genreCat:5,genreVal:2,worldCat:2,worldVal:1,targetCat:0,targetVal:0,eraCat:5,eraVal:0,endingCat:0,endingVal:0,narrCat:1,narrVal:0}),letter:X({themeCat:4,themeVal:8,genreCat:2,genreVal:4,worldCat:0,worldVal:1,targetCat:2,targetVal:2,eraCat:0,eraVal:0,endingCat:2,endingVal:0,narrCat:2,narrVal:1}),diary:X({themeCat:3,themeVal:9,genreCat:6,genreVal:2,worldCat:0,worldVal:3,targetCat:1,targetVal:4,eraCat:0,eraVal:0,endingCat:3,endingVal:1,narrCat:2,narrVal:3}),documentary:X({themeCat:5,themeVal:9,genreCat:5,genreVal:5,worldCat:0,worldVal:1,targetCat:2,targetVal:4,eraCat:1,eraVal:0,endingCat:4,endingVal:1,narrCat:2,narrVal:2}),radio:X({themeCat:3,themeVal:3,genreCat:6,genreVal:6,worldCat:0,worldVal:0,targetCat:2,targetVal:1,eraCat:0,eraVal:0,endingCat:3,endingVal:0,narrCat:2,narrVal:5})};function Ka(e){const t=Ne.find(a=>a.value===e)||Ne[0];return t?t.label:""}function Va(e){const t=ln[e],a=t&&m(t.customId),n=a&&a.value.trim();return!!(t&&(i[t.stateKey]||n||i[t.catKey]))}function Fa(e,t,a={}){const n=ln[e];if(!n||i.locked[n.lockKey])return null;const r=!!(a.forceDefaultOwned&&i.defaultFilled&&i.defaultFilled[e]);if(!a.force&&!r&&Va(e))return null;const s=t&&t[0]||"",o=t&&t[1]||"",l=s&&n.categories&&n.categories[s]?s:null,c=o||l&&n.categories[l][0]||"";if(!c)return null;const d=m(n.catId),p=m(n.subId),g=m(n.customId);return l?(i[n.catKey]=l,i[n.stateKey]=c,d&&d.querySelectorAll(".chip").forEach(h=>h.classList.toggle("active",h.dataset.cat===l)),p&&(Pe(n.subId,n.categories[l],n.stateKey,n.customId,n.clearId),p.querySelectorAll(".chip").forEach(h=>h.classList.toggle("active",h.dataset.v===c)))):(i[n.catKey]=null,i[n.stateKey]=null,d&&d.querySelectorAll(".chip").forEach(h=>h.classList.remove("active")),p&&(p.innerHTML="")),g&&(g.value=c),V(n.clearId,c),i.defaultFilled||(i.defaultFilled={}),i.defaultFilled[e]=c,setAxisSource(e,"default"),e+"="+c}function _e(e=i.mode||"4koma",t={}){const a=Pt[e]||Pt.default,n=[];if(!i.locked.mode){const r=m("mode-custom"),s=Ka(e);r&&(!r.value.trim()||t.forceModeLabel)&&(r.value=s,V("mode-custom-clear",s),n.push("mode="+s),i.modeSource||(i.modeSource="default"))}if(t.includeAxes!==!1)for(const[r,s]of Object.entries(a)){const o=Fa(r,s,{forceDefaultOwned:t.forceDefaultOwned});o&&n.push(o)}return n}function Pe(e,t,a,n,r){const s=m(e);s&&(s.innerHTML=t.map(o=>`<button class="chip sub-chip" data-v="${U(o)}">${U(o)}</button>`).join(""),s.querySelectorAll(".chip").forEach(o=>{o.addEventListener("click",()=>{const l=axisFromStateKey(a);s.querySelectorAll(".chip").forEach(c=>c.classList.remove("active")),o.classList.add("active"),i[a]=o.dataset.v,Ha(a),l&&setAxisSource(l,"selectedDetail"),m(n).value=o.dataset.v,V(r,o.dataset.v)})}))}function Ce({catId:e,subId:t,customId:a,clearId:n,headerRndId:r,customRndId:s,categories:o,originals:l,stateKey:c,stateCatKey:d}){var p,g,h,v;const y=c==="themeSelected"?"theme":c==="narration"?"narr":c,u=m(e);if(u&&o){u.innerHTML=Object.keys(o).map(f=>`<button class="chip cat-chip" data-cat="${U(f)}">${U(f)}</button>`).join(""),u.querySelectorAll(".chip").forEach(f=>{f.addEventListener("click",()=>{i.locked[y]||(u.querySelectorAll(".chip").forEach($=>$.classList.remove("active")),f.classList.add("active"),i.defaultFilled&&delete i.defaultFilled[y],i[d]=f.dataset.cat,i[c]=null,setAxisSource(y,"selectedCategory"),Pe(t,o[f.dataset.cat],c,a,n),m(a).value="",V(n,""))})});const b=Object.keys(o)[0];if(b){const f=u.querySelector(".chip");f&&f.classList.add("active"),Pe(t,o[b],c,a,n)}}(p=m(r))==null||p.addEventListener("click",()=>{if(i.locked[y]||!o)return;if(fillOpenDetailWithinFixedCategory(y)||axisFixed(y))return;randomizeAxisRespectingFixed(y)}),(g=m(s))==null||g.addEventListener("click",()=>{if(i.locked[y])return;if(fillOpenDetailWithinFixedCategory(y)||axisFixed(y))return;let b;c==="themeSelected"?b=Yn():b=D(Vr(l||[],!1)),b&&(i.defaultFilled&&delete i.defaultFilled[y],m(a).value=b,u&&u.querySelectorAll(".chip").forEach(f=>f.classList.remove("active")),m(t).innerHTML="",i[d]=null,i[c]=null,setAxisSource(y,"random"),V(n,b))}),(h=m(n))==null||h.addEventListener("click",()=>{i.locked[y]||(m(a).value="",i.defaultFilled&&delete i.defaultFilled[y],!i[c]&&!i[d]&&setAxisSource(y,null),V(n,""))}),(v=m(a))==null||v.addEventListener("input",()=>{if(i.locked[y])return;const b=m(a).value.trim();i.defaultFilled&&delete i.defaultFilled[y],V(n,b),b?(u&&u.querySelectorAll(".chip").forEach(f=>f.classList.remove("active")),m(t).innerHTML="",i[d]=null,i[c]=null,setAxisSource(y,"manual")):!i[c]&&!i[d]&&setAxisSource(y,null)})}function qa(){document.querySelectorAll(".btn-section-clear").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.section;if(t&&i.locked[t])return;if(i.defaultFilled&&delete i.defaultFilled[t],t==="chars"){Ua();return}if(t==="mode"){i.mode="4koma",delete i.modeSource,m("mode-chips").querySelectorAll(".chip").forEach(l=>l.classList.toggle("active",l.dataset.v==="4koma")),m("mode-custom").value="",V("mode-custom-clear",""),_e(i.mode,{forceModeLabel:!0,includeAxes:!0,forceDefaultOwned:!0});return}const a=`${t}-custom`,n=`${t}-custom-clear`,r=`${t}-cat-chips`,s=`${t}-sub-chips`;m(a)&&(m(a).value=""),V(n,""),m(r)&&m(r).querySelectorAll(".chip").forEach(l=>l.classList.remove("active")),m(s)&&(m(s).innerHTML="");const o={theme:{key:"themeSelected",cat:"themeCategory"},genre:{key:"genre",cat:"genreCategory"},worldview:{key:"worldview",cat:"worldviewCategory"},target:{key:"target",cat:"targetCategory"},era:{key:"era",cat:"eraCategory"},ending:{key:"ending",cat:"endingCategory"},narr:{key:"narration",cat:"narrCategory"}}[t];o&&(i[o.key]=null,i[o.cat]=null,setAxisSource(t,null)),t==="supplement"&&(m("supplement").value="",V("supplement-clear",""))})})}function xt(){const e=m("mode-chips");e.innerHTML=Ne.map(t=>`<button class="chip${i.mode===t.value?" active":""}" data-v="${t.value}">${t.label}</button>`).join(""),e.querySelectorAll(".chip").forEach(t=>{t.addEventListener("click",()=>{if(i.locked.mode)return;const a=t.dataset.v==="long";if(!a&&i.longNovel&&i.longNovel.chapters&&i.longNovel.chapters.length>0)if(confirm(`長編小説データが残っています。クリアして新しい作品の準備をしますか？
...
（キャンセルすると以前のデータを保持します）`)){ke(),document.getElementById("long-novel-panel").classList.add("hidden");const n=document.getElementById("output");n&&(n.className="output-box empty",n.textContent="AIの思考を待っています...（しばらくお待ちください）")}e.querySelectorAll(".chip").forEach(n=>n.classList.remove("active")),t.classList.add("active"),i.mode=t.dataset.v,m("mode-custom").value=t.textContent,V("mode-custom-clear",t.textContent),i.modeSource="selected",_e(i.mode,{forceModeLabel:!0,includeAxes:!0,forceDefaultOwned:!0})})}),m("btn-rand-mode").addEventListener("click",()=>{if(modeFixed())return;const t=D(Ne);i.mode=t.value,e.querySelectorAll(".chip").forEach(a=>a.classList.toggle("active",a.dataset.v===t.value)),m("mode-custom").value=t.label,V("mode-custom-clear",t.label),i.modeSource="random",_e(i.mode,{forceModeLabel:!0,includeAxes:!0,forceDefaultOwned:!0})}),m("mode-custom-rnd").addEventListener("click",()=>{if(modeFixed())return;const t=D(Vr(kn,!1));m("mode-custom").value=t,i.mode=null,e.querySelectorAll(".chip").forEach(a=>a.classList.remove("active")),V("mode-custom-clear",t),i.modeSource="random"}),m("mode-custom").addEventListener("input",()=>{if(i.locked.mode)return;const t=m("mode-custom").value.trim();V("mode-custom-clear",t),t?(i.modeSource="manual",e.querySelectorAll(".chip").forEach(a=>a.classList.remove("active")),i.mode=null):delete i.modeSource}),_e(i.mode,{forceModeLabel:!0,includeAxes:!0,forceDefaultOwned:!0})}function Ua(){i.characters=[],te()}function te(){m("char-count-display").textContent=i.characters.length;const e=m("char-list"),t=i.locked&&i.locked.chars,a=`<datalist id="roles-list">${fe.map(s=>`<option value="${s}"></option>`).join("")}</datalist>`,n=`<datalist id="personalities-list">${ye.map(s=>`<option value="${s}"></option>`).join("")}</datalist>`,r='<datalist id="sex-list"><option value="男性"></option><option value="女性"></option><option value="無性"></option><option value="回答無し"></option></datalist>';e.innerHTML=i.characters.map((s,o)=>`
...
`,T+=`──────────────────────────────────────────────────
`),f&&(T+=`
`+f),p.textContent=T;const M=m("progress-content");M&&(M.scrollTop=M.scrollHeight)}g&&(g.style.display="none"),h&&(h.textContent="AI進捗・思考ログ: 構想中..."),C("[システム] アプリケーション構築を開始しました...");C("[システム] 選択・手入力済みの設定を固定。生成開始時の自動変更は行いません。");const x=er();if(C("[システム] 設定データを読み込みました。"),x.universalAssets&&x.universalAssets.length>0?C(`[システム] 入力アセット ${x.universalAssets.length} 件の事前解析コンテキストを埋め込み中...`):C("[システム] 万能インプット（アセット入力）: 空白。標準推論コンテキストを適用します。"),C("[システム] ローカルRAG（検索拡張生成）ナレッジ辞書を参照中..."),C("[システム] ストーリープロンプトのセマンティック階層を構築中..."),x.mode==="long"){if(i.longNovel&&i.longNovel.chapters&&i.longNovel.chapters.length>0&&!confirm(`前の長編小説データが残っています。クリアして一から（第1章から）書き直しますか？
（※これまでの本文は失われます）`)){n.disabled=!1,m("settings").classList.remove("generating");return}C("[システム] 長編小説モードを検出。章別生成エンジンを起動します...");try{await wn(x,n,r,s,o)}catch(T){console.error(T),r.innerHTML=`<span class="error-msg">⚠ 長編小説の初期化でエラーが発生しました: ${T.message}</span>`}finally{i.longNovel&&i.longNovel.active&&i.longNovel.currentChapter<i.longNovel.totalChapters?Vt():(m("settings").classList.remove("generating"),n.disabled=!1,n.textContent="ストーリー生成")}return}if(i.longNovel&&(((e=i.longNovel.chapters)==null?void 0:e.length)>0||i.longNovel.active)){ke();const T=document.getElementById("long-novel-panel");T&&(T.classList.add("hidden"),T.classList.remove("ln-completed","ln-generating")),Re()}const{prompt:A,tags:O}=zn(x),advancedPrompt=A+advancedNarrativeContract(x,"standard");C("[System] Gen-4 quality contract active: fact preflight, emotional arc ledger, controlled human noise.");C("[システム] プロンプトのバリデーションとトークン最適化が完了しました。"),x.mode==="4koma_scenario"?C("[システム] 出力モード: AI 4コマ シナリオ連携モード（NBP Step2パーサー互換）が有効化されました。"):C(`[システム] 出力モード: ${x.mode||"標準物語"} 向け文体テンプレートを選択しました。`),r.className="output-box empty",Ae(),r.textContent="AIの思考を待っています...（しばらくお待ちください）",d&&(d.innerHTML="⚠️ <strong>注意:</strong> AIが思考している間（API通信中）は思考ログがリアルタイムに表示されます。結果が表示されるまでお待ちください。",d.style.display="flex");let _="",E="",w="",S=!1,G=!0,j=null;function N(T){$=T,L();const M=v(T);y(M,!1)}function F(T){const M=T.length;let R="";S?R=`[システム] ネイティブ思考プロセスが完了しました。本文執筆に移行します。
...
`);e.cleanText=appendAppFooter((n+(n?`
...
`,l=r.split(/\n+/).map(h=>h.trim()).filter(h=>h.length>=40),c=l.filter(h=>h.length>950).length,d=(r.match(/[「『“"]/g)||[]).length,p=(r.match(/(?:音|匂|臭|熱|冷|湿|乾|痛|息|指|手|足|喉|胸|胃|汗|震|光|影|風|雨|床|扉|窓|紙|金属|沈黙|声|触|重|軽|暗|明)/g)||[]).length,g=(r.match(/(?:決め|選|拒|告げ|嘘|失|壊|奪|渡|捨|逃|戻れ|約束|証拠|代償|傷|秘密|裏切|疑|怒|恐|泣|変わ|できなく|許さ)/g)||[]).length,h=r.slice(-420),v=(h.match(/(?:\u5915\u65e5|\u5915\u713c\u3051|\u671d\u713c\u3051|\u831c\u8272|\u7a7a|\u661f|\u6708|\u98a8|\u5149|\u5f71|\u4f59\u97fb|\u97ff\u304d\u6e21|\u67d3\u3081|\u7167\u3089|\u5305\u3093|\u5fae\u7b11|\u80f8\u306e\u5965|\u6f84\u3093\u3060|\u6d99|\u9759\u304b\u306b)/g)||[]).length,y=/(?:[\u300c\u300e\u201c"]|\u820c\u6253\u3061|\u305f\u3081\u606f|\u8179|\u80c3|\u6c57|\u54b3|\u9774|\u9375|\u30ec\u30b7\u30fc\u30c8|\u901a\u77e5|\u76bf|\u6905\u5b50|\u30c9\u30a2|\u73fe\u5b9f|\u306a\u306e\u306b|\u305f\u3060\u3057|\u307e\u3060|\u9055\u3046|\u3046\u308b\u3055\u3044|\u6700\u60aa|\u5197\u8ac7|\u9ed9\u3063\u305f|\u6255|\u7247\u4ed8|\u5fd8\u308c|\u75db|\u81ed|\u6fe1|\u3053\u307c|\u9cf4\u3063\u305f|\u5272\u308c)/.test(h);return l.length<7&&n.push(`場面段落数が少なく、章が要約化している可能性があります（第${t}章: ${l.length}段落）`),c>=Math.max(4,Math.ceil(l.length*.45))&&n.push(`長い説明段落が多く、場面の切れ目が不足しています（第${t}章: ${c}段落）`),d<2&&g<7&&n.push(`人物の選択・対立・会話の密度が不足しています（第${t}章）`),p<8&&n.push(`五感・身体感覚・物理ディテールが不足しています（第${t}章: ${p}件）`),/(?:次章へ|続きは|幕を開け|物語はまだ|どうなるのか|to be continued)/i.test(r)&&n.push(`章末が予告・煽り文で終わっています（第${t}章）`),v>=2&&!y&&n.push(`\u7ae0\u672b\u304c\u5b9a\u578b\u7684\u306a\u60c5\u666f\u4f59\u97fb\u306b\u5bc4\u3063\u3066\u3044\u307e\u3059\uff08\u7b2c${t}\u7ae0\uff09\u3002\u6ce5\u81ed\u3044\u4e00\u8a00\u3001\u5b9f\u52d9\u3001\u8eab\u4f53\u611f\u899a\u3001\u6c88\u9ed9\u306e\u30ba\u30ec\u306a\u3069\u5177\u4f53\u7684\u306a\u30ce\u30a4\u30ba\u3067\u7740\u5730\u3092\u5d29\u3057\u3066\u304f\u3060\u3055\u3044`),n}function lt(e){return String(e||"").replace(/\r/g,"").replace(/[#＃]\s*第[\d０-９一二三四五六七八九十]+章[^\n]*/g,"").replace(/【完】/g,"").replace(/\s+/g," ").trim()}function Kt(e){const t=String(e||"").replace(/\r/g,"").split(/\n{2,}/).map(lt).filter(n=>n.length>=120&&!/^【/.test(n)),a=[];for(const n of t)a.push(n.slice(0,260)),n.length>=420&&a.push(n.slice(260,520));return[...new Set(a.filter(n=>n.length>=140))]}function Ar(e,{chapterNum:t,previousChapters:a=[]}={}){const n=[],r=Array.isArray(a)?a:[];if(!e||!r.length)return n;const s=lt(e),o=Kt(e);if(s.length<1800||o.length<2)return n;for(let l=0;l<r.length;l++){const c=r[l]||{},d=c.body||c.text||"",p=lt(d);if(p.length<1e3)continue;const g=new Set(Kt(d));let h=0,v=0;for(const b of o)g.has(b)&&(h++,v+=b.length);const y=s.slice(0,900),u=y.length>=700&&p.includes(y);if(u||h>=3&&v>=500){const b=u?"冒頭一致":`${h}箇所`;n.push(`前章以前の本文と長い重複段落が残っています（第${t}章 / 第${l+1}章: ${b}）`);break}}return n}function Pr(e,{chapterNum:t,isLast:a,totalChapters:n}={}){const r=[],s=String(e||"").trim();if(!s||a)return r;const o=Number(n)||0,l=Number(t)||0;if(!o)return r;const c=Math.max(1,Math.ceil(o*.5));if(l<c)return r;[/\u3053\u308c\u306b\u3066\u4e00\u4ef6\u843d\u7740/,/\u3059\u3079\u3066(?:\u304c|\u3001)?\u7d42\u308f/,/\u7d42\u308f\u3063\u305f(?:\u306e\u306d|\u306e\u3060|\u306e\u304b|\u308f\u3051|\u306f\u305a|\u3068\u601d)/,/(?:\u30b7\u30b9\u30c6\u30e0|\u30b0\u30e9\u30f3\u30c9\u30fb\u30ea\u30bb\u30c3\u30c8|\u8abf\u5f8b)[^\u3002\n]{0,80}(?:\u505c\u6b62|\u6b62\u307e|\u5d29\u58ca|\u6c88\u9ed9|\u6d88\u3048)/,/(?:\u4eba\u3005|\u5e02\u6c11|\u6771\u4eac)[^\u3002\n]{0,120}(?:\u601d\u3044\u51fa|\u76ee\u899a\u3081)/,/(?:\u30b3\u30a2|\u4e2d\u67a2|\u7089|\u8a18\u61b6\u88c5\u7f6e|\u5b9f\u9a13|\u8a08\u753b|\u9670\u8b00|\u30cd\u30c3\u30c8\u30ef\u30fc\u30af)[^\u3002\n]{0,120}(?:\u7834\u58ca|\u505c\u6b62|\u5d29\u58ca|\u6c88\u9ed9|\u6d88\u6ec5|\u6b62\u307e|\u7d42\u308f)/,/(?:\u6551\u6025\u8eca|\u642c\u9001|\u75c5\u5ba4|\u30d9\u30c3\u30c9|\u671d\u306e\u5149|\u9759\u304b\u306a\u671d)[^\u3002\n]{0,140}(?:\u76ee\u899a|\u8a18\u61b6|\u7d42\u308f|\u9759\u304b|\u623b)/,/\u5b8c\u5168\u52dd\u5229|\u9ed2\u5e55\u5b8c\u5168\u6557\u5317|\u4f1a\u793e\u518d\u5efa(?:\u304c|\u306f)?\u5b8c\u4e86|\u5168\u9762\u5951\u7d04/].forEach(d=>{d.test(s)&&r.push(`Whole-story resolution appears before the final chapter (${d.toString()})`)});return r}function Ve(e,t){return[...Et(e),...Ir(e,t),...wr(e,t),...Er(e,t),...Ar(e,t),...Lr(e,t),...Pr(e,t)]}function Fe(e,t){let a=ue(e),n=t||"";const r=Oe(a);return r.memo&&(n+=(n?`
...
${c}`:""}`.trim()}function Tr(e){const t=e||"",{body:a}=Oe(t);return ue(a||t).trim()}function parseVisibleSelfScores(e){if(!e)return{plotRecovery:null,structure:null,constraint:null};let t=null;const a=e.match(/\u4f0f\u7dda\u56de\u53ce\u5ea6\s*[:\uff1a]\s*(\d+)/);a&&(t=parseInt(a[1]));let n=null;const r=e.match(/\u8d77\u627f\u8ee2\u7d50\u306e\u69cb\u9020\s*[:\uff1a]\s*(\d+)/);r&&(n=parseInt(r[1]));let s=null;const o=e.match(/\u5236\u7d04\u9075\u5b88\u5ea6\s*[:\uff1a]\s*(\d+)/);return o&&(s=parseInt(o[1])),{plotRecovery:t,structure:n,constraint:s}}function renderVisibleSelfScoreBoard(e,t=!1){const a=m("thought-score-board");if(!a)return;if(!t||!e){a.innerHTML="",a.style.display="none";return}const{plotRecovery:n=null,structure:r=null,constraint:s=null}=e;if(n===null&&r===null&&s===null){a.innerHTML="",a.style.display="none";return}a.style.display="flex";const o=[{label:"\u4f0f\u7dda\u56de\u53ce\u5ea6",val:n,target:85},{label:"\u8d77\u627f\u8ee2\u7d50\u306e\u69cb\u9020",val:r,target:85},{label:"\u5236\u7d04\u9075\u5b88\u5ea6",val:s,target:90}];a.innerHTML=o.map(l=>{const c=l.val!==null?`${l.val}\u70b9`:"\u6e2c\u5b9a\u4e2d...",d=l.val!==null?`${l.val}%`:"0%",p=l.val!==null&&l.val>=l.target,g=p?"passed":"",h=l.val!==null?p?"(\u5408\u683c)":"(\u4e0d\u5408\u683c)":"";return`
        <div class="score-row ${g}">
          <div class="score-label">${l.label}</div>
          <div class="score-bar-bg"><div class="score-bar-fill" style="width: ${d}"></div></div>
          <div class="score-val">${c} ${h}</div>
        </div>
      `}).join("")}function clampVisibleScore(e){return Math.max(0,Math.min(100,Math.round(Number.isFinite(e)?e:0)))}function countVisibleMatches(e,t){const a=String(e||"").match(t);return a?a.length:0}function buildLongNovelSelfScores(e={}){const t=String(e.cleanText||""),a=Array.isArray(e.chapters)?e.chapters:[],n=Math.max(1,Number(e.totalChapters)||a.length||1),r=Math.min(1,(Number(e.currentChapter)||a.length||0)/n),s=countVisibleMatches(t,/\u3010\u5b8c\u3011/g),o=countVisibleMatches(t,/(?:^|\n)\s*#?\s*\u7b2c[\d\uff10-\uff19\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341]+\u7ae0/g),l=a.map(c=>String(c&&c.body||"").trim().length).filter(Boolean),c=l.length?l.reduce((p,g)=>p+g,0)/l.length:t.length/n,d=l.length?Math.min(...l):0,p=a.some(g=>String(g&&g.contextMemo||"").length>80),g=/\u6587\u8108\u7dad\u6301\u30e1\u30e2|\u56de\u53ce\u5f85\u3061\u4f0f\u7dda\u30e1\u30e2|\u4eba\u7269\u30ed\u30b9\u30bf\u30fc\u66f4\u65b0\u30e1\u30e2|\u30e2\u30c1\u30fc\u30d5\uff06\u30b5\u30d6\u30ad\u30e3\u30e9\u8ffd\u8de1\u30e1\u30e2|\u6b21\u7ae0\u306e\u30b7\u30fc\u30f3\u8a2d\u8a08|\u518d\u73fe\u7528\u30de\u30b9\u30bf\u30fc\u6307\u793a\u66f8|\u5168\u6587\u7d50\u5408\u51fa\u529b|```|\[REJECTION|Chapter prose looks|Regenerate/i.test(t);return{plotRecovery:clampVisibleScore(80+r*8+(s===1?5:-8)+(p?3:0)),structure:clampVisibleScore(78+r*8+(o>=n?4:0)+(c>=4500?4:0)+(d>=3000?3:0)),constraint:clampVisibleScore(86+r*5+(s===1?4:-8)+(g?-12:5))}}function J({phase:e="待機中",chapterNum:t=null,chapterChars:a=null,totalChars:n=null,extra:r="",level:s="active"}={}){const o=document.getElementById("ln-live-status");if(!o)return;const l=[e];t&&l.push(`現在: 第${t}章`),Number.isFinite(a)&&l.push(`章内 ${a.toLocaleString()}字`),Number.isFinite(n)&&l.push(`合計 ${n.toLocaleString()}字`),r&&l.push(r),l.push(`更新 ${new Date().toLocaleTimeString("ja-JP",{hour12:!1})}`),o.textContent=l.join(" / "),o.classList.remove("is-active","is-error"),s==="error"?o.classList.add("is-error"):s!=="idle"&&o.classList.add("is-active")}function _r(e,t={}){var a;if(!e||t.autoScroll===!1)return;const n=document.getElementById("output-panel");(a=n==null?void 0:n.classList)!=null&&a.contains("ln-live-preview")&&requestAnimationFrame(()=>{e.scrollTop=e.scrollHeight})}function xe(e,t,a="",n="",r={}){const s=(a||"").trim(),o=Tr(n),l=[s,o].filter(p=>p&&p.trim()).join(`
...
Pr=function(e,{chapterNum:t,isLast:a,totalChapters:n}={}){
const r=[],s=String(e||"").trim();
if(!s||a)return r;
const o=Number(n)||0,l=Number(t)||0;
if(!o)return r;
const c=Math.max(1,Math.ceil(o*.5));
if(l<c)return r;
const d=s.split(/[\u3002\uff01\uff1f!?\n]+/).map(p=>p.trim()).filter(Boolean);
const p=[
{re:/\u3053\u308c\u306b\u3066\u4e00\u4ef6\u843d\u7740/},
{re:/\u3059\u3079\u3066(?:\u304c|\u3001)?\u7d42\u308f/},
{re:/\u7d42\u308f\u3063\u305f(?:\u306e\u306d|\u306e\u3060|\u306e\u304b|\u308f\u3051|\u306f\u305a|\u3068\u601d)/},
{re:/(?:\u4eba\u3005|\u5e02\u6c11|\u6771\u4eac)[^\u3002\n]{0,120}(?:\u601d\u3044\u51fa|\u76ee\u899a\u3081)/},
{re:/(?:\u6551\u6025\u8eca|\u642c\u9001|\u75c5\u5ba4|\u30d9\u30c3\u30c9|\u671d\u306e\u5149|\u9759\u304b\u306a\u671d)[^\u3002\n]{0,140}(?:\u76ee\u899a|\u8a18\u61b6|\u7d42\u308f|\u9759\u304b|\u623b)/},
{re:/\u5b8c\u5168\u52dd\u5229|\u9ed2\u5e55\u5b8c\u5168\u6557\u5317|\u4f1a\u793e\u518d\u5efa(?:\u304c|\u306f)?\u5b8c\u4e86|\u5168\u9762\u5951\u7d04/}
];
const g=[
{re:/(?:\u30b7\u30b9\u30c6\u30e0|\u30b0\u30e9\u30f3\u30c9\u30fb\u30ea\u30bb\u30c3\u30c8|\u8abf\u5f8b)[^\u3002\n]{0,80}(?:\u505c\u6b62|\u6b62\u307e|\u5d29\u58ca|\u6c88\u9ed9|\u6d88\u3048)/},
{re:/(?:\u30b3\u30a2|\u4e2d\u67a2|\u7089|\u8a18\u61b6\u88c5\u7f6e|\u5b9f\u9a13|\u8a08\u753b|\u9670\u8b00|\u30cd\u30c3\u30c8\u30ef\u30fc\u30af)[^\u3002\n]{0,120}(?:\u7834\u58ca|\u505c\u6b62|\u5d29\u58ca|\u6c88\u9ed9|\u6d88\u6ec5|\u6b62\u307e|\u7d42\u308f)/}
];
const h=/(?:\u9632|\u963b\u6b62|\u5931\u6557|\u672a\u9042|\u672a\u5b8c|\u4e0d\u5b8c\u5168|\u90e8\u5206|\u5c40\u6240|\u4e00\u6642|\u5bf8\u524d|\u76f4\u524d|\u8a66\u307f|\u72d9|\u307e\u3060|\u7d9a|\u7a3c\u50cd|\u751f\u304d|\u6b62\u307e\u3089|\u56de\u907f|\u672a\u89e3\u6c7a|\u6b8b|\u7dad\u6301|\u4fdd\u305f|\u89e3\u9664\u3067\u304d\u306a\u3044|\u7834\u58ca\u3067\u304d\u306a\u3044|\u58ca\u305b\u306a\u3044|\u5d29\u58ca\u3057\u306a\u3044|\u6c88\u9ed9\u3057\u306a\u3044|\u6d88\u3048\u306a\u3044)/;
for(const y of p)y.re.test(s)&&r.push(`Whole-story resolution appears before the final chapter (${y.re.toString()})`);
for(const y of g)for(const u of d)if(y.re.test(u)&&!h.test(u)){r.push(`Whole-story resolution appears before the final chapter (${y.re.toString()})`);break}
return r
};

const smBaseSanitizeV404=ue;
ue=function(e){
const t=smBaseSanitizeV404(e);
return String(t||"").replace(/(?:^|\n)\s*(?:#{1,6}\s*)?(?:[【\[]\s*)?第[\d０-９一二三四五六七八九十]+章\s*終了時点での[\s\S]*$/g,"\n").replace(/(?:^|\n)\s*(?:#{1,6}\s*)?(?:CONTEXT MEMO|GMC\+S|Chapter\s+\d+\s+context memo)[\s\S]*$/gi,"\n").replace(/\n{3,}/g,"\n\n").trim()
};

const smBaseValidateV404=Et;
Et=function(e){
const t=smBaseValidateV404(e),a=String(e||"");
/(?:^|\n)\s*(?:#{1,6}\s*)?(?:[【\[]\s*)?第[\d０-９一二三四五六七八九十]+章\s*終了時点での|CONTEXT MEMO|GMC\+S|再現用マスター指示書/.test(a)&&t.push("Long-novel context memo fragment remains in chapter body");
return t
};
