...
### 生成コンテンツに関するポリシー / Generated Content Policy

本ツールは創作支援を目的としており、特定の既存作品の再現や複製を目的とした利用は想定していません。  
This tool is intended for creative support and is not designed for reproducing or replicating existing copyrighted works.

ユーザーは、本ツールを使用して生成されたコンテンツについて、以下の行為を行ってはなりません。  
Users must not engage in the following actions when using content generated by this tool:

#### 1. 著作権侵害となる生成 / Copyright Infringement
- 既存作品（漫画、アニメ、小説、映画、ゲーム等）を実質的に再現・模倣する行為  
  Reproducing or closely imitating existing works (e.g., manga, anime, novels, films, games)
- 特定の作品・キャラクター・作家の作風を識別可能なレベルで再現する行為  
  Replicating the style of a specific work, character, or creator at a recognizable level
- 構図、セリフ、デザイン、ストーリーの無断流用  
  Unauthorized reuse of compositions, dialogue, designs, or story elements

#### 2. 権利侵害コンテンツの利用 / Distribution of Infringing Content
- 第三者の著作権、商標権、肖像権等を侵害するコンテンツの公開・販売・共有  
  Publishing, selling, or sharing content that infringes on copyrights, trademarks, or publicity rights
- 既存IPに類似したコンテンツの無断商用利用  
  Commercial use of content similar to existing IP without permission

#### 3. 不正利用の助長 / Facilitation of Misuse
- 権利侵害を目的としたプロンプトやテンプレートの作成・共有  
  Creating or sharing prompts/templates intended for infringement
- 他者に侵害コンテンツ生成を促す行為  
  Encouraging others to generate infringing content

---

### 免責事項 / Disclaimer

本ツールはコンテンツ生成を補助するものであり、生成物の内容および利用に関する法的責任はすべてユーザーに帰属します。  
This tool assists content generation, and all legal responsibility for generated content lies with the user.

ユーザーは、適用される法令（著作権法等）を遵守する責任を負います。  
Users are responsible for complying with all applicable laws and regulations.

---

### ポリシー違反への対応 / Enforcement

開発者は、本規約に違反する利用が確認された場合、以下の措置を講じる権利を有します。  
The developer reserves the right to take action in case of violations:

- 利用の制限または禁止  
  Restrict or prohibit usage
- コンテンツの削除要請  
...
本ポリシーは、ユーザーおよび第三者の権利保護を目的としています。  
This policy is intended to protect the rights of users and third parties.

健全な創作活動の範囲内でご利用ください。  
Please use this tool responsibly within the scope of legitimate creative activity.
